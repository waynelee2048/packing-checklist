...
export default function AddItemsView({ data, onNavigate, onSaveData }) {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      {showAddForm && (
        <div className="fixed right-4 bottom-[168px] z-50 w-72 bg-white rounded-xl shadow-xl border border-slate-200 p-4 space-y-3">
          <div className="text-sm font-semibold text-slate-700">快速新增物品</div>
          <input
            type="text"
            placeholder="物品名稱"
            value={newItemName}
      ...
      <button
        ...
        className="fixed right-4 bottom-[112px] z-50 w-14 h-14 rounded-full bg-indigo-600 text-white shadow-lg flex items-center justify-center active:bg-indigo-700 transition-colors duration-150"
