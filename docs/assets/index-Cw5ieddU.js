 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y_=t=>{const e=ET(t);return e.charAt(0).toUpperCase()+e.slice(1)};/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TT=y.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:s="",children:i,iconNode:o,...l},a)=>y.createElement("svg",{ref:a,...NT,width:e,height:e,stroke:t,strokeWidth:r?Number(n)*24/Number(e):n,className:Wx("lucide",s),...!i&&!IT(l)&&{"aria-hidden":"true"},...l},[...o.map(([u,h])=>y.createElement(u,h)),...Array.isArray(i)?i:[i]]));/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W=(t,e)=>{const n=y.forwardRef(({className:r,...s},i)=>y.createElement(TT,{ref:i,iconNode:e,className:Wx(`lucide-${ST(Y_(t))}`,`lucide-${t}`,r),...s}));return n.displayName=Y_(t),n};/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const RT=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],Iu=W("arrow-left",RT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jT=[["path",{d:"m21 16-4 4-4-4",key:"f6ql7i"}],["path",{d:"M17 20V4",key:"1ejh1v"}],["path",{d:"m3 8 4-4 4 4",key:"11wl7u"}],["path",{d:"M7 4v16",key:"1glfcx"}]],Hx=W("arrow-up-down",jT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zT=[["path",{d:"M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16",key:"jecpp"}],["rect",{width:"20",height:"14",x:"2",y:"6",rx:"2",key:"i6l2r4"}]],UT=W("briefcase",zT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const FT=[["path",{d:"M13.997 4a2 2 0 0 1 1.76 1.05l.486.9A2 2 0 0 0 18.003 7H20a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h1.997a2 2 0 0 0 1.759-1.048l.489-.904A2 2 0 0 1 10.004 4z",key:"18u6gg"}],["circle",{cx:"12",cy:"13",r:"3",key:"1vg3eu"}]],op=W("camera",FT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const VT=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],ni=W("check",VT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const QT=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],Vx=W("chevron-left",QT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const GT=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]],qT=W("circle-alert",GT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const XT=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2",key:"116196"}],["path",{d:"M12 11h4",key:"1jrz19"}],["path",{d:"M12 16h4",key:"n85exb"}],["path",{d:"M8 11h.01",key:"1dfujw"}],["path",{d:"M8 16h.01",key:"18s6g9"}]],Zd=W("clipboard-list",XT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const KT=[["path",{d:"M10.94 5.274A7 7 0 0 1 15.71 10h1.79a4.5 4.5 0 0 1 4.222 6.057",key:"1uxyv8"}],["path",{d:"M18.796 18.81A4.5 4.5 0 0 1 17.5 19H9A7 7 0 0 1 5.79 5.78",key:"99tcn7"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]],JT=W("cloud-off",KT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ZT=[["path",{d:"M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z",key:"p7xjir"}]],e4=W("cloud",ZT);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const t4=[["path",{d:"M10 2v2",key:"7u0qdc"}],["path",{d:"M14 2v2",key:"6buw04"}],["path",{d:"M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1",key:"pwadti"}],["path",{d:"M6 2v2",key:"colzsn"}]],n4=W("coffee",t4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const r4=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],s4=W("copy",r4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const i4=[["path",{d:"M12 15V3",key:"m9g1x1"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["path",{d:"m7 10 5 5 5-5",key:"brsn70"}]],o4=W("download",i4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l4=[["path",{d:"M17.596 12.768a2 2 0 1 0 2.829-2.829l-1.768-1.767a2 2 0 0 0 2.828-2.829l-2.828-2.828a2 2 0 0 0-2.829 2.828l-1.767-1.768a2 2 0 1 0-2.829 2.829z",key:"9m4mmf"}],["path",{d:"m2.5 21.5 1.4-1.4",key:"17g3f0"}],["path",{d:"m20.1 3.9 1.4-1.4",key:"1qn309"}],["path",{d:"M5.343 21.485a2 2 0 1 0 2.829-2.828l1.767 1.768a2 2 0 1 0 2.829-2.829l-6.364-6.364a2 2 0 1 0-2.829 2.829l1.768 1.767a2 2 0 0 0-2.828 2.829z",key:"1t2c92"}],["path",{d:"m9.6 14.4 4.8-4.8",key:"6umqxw"}]],a4=W("dumbbell",l4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c4=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],u4=W("eye",c4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const d4=[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]],Yx=W("file-text",d4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h4=[["path",{d:"M4 16v-2.38C4 11.5 2.97 10.5 3 8c.03-2.72 1.49-6 4.5-6C9.37 2 10 3.8 10 5.5c0 3.11-2 5.66-2 8.68V16a2 2 0 1 1-4 0Z",key:"1dudjm"}],["path",{d:"M20 20v-2.38c0-2.12 1.03-3.12 1-5.62-.03-2.72-1.49-6-4.5-6C14.63 6 14 7.8 14 9.5c0 3.11 2 5.66 2 8.68V20a2 2 0 1 0 4 0Z",key:"l2t8xc"}],["path",{d:"M16 17h4",key:"1dejxt"}],["path",{d:"M4 13h4",key:"1bwh8b"}]],f4=W("footprints",h4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p4=[["path",{d:"M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z",key:"sc7q7i"}]],m4=W("funnel",p4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _4=[["rect",{x:"3",y:"8",width:"18",height:"4",rx:"1",key:"bkv52"}],["path",{d:"M12 8v13",key:"1c76mn"}],["path",{d:"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7",key:"6wjy6b"}],["path",{d:"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5",key:"1ihvrl"}]],g4=W("gift",_4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y4=[["circle",{cx:"9",cy:"12",r:"1",key:"1vctgf"}],["circle",{cx:"9",cy:"5",r:"1",key:"hp0tcf"}],["circle",{cx:"9",cy:"19",r:"1",key:"fkjjf6"}],["circle",{cx:"15",cy:"12",r:"1",key:"1tmaij"}],["circle",{cx:"15",cy:"5",r:"1",key:"19l28e"}],["circle",{cx:"15",cy:"19",r:"1",key:"f4zoj3"}]],Qx=W("grip-vertical",y4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v4=[["path",{d:"M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5",key:"mvr1a0"}]],x4=W("heart",v4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b4=[["polyline",{points:"22 12 16 12 14 15 10 15 8 12 2 12",key:"o97t9d"}],["path",{d:"M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z",key:"oot6mr"}]],w4=W("inbox",b4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k4=[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]],Gx=W("layout-dashboard",k4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C4=[["rect",{width:"7",height:"7",x:"3",y:"3",rx:"1",key:"1g98yp"}],["rect",{width:"7",height:"7",x:"3",y:"14",rx:"1",key:"1bb6yr"}],["path",{d:"M14 4h7",key:"3xa0d5"}],["path",{d:"M14 9h7",key:"1icrd9"}],["path",{d:"M14 15h7",key:"1mj8o2"}],["path",{d:"M14 20h7",key:"11slyb"}]],S4=W("layout-list",C4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E4=[["path",{d:"M13 5h8",key:"a7qcls"}],["path",{d:"M13 12h8",key:"h98zly"}],["path",{d:"M13 19h8",key:"c3s6r1"}],["path",{d:"m3 17 2 2 4-4",key:"1jhpwq"}],["path",{d:"m3 7 2 2 4-4",key:"1obspn"}]],N4=W("list-checks",E4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I4=[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]],qx=W("loader-circle",I4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T4=[["path",{d:"M12 2v4",key:"3427ic"}],["path",{d:"m16.2 7.8 2.9-2.9",key:"r700ao"}],["path",{d:"M18 12h4",key:"wj9ykh"}],["path",{d:"m16.2 16.2 2.9 2.9",key:"1bxg5t"}],["path",{d:"M12 18v4",key:"jadmvz"}],["path",{d:"m4.9 19.1 2.9-2.9",key:"bwix9q"}],["path",{d:"M2 12h4",key:"j09sii"}],["path",{d:"m4.9 4.9 2.9 2.9",key:"giyufr"}]],R4=W("loader",T4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j4=[["path",{d:"m10 17 5-5-5-5",key:"1bsop3"}],["path",{d:"M15 12H3",key:"6jk70r"}],["path",{d:"M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4",key:"u53s6r"}]],P4=W("log-in",j4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A4=[["path",{d:"m16 17 5-5-5-5",key:"1bji2h"}],["path",{d:"M21 12H9",key:"dn1m92"}],["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}]],L4=W("log-out",A4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const O4=[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]],D4=W("menu",O4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M4=[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]],z4=W("monitor",M4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U4=[["path",{d:"M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401",key:"kfwtm"}]],F4=W("moon",U4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B4=[["path",{d:"m8 3 4 8 5-5 5 15H2L8 3z",key:"otkl63"}]],$4=W("mountain",B4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W4=[["path",{d:"M9 18V5l12-2v13",key:"1jmyc2"}],["circle",{cx:"6",cy:"18",r:"3",key:"fqmcym"}],["circle",{cx:"18",cy:"16",r:"3",key:"1hluhg"}]],H4=W("music",W4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const V4=[["path",{d:"M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z",key:"1a0edw"}],["path",{d:"M12 22V12",key:"d0xqtd"}],["polyline",{points:"3.29 7 12 12 20.71 7",key:"ousv84"}],["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}]],Oo=W("package",V4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y4=[["path",{d:"M13 21h8",key:"1jsn5i"}],["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}]],Ba=W("pen-line",Y4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q4=[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}],["path",{d:"m15 5 4 4",key:"1mk7zo"}]],G4=W("pencil",Q4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const q4=[["circle",{cx:"12",cy:"5",r:"1",key:"gxeob9"}],["path",{d:"m9 20 3-6 3 6",key:"se2kox"}],["path",{d:"m6 8 6 2 6-2",key:"4o3us4"}],["path",{d:"M12 10v4",key:"1kjpxc"}]],X4=W("person-standing",q4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const K4=[["path",{d:"M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z",key:"1v9wt8"}]],J4=W("plane",K4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Z4=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],$n=W("plus",Z4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eR=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],tR=W("rotate-ccw",eR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nR=[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]],Nc=W("search",nR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rR=[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]],Ic=W("share-2",rR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sR=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}]],eh=W("shield",sR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const iR=[["path",{d:"M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z",key:"1wgbhj"}]],oR=W("shirt",iR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lR=[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]],aR=W("shopping-cart",lR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cR=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],uR=W("sparkles",cR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dR=[["path",{d:"M21 9a2.4 2.4 0 0 0-.706-1.706l-3.588-3.588A2.4 2.4 0 0 0 15 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z",key:"1dfntj"}],["path",{d:"M15 3v5a1 1 0 0 0 1 1h5",key:"6s6qgf"}]],lp=W("sticky-note",dR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const hR=[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]],fR=W("sun",hR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pR=[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]],Xx=W("tag",pR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mR=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"6",key:"1vlfrh"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]],_R=W("target",mR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gR=[["path",{d:"M3.5 21 14 3",key:"1szst5"}],["path",{d:"M20.5 21 10 3",key:"1310c3"}],["path",{d:"M15.5 21 12 15l-3.5 6",key:"1ddtfw"}],["path",{d:"M2 21h20",key:"1nyx9w"}]],yR=W("tent",gR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vR=[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]],Ln=W("trash-2",vR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xR=[["path",{d:"M12 13v7a2 2 0 0 0 4 0",key:"rpgb42"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M20.992 13a1 1 0 0 0 .97-1.274 10.284 10.284 0 0 0-19.923 0A1 1 0 0 0 3 13z",key:"124nyo"}]],bR=W("umbrella",xR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wR=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],kR=W("upload",wR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const CR=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],SR=W("user",CR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ER=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744",key:"16gr8j"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],Kx=W("users",ER);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const NR=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],ut=W("x",NR);function IR(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return y.useMemo(()=>r=>{e.forEach(s=>s(r))},e)}const Tc=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function fi(t){const e=Object.prototype.toString.call(t);return e==="[object Window]"||e==="[object global]"}function ap(t){return"nodeType"in t}function bt(t){var e,n;return t?fi(t)?t:ap(t)&&(e=(n=t.ownerDocument)==null?void 0:n.defaultView)!=null?e:window:window}function cp(t){const{Document:e}=bt(t);return t instanceof e}function Jo(t){return fi(t)?!1:t instanceof bt(t).HTMLElement}function Jx(t){return t instanceof bt(t).SVGElement}function pi(t){return t?fi(t)?t.document:ap(t)?cp(t)?t:Jo(t)||Jx(t)?t.ownerDocument:document:document:document}const gn=Tc?y.useLayoutEffect:y.useEffect;function up(t){const e=y.useRef(t);return gn(()=>{e.current=t}),y.useCallback(function(){for(var n=arguments.length,r=new Array(n),s=0;s<n;s++)r[s]=arguments[s];return e.current==null?void 0:e.current(...r)},[])}function TR(){const t=y.useRef(null),e=y.useCallback((r,s)=>{t.current=setInterval(r,s)},[]),n=y.useCallback(()=>{t.current!==null&&(clearInterval(t.current),t.current=null)},[]);return[e,n]}function Do(t,e){e===void 0&&(e=[t]);const n=y.useRef(t);return gn(()=>{n.current!==t&&(n.current=t)},e),n}function Zo(t,e){const n=y.useRef();return y.useMemo(()=>{const r=t(n.current);return n.current=r,r},[...e])}function $a(t){const e=up(t),n=y.useRef(null),r=y.useCallback(s=>{s!==n.current&&(e==null||e(s,n.current)),n.current=s},[]);return[n,r]}function th(t){const e=y.useRef();return y.useEffect(()=>{e.current=t},[t]),e.current}let Tu={};function el(t,e){return y.useMemo(()=>{if(e)return e;const n=Tu[t]==null?0:Tu[t]+1;return Tu[t]=n,t+"-"+n},[t,e])}function Zx(t){return function(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),s=1;s<n;s++)r[s-1]=arguments[s];return r.reduce((i,o)=>{const l=Object.entries(o);for(const[a,u]of l){const h=i[a];h!=null&&(i[a]=h+t*u)}return i},{...e})}}const Bs=Zx(1),Wa=Zx(-1);function RR(t){return"clientX"in t&&"clientY"in t}function dp(t){if(!t)return!1;const{KeyboardEvent:e}=bt(t.target);return e&&t instanceof e}function jR(t){if(!t)return!1;const{TouchEvent:e}=bt(t.target);return e&&t instanceof e}function nh(t){if(jR(t)){if(t.touches&&t.touches.length){const{clientX:e,clientY:n}=t.touches[0];return{x:e,y:n}}else if(t.changedTouches&&t.changedTouches.length){const{clientX:e,clientY:n}=t.changedTouches[0];return{x:e,y:n}}}return RR(t)?{x:t.clientX,y:t.clientY}:null}const ri=Object.freeze({Translate:{toString(t){if(!t)return;const{x:e,y:n}=t;return"translate3d("+(e?Math.round(e):0)+"px, "+(n?Math.round(n):0)+"px, 0)"}},Scale:{toString(t){if(!t)return;const{scaleX:e,scaleY:n}=t;return"scaleX("+e+") scaleY("+n+")"}},Transform:{toString(t){if(t)return[ri.Translate.toString(t),ri.Scale.toString(t)].join(" ")}},Transition:{toString(t){let{property:e,duration:n,easing:r}=t;return e+" "+n+"ms "+r}}}),G_="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function PR(t){return t.matches(G_)?t:t.querySelector(G_)}const AR={display:"none"};function LR(t){let{id:e,value:n}=t;return lt.createElement("div",{id:e,style:AR},n)}function OR(t){let{id:e,announcement:n,ariaLiveType:r="assertive"}=t;const s={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return lt.createElement("div",{id:e,style:s,role:"status","aria-live":r,"aria-atomic":!0},n)}function DR(){const[t,e]=y.useState("");return{announce:y.useCallback(r=>{r!=null&&e(r)},[]),announcement:t}}const eb=y.createContext(null);function MR(t){const e=y.useContext(eb);y.useEffect(()=>{if(!e)throw new Error("useDndMonitor must be used within a children of <DndContext>");return e(t)},[t,e])}function zR(){const[t]=y.useState(()=>new Set),e=y.useCallback(r=>(t.add(r),()=>t.delete(r)),[t]);return[y.useCallback(r=>{let{type:s,event:i}=r;t.forEach(o=>{var l;return(l=o[s])==null?void 0:l.call(o,i)})},[t]),e]}const UR={draggable:`
    To pick up a draggable item, press the space bar.
    While dragging, use the arrow keys to move the item.
    Press space again to drop the item in its new position, or press escape to cancel.
  `},FR={onDragStart(t){let{active:e}=t;return"Picked up draggable item "+e.id+"."},onDragOver(t){let{active:e,over:n}=t;return n?"Draggable item "+e.id+" was moved over droppable area "+n.id+".":"Draggable item "+e.id+" is no longer over a droppable area."},onDragEnd(t){let{active:e,over:n}=t;return n?"Draggable item "+e.id+" was dropped over droppable area "+n.id:"Draggable item "+e.id+" was dropped."},onDragCancel(t){let{active:e}=t;return"Dragging was cancelled. Draggable item "+e.id+" was dropped."}};function BR(t){let{announcements:e=FR,container:n,hiddenTextDescribedById:r,screenReaderInstructions:s=UR}=t;const{announce:i,announcement:o}=DR(),l=el("DndLiveRegion"),[a,u]=y.useState(!1);if(y.useEffect(()=>{u(!0)},[]),MR(y.useMemo(()=>({onDragStart(d){let{active:f}=d;i(e.onDragStart({active:f}))},onDragMove(d){let{active:f,over:p}=d;e.onDragMove&&i(e.onDragMove({active:f,over:p}))},onDragOver(d){let{active:f,over:p}=d;i(e.onDragOver({active:f,over:p}))},onDragEnd(d){let{active:f,over:p}=d;i(e.onDragEnd({active:f,over:p}))},onDragCancel(d){let{active:f,over:p}=d;i(e.onDragCancel({active:f,over:p}))}}),[i,e])),!a)return null;const h=lt.createElement(lt.Fragment,null,lt.createElement(LR,{id:r,value:s.draggable}),lt.createElement(OR,{id:l,announcement:o}));return n?Ns.createPortal(h,n):h}var De;(function(t){t.DragStart="dragStart",t.DragMove="dragMove",t.DragEnd="dragEnd",t.DragCancel="dragCancel",t.DragOver="dragOver",t.RegisterDroppable="registerDroppable",t.SetDroppableDisabled="setDroppableDisabled",t.UnregisterDroppable="unregisterDroppable"})(De||(De={}));function Ha(){}function Va(t,e){return y.useMemo(()=>({sensor:t,options:e??{}}),[t,e])}function tb(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return y.useMemo(()=>[...e].filter(r=>r!=null),[...e])}const nn=Object.freeze({x:0,y:0});function $R(t,e){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function WR(t,e){let{data:{value:n}}=t,{data:{value:r}}=e;return n-r}function HR(t,e){let{data:{value:n}}=t,{data:{value:r}}=e;return r-n}function VR(t,e){if(!t||t.length===0)return null;const[n]=t;return n[e]}function q_(t,e,n){return e===void 0&&(e=t.left),n===void 0&&(n=t.top),{x:e+t.width*.5,y:n+t.height*.5}}const nb=t=>{let{collisionRect:e,droppableRects:n,droppableContainers:r}=t;const s=q_(e,e.left,e.top),i=[];for(const o of r){const{id:l}=o,a=n.get(l);if(a){const u=$R(q_(a),s);i.push({id:l,data:{droppableContainer:o,value:u}})}}return i.sort(WR)};function YR(t,e){const n=Math.max(e.top,t.top),r=Math.max(e.left,t.left),s=Math.min(e.left+e.width,t.left+t.width),i=Math.min(e.top+e.height,t.top+t.height),o=s-r,l=i-n;if(r<s&&n<i){const a=e.width*e.height,u=t.width*t.height,h=o*l,d=h/(a+u-h);return Number(d.toFixed(4))}return 0}const QR=t=>{let{collisionRect:e,droppableRects:n,droppableContainers:r}=t;const s=[];for(const i of r){const{id:o}=i,l=n.get(o);if(l){const a=YR(l,e);a>0&&s.push({id:o,data:{droppableContainer:i,value:a}})}}return s.sort(HR)};function GR(t,e,n){return{...t,scaleX:e&&n?e.width/n.width:1,scaleY:e&&n?e.height/n.height:1}}function rb(t,e){return t&&e?{x:t.left-e.left,y:t.top-e.top}:nn}function qR(t){return function(n){for(var r=arguments.length,s=new Array(r>1?r-1:0),i=1;i<r;i++)s[i-1]=arguments[i];return s.reduce((o,l)=>({...o,top:o.top+t*l.y,bottom:o.bottom+t*l.y,left:o.left+t*l.x,right:o.right+t*l.x}),{...n})}}const XR=qR(1);function KR(t){if(t.startsWith("matrix3d(")){const e=t.slice(9,-1).split(/, /);return{x:+e[12],y:+e[13],scaleX:+e[0],scaleY:+e[5]}}else if(t.startsWith("matrix(")){const e=t.slice(7,-1).split(/, /);return{x:+e[4],y:+e[5],scaleX:+e[0],scaleY:+e[3]}}return null}function JR(t,e,n){const r=KR(e);if(!r)return t;const{scaleX:s,scaleY:i,x:o,y:l}=r,a=t.left-o-(1-s)*parseFloat(n),u=t.top-l-(1-i)*parseFloat(n.slice(n.indexOf(" ")+1)),h=s?t.width/s:t.width,d=i?t.height/i:t.height;return{width:h,height:d,top:u,right:a+h,bottom:u+d,left:a}}const ZR={ignoreTransform:!1};function mi(t,e){e===void 0&&(e=ZR);let n=t.getBoundingClientRect();if(e.ignoreTransform){const{transform:u,transformOrigin:h}=bt(t).getComputedStyle(t);u&&(n=JR(n,u,h))}const{top:r,left:s,width:i,height:o,bottom:l,right:a}=n;return{top:r,left:s,width:i,height:o,bottom:l,right:a}}function X_(t){return mi(t,{ignoreTransform:!0})}function ej(t){const e=t.innerWidth,n=t.innerHeight;return{top:0,left:0,right:e,bottom:n,width:e,height:n}}function tj(t,e){return e===void 0&&(e=bt(t).getComputedStyle(t)),e.position==="fixed"}function nj(t,e){e===void 0&&(e=bt(t).getComputedStyle(t));const n=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(s=>{const i=e[s];return typeof i=="string"?n.test(i):!1})}function hp(t,e){const n=[];function r(s){if(e!=null&&n.length>=e||!s)return n;if(cp(s)&&s.scrollingElement!=null&&!n.includes(s.scrollingElement))return n.push(s.scrollingElement),n;if(!Jo(s)||Jx(s)||n.includes(s))return n;const i=bt(t).getComputedStyle(s);return s!==t&&nj(s,i)&&n.push(s),tj(s,i)?n:r(s.parentNode)}return t?r(t):n}function sb(t){const[e]=hp(t,1);return e??null}function Ru(t){return!Tc||!t?null:fi(t)?t:ap(t)?cp(t)||t===pi(t).scrollingElement?window:Jo(t)?t:null:null}function ib(t){return fi(t)?t.scrollX:t.scrollLeft}function ob(t){return fi(t)?t.scrollY:t.scrollTop}function rh(t){return{x:ib(t),y:ob(t)}}var $e;(function(t){t[t.Forward=1]="Forward",t[t.Backward=-1]="Backward"})($e||($e={}));function lb(t){return!Tc||!t?!1:t===document.scrollingElement}function ab(t){const e={x:0,y:0},n=lb(t)?{height:window.innerHeight,width:window.innerWidth}:{height:t.clientHeight,width:t.clientWidth},r={x:t.scrollWidth-n.width,y:t.scrollHeight-n.height},s=t.scrollTop<=e.y,i=t.scrollLeft<=e.x,o=t.scrollTop>=r.y,l=t.scrollLeft>=r.x;return{isTop:s,isLeft:i,isBottom:o,isRight:l,maxScroll:r,minScroll:e}}const rj={x:.2,y:.2};function sj(t,e,n,r,s){let{top:i,left:o,right:l,bottom:a}=n;r===void 0&&(r=10),s===void 0&&(s=rj);const{isTop:u,isBottom:h,isLeft:d,isRight:f}=ab(t),p={x:0,y:0},v={x:0,y:0},w={height:e.height*s.y,width:e.width*s.x};return!u&&i<=e.top+w.height?(p.y=$e.Backward,v.y=r*Math.abs((e.top+w.height-i)/w.height)):!h&&a>=e.bottom-w.height&&(p.y=$e.Forward,v.y=r*Math.abs((e.bottom-w.height-a)/w.height)),!f&&l>=e.right-w.width?(p.x=$e.Forward,v.x=r*Math.abs((e.right-w.width-l)/w.width)):!d&&o<=e.left+w.width&&(p.x=$e.Backward,v.x=r*Math.abs((e.left+w.width-o)/w.width)),{direction:p,speed:v}}function ij(t){if(t===document.scrollingElement){const{innerWidth:i,innerHeight:o}=window;return{top:0,left:0,right:i,bottom:o,width:i,height:o}}const{top:e,left:n,right:r,bottom:s}=t.getBoundingClientRect();return{top:e,left:n,right:r,bottom:s,width:t.clientWidth,height:t.clientHeight}}function cb(t){return t.reduce((e,n)=>Bs(e,rh(n)),nn)}function oj(t){return t.reduce((e,n)=>e+ib(n),0)}function lj(t){return t.reduce((e,n)=>e+ob(n),0)}function aj(t,e){if(e===void 0&&(e=mi),!t)return;const{top:n,left:r,bottom:s,right:i}=e(t);sb(t)&&(s<=0||i<=0||n>=window.innerHeight||r>=window.innerWidth)&&t.scrollIntoView({block:"center",inline:"center"})}const cj=[["x",["left","right"],oj],["y",["top","bottom"],lj]];class fp{constructor(e,n){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const r=hp(n),s=cb(r);this.rect={...e},this.width=e.width,this.height=e.height;for(const[i,o,l]of cj)for(const a of o)Object.defineProperty(this,a,{get:()=>{const u=l(r),h=s[i]-u;return this.rect[a]+h},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class no{constructor(e){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(n=>{var r;return(r=this.target)==null?void 0:r.removeEventListener(...n)})},this.target=e}add(e,n,r){var s;(s=this.target)==null||s.addEventListener(e,n,r),this.listeners.push([e,n,r])}}function uj(t){const{EventTarget:e}=bt(t);return t instanceof e?t:pi(t)}function ju(t,e){const n=Math.abs(t.x),r=Math.abs(t.y);return typeof e=="number"?Math.sqrt(n**2+r**2)>e:"x"in e&&"y"in e?n>e.x&&r>e.y:"x"in e?n>e.x:"y"in e?r>e.y:!1}var Ot;(function(t){t.Click="click",t.DragStart="dragstart",t.Keydown="keydown",t.ContextMenu="contextmenu",t.Resize="resize",t.SelectionChange="selectionchange",t.VisibilityChange="visibilitychange"})(Ot||(Ot={}));function K_(t){t.preventDefault()}function dj(t){t.stopPropagation()}var le;(function(t){t.Space="Space",t.Down="ArrowDown",t.Right="ArrowRight",t.Left="ArrowLeft",t.Up="ArrowUp",t.Esc="Escape",t.Enter="Enter",t.Tab="Tab"})(le||(le={}));const ub={start:[le.Space,le.Enter],cancel:[le.Esc],end:[le.Space,le.Enter,le.Tab]},hj=(t,e)=>{let{currentCoordinates:n}=e;switch(t.code){case le.Right:return{...n,x:n.x+25};case le.Left:return{...n,x:n.x-25};case le.Down:return{...n,y:n.y+25};case le.Up:return{...n,y:n.y-25}}};class db{constructor(e){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=e;const{event:{target:n}}=e;this.props=e,this.listeners=new no(pi(n)),this.windowListeners=new no(bt(n)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(Ot.Resize,this.handleCancel),this.windowListeners.add(Ot.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(Ot.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:e,onStart:n}=this.props,r=e.node.current;r&&aj(r),n(nn)}handleKeyDown(e){if(dp(e)){const{active:n,context:r,options:s}=this.props,{keyboardCodes:i=ub,coordinateGetter:o=hj,scrollBehavior:l="smooth"}=s,{code:a}=e;if(i.end.includes(a)){this.handleEnd(e);return}if(i.cancel.includes(a)){this.handleCancel(e);return}const{collisionRect:u}=r.current,h=u?{x:u.left,y:u.top}:nn;this.referenceCoordinates||(this.referenceCoordinates=h);const d=o(e,{active:n,context:r.current,currentCoordinates:h});if(d){const f=Wa(d,h),p={x:0,y:0},{scrollableAncestors:v}=r.current;for(const w of v){const k=e.code,{isTop:_,isRight:m,isLeft:g,isBottom:x,maxScroll:b,minScroll:C}=ab(w),N=ij(w),S={x:Math.min(k===le.Right?N.right-N.width/2:N.right,Math.max(k===le.Right?N.left:N.left+N.width/2,d.x)),y:Math.min(k===le.Down?N.bottom-N.height/2:N.bottom,Math.max(k===le.Down?N.top:N.top+N.height/2,d.y))},j=k===le.Right&&!m||k===le.Left&&!g,E=k===le.Down&&!x||k===le.Up&&!_;if(j&&S.x!==d.x){const I=w.scrollLeft+f.x,T=k===le.Right&&I<=b.x||k===le.Left&&I>=C.x;if(T&&!f.y){w.scrollTo({left:I,behavior:l});return}T?p.x=w.scrollLeft-I:p.x=k===le.Right?w.scrollLeft-b.x:w.scrollLeft-C.x,p.x&&w.scrollBy({left:-p.x,behavior:l});break}else if(E&&S.y!==d.y){const I=w.scrollTop+f.y,T=k===le.Down&&I<=b.y||k===le.Up&&I>=C.y;if(T&&!f.x){w.scrollTo({top:I,behavior:l});return}T?p.y=w.scrollTop-I:p.y=k===le.Down?w.scrollTop-b.y:w.scrollTop-C.y,p.y&&w.scrollBy({top:-p.y,behavior:l});break}}this.handleMove(e,Bs(Wa(d,this.referenceCoordinates),p))}}}handleMove(e,n){const{onMove:r}=this.props;e.preventDefault(),r(n)}handleEnd(e){const{onEnd:n}=this.props;e.preventDefault(),this.detach(),n()}handleCancel(e){const{onCancel:n}=this.props;e.preventDefault(),this.detach(),n()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}db.activators=[{eventName:"onKeyDown",handler:(t,e,n)=>{let{keyboardCodes:r=ub,onActivation:s}=e,{active:i}=n;const{code:o}=t.nativeEvent;if(r.start.includes(o)){const l=i.activatorNode.current;return l&&t.target!==l?!1:(t.preventDefault(),s==null||s({event:t.nativeEvent}),!0)}return!1}}];function J_(t){return!!(t&&"distance"in t)}function Z_(t){return!!(t&&"delay"in t)}class pp{constructor(e,n,r){var s;r===void 0&&(r=uj(e.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=e,this.events=n;const{event:i}=e,{target:o}=i;this.props=e,this.events=n,this.document=pi(o),this.documentListeners=new no(this.document),this.listeners=new no(r),this.windowListeners=new no(bt(o)),this.initialCoordinates=(s=nh(i))!=null?s:nn,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:e,props:{options:{activationConstraint:n,bypassActivationConstraint:r}}}=this;if(this.listeners.add(e.move.name,this.handleMove,{passive:!1}),this.listeners.add(e.end.name,this.handleEnd),e.cancel&&this.listeners.add(e.cancel.name,this.handleCancel),this.windowListeners.add(Ot.Resize,this.handleCancel),this.windowListeners.add(Ot.DragStart,K_),this.windowListeners.add(Ot.VisibilityChange,this.handleCancel),this.windowListeners.add(Ot.ContextMenu,K_),this.documentListeners.add(Ot.Keydown,this.handleKeydown),n){if(r!=null&&r({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(Z_(n)){this.timeoutId=setTimeout(this.handleStart,n.delay),this.handlePending(n);return}if(J_(n)){this.handlePending(n);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(e,n){const{active:r,onPending:s}=this.props;s(r,e,this.initialCoordinates,n)}handleStart(){const{initialCoordinates:e}=this,{onStart:n}=this.props;e&&(this.activated=!0,this.documentListeners.add(Ot.Click,dj,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(Ot.SelectionChange,this.removeTextSelection),n(e))}handleMove(e){var n;const{activated:r,initialCoordinates:s,props:i}=this,{onMove:o,options:{activationConstraint:l}}=i;if(!s)return;const a=(n=nh(e))!=null?n:nn,u=Wa(s,a);if(!r&&l){if(J_(l)){if(l.tolerance!=null&&ju(u,l.tolerance))return this.handleCancel();if(ju(u,l.distance))return this.handleStart()}if(Z_(l)&&ju(u,l.tolerance))return this.handleCancel();this.handlePending(l,u);return}e.cancelable&&e.preventDefault(),o(a)}handleEnd(){const{onAbort:e,onEnd:n}=this.props;this.detach(),this.activated||e(this.props.active),n()}handleCancel(){const{onAbort:e,onCancel:n}=this.props;this.detach(),this.activated||e(this.props.active),n()}handleKeydown(e){e.code===le.Esc&&this.handleCancel()}removeTextSelection(){var e;(e=this.document.getSelection())==null||e.removeAllRanges()}}const fj={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class Rc extends pp{constructor(e){const{event:n}=e,r=pi(n.target);super(e,fj,r)}}Rc.activators=[{eventName:"onPointerDown",handler:(t,e)=>{let{nativeEvent:n}=t,{onActivation:r}=e;return!n.isPrimary||n.button!==0?!1:(r==null||r({event:n}),!0)}}];const pj={move:{name:"mousemove"},end:{name:"mouseup"}};var sh;(function(t){t[t.RightClick=2]="RightClick"})(sh||(sh={}));class mj extends pp{constructor(e){super(e,pj,pi(e.event.target))}}mj.activators=[{eventName:"onMouseDown",handler:(t,e)=>{let{nativeEvent:n}=t,{onActivation:r}=e;return n.button===sh.RightClick?!1:(r==null||r({event:n}),!0)}}];const Pu={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class mp extends pp{constructor(e){super(e,Pu)}static setup(){return window.addEventListener(Pu.move.name,e,{capture:!1,passive:!1}),function(){window.removeEventListener(Pu.move.name,e)};function e(){}}}mp.activators=[{eventName:"onTouchStart",handler:(t,e)=>{let{nativeEvent:n}=t,{onActivation:r}=e;const{touches:s}=n;return s.length>1?!1:(r==null||r({event:n}),!0)}}];var ro;(function(t){t[t.Pointer=0]="Pointer",t[t.DraggableRect=1]="DraggableRect"})(ro||(ro={}));var Ya;(function(t){t[t.TreeOrder=0]="TreeOrder",t[t.ReversedTreeOrder=1]="ReversedTreeOrder"})(Ya||(Ya={}));function _j(t){let{acceleration:e,activator:n=ro.Pointer,canScroll:r,draggingRect:s,enabled:i,interval:o=5,order:l=Ya.TreeOrder,pointerCoordinates:a,scrollableAncestors:u,scrollableAncestorRects:h,delta:d,threshold:f}=t;const p=yj({delta:d,disabled:!i}),[v,w]=TR(),k=y.useRef({x:0,y:0}),_=y.useRef({x:0,y:0}),m=y.useMemo(()=>{switch(n){case ro.Pointer:return a?{top:a.y,bottom:a.y,left:a.x,right:a.x}:null;case ro.DraggableRect:return s}},[n,s,a]),g=y.useRef(null),x=y.useCallback(()=>{const C=g.current;if(!C)return;const N=k.current.x*_.current.x,S=k.current.y*_.current.y;C.scrollBy(N,S)},[]),b=y.useMemo(()=>l===Ya.TreeOrder?[...u].reverse():u,[l,u]);y.useEffect(()=>{if(!i||!u.length||!m){w();return}for(const C of b){if((r==null?void 0:r(C))===!1)continue;const N=u.indexOf(C),S=h[N];if(!S)continue;const{direction:j,speed:E}=sj(C,S,m,e,f);for(const I of["x","y"])p[I][j[I]]||(E[I]=0,j[I]=0);if(E.x>0||E.y>0){w(),g.current=C,v(x,o),k.current=E,_.current=j;return}}k.current={x:0,y:0},_.current={x:0,y:0},w()},[e,x,r,w,i,o,JSON.stringify(m),JSON.stringify(p),v,u,b,h,JSON.stringify(f)])}const gj={x:{[$e.Backward]:!1,[$e.Forward]:!1},y:{[$e.Backward]:!1,[$e.Forward]:!1}};function yj(t){let{delta:e,disabled:n}=t;const r=th(e);return Zo(s=>{if(n||!r||!s)return gj;const i={x:Math.sign(e.x-r.x),y:Math.sign(e.y-r.y)};return{x:{[$e.Backward]:s.x[$e.Backward]||i.x===-1,[$e.Forward]:s.x[$e.Forward]||i.x===1},y:{[$e.Backward]:s.y[$e.Backward]||i.y===-1,[$e.Forward]:s.y[$e.Forward]||i.y===1}}},[n,e,r])}function vj(t,e){const n=e!=null?t.get(e):void 0,r=n?n.node.current:null;return Zo(s=>{var i;return e==null?null:(i=r??s)!=null?i:null},[r,e])}function xj(t,e){return y.useMemo(()=>t.reduce((n,r)=>{const{sensor:s}=r,i=s.activators.map(o=>({eventName:o.eventName,handler:e(o.handler,r)}));return[...n,...i]},[]),[t,e])}var Mo;(function(t){t[t.Always=0]="Always",t[t.BeforeDragging=1]="BeforeDragging",t[t.WhileDragging=2]="WhileDragging"})(Mo||(Mo={}));var ih;(function(t){t.Optimized="optimized"})(ih||(ih={}));const e0=new Map;function bj(t,e){let{dragging:n,dependencies:r,config:s}=e;const[i,o]=y.useState(null),{frequency:l,measure:a,strategy:u}=s,h=y.useRef(t),d=k(),f=Do(d),p=y.useCallback(function(_){_===void 0&&(_=[]),!f.current&&o(m=>m===null?_:m.concat(_.filter(g=>!m.includes(g))))},[f]),v=y.useRef(null),w=Zo(_=>{if(d&&!n)return e0;if(!_||_===e0||h.current!==t||i!=null){const m=new Map;for(let g of t){if(!g)continue;if(i&&i.length>0&&!i.includes(g.id)&&g.rect.current){m.set(g.id,g.rect.current);continue}const x=g.node.current,b=x?new fp(a(x),x):null;g.rect.current=b,b&&m.set(g.id,b)}return m}return _},[t,i,n,d,a]);return y.useEffect(()=>{h.current=t},[t]),y.useEffect(()=>{d||p()},[n,d]),y.useEffect(()=>{i&&i.length>0&&o(null)},[JSON.stringify(i)]),y.useEffect(()=>{d||typeof l!="number"||v.current!==null||(v.current=setTimeout(()=>{p(),v.current=null},l))},[l,d,p,...r]),{droppableRects:w,measureDroppableContainers:p,measuringScheduled:i!=null};function k(){switch(u){case Mo.Always:return!1;case Mo.BeforeDragging:return n;default:return!n}}}function hb(t,e){return Zo(n=>t?n||(typeof e=="function"?e(t):t):null,[e,t])}function wj(t,e){return hb(t,e)}function kj(t){let{callback:e,disabled:n}=t;const r=up(e),s=y.useMemo(()=>{if(n||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:i}=window;return new i(r)},[r,n]);return y.useEffect(()=>()=>s==null?void 0:s.disconnect(),[s]),s}function jc(t){let{callback:e,disabled:n}=t;const r=up(e),s=y.useMemo(()=>{if(n||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:i}=window;return new i(r)},[n]);return y.useEffect(()=>()=>s==null?void 0:s.disconnect(),[s]),s}function Cj(t){return new fp(mi(t),t)}function t0(t,e,n){e===void 0&&(e=Cj);const[r,s]=y.useState(null);function i(){s(a=>{if(!t)return null;if(t.isConnected===!1){var u;return(u=a??n)!=null?u:null}const h=e(t);return JSON.stringify(a)===JSON.stringify(h)?a:h})}const o=kj({callback(a){if(t)for(const u of a){const{type:h,target:d}=u;if(h==="childList"&&d instanceof HTMLElement&&d.contains(t)){i();break}}}}),l=jc({callback:i});return gn(()=>{i(),t?(l==null||l.observe(t),o==null||o.observe(document.body,{childList:!0,subtree:!0})):(l==null||l.disconnect(),o==null||o.disconnect())},[t]),r}function Sj(t){const e=hb(t);return rb(t,e)}const n0=[];function Ej(t){const e=y.useRef(t),n=Zo(r=>t?r&&r!==n0&&t&&e.current&&t.parentNode===e.current.parentNode?r:hp(t):n0,[t]);return y.useEffect(()=>{e.current=t},[t]),n}function Nj(t){const[e,n]=y.useState(null),r=y.useRef(t),s=y.useCallback(i=>{const o=Ru(i.target);o&&n(l=>l?(l.set(o,rh(o)),new Map(l)):null)},[]);return y.useEffect(()=>{const i=r.current;if(t!==i){o(i);const l=t.map(a=>{const u=Ru(a);return u?(u.addEventListener("scroll",s,{passive:!0}),[u,rh(u)]):null}).filter(a=>a!=null);n(l.length?new Map(l):null),r.current=t}return()=>{o(t),o(i)};function o(l){l.forEach(a=>{const u=Ru(a);u==null||u.removeEventListener("scroll",s)})}},[s,t]),y.useMemo(()=>t.length?e?Array.from(e.values()).reduce((i,o)=>Bs(i,o),nn):cb(t):nn,[t,e])}function r0(t,e){e===void 0&&(e=[]);const n=y.useRef(null);return y.useEffect(()=>{n.current=null},e),y.useEffect(()=>{const r=t!==nn;r&&!n.current&&(n.current=t),!r&&n.current&&(n.current=null)},[t]),n.current?Wa(t,n.current):nn}function Ij(t){y.useEffect(()=>{if(!Tc)return;const e=t.map(n=>{let{sensor:r}=n;return r.setup==null?void 0:r.setup()});return()=>{for(const n of e)n==null||n()}},t.map(e=>{let{sensor:n}=e;return n}))}function Tj(t,e){return y.useMemo(()=>t.reduce((n,r)=>{let{eventName:s,handler:i}=r;return n[s]=o=>{i(o,e)},n},{}),[t,e])}function fb(t){return y.useMemo(()=>t?ej(t):null,[t])}const s0=[];function Rj(t,e){e===void 0&&(e=mi);const[n]=t,r=fb(n?bt(n):null),[s,i]=y.useState(s0);function o(){i(()=>t.length?t.map(a=>lb(a)?r:new fp(e(a),a)):s0)}const l=jc({callback:o});return gn(()=>{l==null||l.disconnect(),o(),t.forEach(a=>l==null?void 0:l.observe(a))},[t]),s}function jj(t){if(!t)return null;if(t.children.length>1)return t;const e=t.children[0];return Jo(e)?e:t}function Pj(t){let{measure:e}=t;const[n,r]=y.useState(null),s=y.useCallback(u=>{for(const{target:h}of u)if(Jo(h)){r(d=>{const f=e(h);return d?{...d,width:f.width,height:f.height}:f});break}},[e]),i=jc({callback:s}),o=y.useCallback(u=>{const h=jj(u);i==null||i.disconnect(),h&&(i==null||i.observe(h)),r(h?e(h):null)},[e,i]),[l,a]=$a(o);return y.useMemo(()=>({nodeRef:l,rect:n,setRef:a}),[n,l,a])}const Aj=[{sensor:Rc,options:{}},{sensor:db,options:{}}],Lj={current:{}},Ql={draggable:{measure:X_},droppable:{measure:X_,strategy:Mo.WhileDragging,frequency:ih.Optimized},dragOverlay:{measure:mi}};class so extends Map{get(e){var n;return e!=null&&(n=super.get(e))!=null?n:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(e=>{let{disabled:n}=e;return!n})}getNodeFor(e){var n,r;return(n=(r=this.get(e))==null?void 0:r.node.current)!=null?n:void 0}}const Oj={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new so,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:Ha},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:Ql,measureDroppableContainers:Ha,windowRect:null,measuringScheduled:!1},Dj={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:Ha,draggableNodes:new Map,over:null,measureDroppableContainers:Ha},Pc=y.createContext(Dj),pb=y.createContext(Oj);function Mj(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new so}}}function zj(t,e){switch(e.type){case De.DragStart:return{...t,draggable:{...t.draggable,initialCoordinates:e.initialCoordinates,active:e.active}};case De.DragMove:return t.draggable.active==null?t:{...t,draggable:{...t.draggable,translate:{x:e.coordinates.x-t.draggable.initialCoordinates.x,y:e.coordinates.y-t.draggable.initialCoordinates.y}}};case De.DragEnd:case De.DragCancel:return{...t,draggable:{...t.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case De.RegisterDroppable:{const{element:n}=e,{id:r}=n,s=new so(t.droppable.containers);return s.set(r,n),{...t,droppable:{...t.droppable,containers:s}}}case De.SetDroppableDisabled:{const{id:n,key:r,disabled:s}=e,i=t.droppable.containers.get(n);if(!i||r!==i.key)return t;const o=new so(t.droppable.containers);return o.set(n,{...i,disabled:s}),{...t,droppable:{...t.droppable,containers:o}}}case De.UnregisterDroppable:{const{id:n,key:r}=e,s=t.droppable.containers.get(n);if(!s||r!==s.key)return t;const i=new so(t.droppable.containers);return i.delete(n),{...t,droppable:{...t.droppable,containers:i}}}default:return t}}function Uj(t){let{disabled:e}=t;const{active:n,activatorEvent:r,draggableNodes:s}=y.useContext(Pc),i=th(r),o=th(n==null?void 0:n.id);return y.useEffect(()=>{if(!e&&!r&&i&&o!=null){if(!dp(i)||document.activeElement===i.target)return;const l=s.get(o);if(!l)return;const{activatorNode:a,node:u}=l;if(!a.current&&!u.current)return;requestAnimationFrame(()=>{for(const h of[a.current,u.current]){if(!h)continue;const d=PR(h);if(d){d.focus();break}}})}},[r,e,s,o,i]),null}function Fj(t,e){let{transform:n,...r}=e;return t!=null&&t.length?t.reduce((s,i)=>i({transform:s,...r}),n):n}function Bj(t){return y.useMemo(()=>({draggable:{...Ql.draggable,...t==null?void 0:t.draggable},droppable:{...Ql.droppable,...t==null?void 0:t.droppable},dragOverlay:{...Ql.dragOverlay,...t==null?void 0:t.dragOverlay}}),[t==null?void 0:t.draggable,t==null?void 0:t.droppable,t==null?void 0:t.dragOverlay])}function $j(t){let{activeNode:e,measure:n,initialRect:r,config:s=!0}=t;const i=y.useRef(!1),{x:o,y:l}=typeof s=="boolean"?{x:s,y:s}:s;gn(()=>{if(!o&&!l||!e){i.current=!1;return}if(i.current||!r)return;const u=e==null?void 0:e.node.current;if(!u||u.isConnected===!1)return;const h=n(u),d=rb(h,r);if(o||(d.x=0),l||(d.y=0),i.current=!0,Math.abs(d.x)>0||Math.abs(d.y)>0){const f=sb(u);f&&f.scrollBy({top:d.y,left:d.x})}},[e,o,l,r,n])}const mb=y.createContext({...nn,scaleX:1,scaleY:1});var nr;(function(t){t[t.Uninitialized=0]="Uninitialized",t[t.Initializing=1]="Initializing",t[t.Initialized=2]="Initialized"})(nr||(nr={}));const _b=y.memo(function(e){var n,r,s,i;let{id:o,accessibility:l,autoScroll:a=!0,children:u,sensors:h=Aj,collisionDetection:d=QR,measuring:f,modifiers:p,...v}=e;const w=y.useReducer(zj,void 0,Mj),[k,_]=w,[m,g]=zR(),[x,b]=y.useState(nr.Uninitialized),C=x===nr.Initialized,{draggable:{active:N,nodes:S,translate:j},droppable:{containers:E}}=k,I=N!=null?S.get(N):null,T=y.useRef({initial:null,translated:null}),L=y.useMemo(()=>{var et;return N!=null?{id:N,data:(et=I==null?void 0:I.data)!=null?et:Lj,rect:T}:null},[N,I]),q=y.useRef(null),[Z,X]=y.useState(null),[K,z]=y.useState(null),M=Do(v,Object.values(v)),R=el("DndDescribedBy",o),U=y.useMemo(()=>E.getEnabled(),[E]),B=Bj(f),{droppableRects:V,measureDroppableContainers:ie,measuringScheduled:P}=bj(U,{dragging:C,dependencies:[j.x,j.y],config:B.droppable}),F=vj(S,N),J=y.useMemo(()=>K?nh(K):null,[K]),ue=Nb(),fe=wj(F,B.draggable.measure);$j({activeNode:N!=null?S.get(N):null,config:ue.layoutShiftCompensation,initialRect:fe,measure:B.draggable.measure});const ee=t0(F,B.draggable.measure,fe),vn=t0(F?F.parentElement:null),Ze=y.useRef({activatorEvent:null,active:null,activeNode:F,collisionRect:null,collisions:null,droppableRects:V,draggableNodes:S,draggingNode:null,draggingNodeRect:null,droppableContainers:E,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),Vn=E.getNodeFor((n=Ze.current.over)==null?void 0:n.id),At=Pj({measure:B.dragOverlay.measure}),Yn=(r=At.nodeRef.current)!=null?r:F,Qn=C?(s=At.rect)!=null?s:ee:null,tl=!!(At.nodeRef.current&&At.rect),nl=Sj(tl?null:ee),_i=fb(Yn?bt(Yn):null),rn=Ej(C?Vn??F:null),cs=Rj(rn),Pr=Fj(p,{transform:{x:j.x-nl.x,y:j.y-nl.y,scaleX:1,scaleY:1},activatorEvent:K,active:L,activeNodeRect:ee,containerNodeRect:vn,draggingNodeRect:Qn,over:Ze.current.over,overlayNodeRect:At.rect,scrollableAncestors:rn,scrollableAncestorRects:cs,windowRect:_i}),gi=J?Bs(J,j):null,yi=Nj(rn),rl=r0(yi),sl=r0(yi,[ee]),A=Bs(Pr,rl),H=Qn?XR(Qn,Pr):null,Q=L&&H?d({active:L,collisionRect:H,droppableRects:V,droppableContainers:U,pointerCoordinates:gi}):null,be=VR(Q,"id"),[pe,Wt]=y.useState(null),sn=tl?Pr:Bs(Pr,sl),wt=GR(sn,(i=pe==null?void 0:pe.rect)!=null?i:null,ee),Lc=y.useRef(null),_p=y.useCallback((et,kt)=>{let{sensor:Ct,options:Gn}=kt;if(q.current==null)return;const Lt=S.get(q.current);if(!Lt)return;const St=et.nativeEvent,on=new Ct({active:q.current,activeNode:Lt,event:St,options:Gn,context:Ze,onAbort(Ye){if(!S.get(Ye))return;const{onDragAbort:ln}=M.current,xn={id:Ye};ln==null||ln(xn),m({type:"onDragAbort",event:xn})},onPending(Ye,qn,ln,xn){if(!S.get(Ye))return;const{onDragPending:xi}=M.current,Xn={id:Ye,constraint:qn,initialCoordinates:ln,offset:xn};xi==null||xi(Xn),m({type:"onDragPending",event:Xn})},onStart(Ye){const qn=q.current;if(qn==null)return;const ln=S.get(qn);if(!ln)return;const{onDragStart:xn}=M.current,vi={activatorEvent:St,active:{id:qn,data:ln.data,rect:T}};Ns.unstable_batchedUpdates(()=>{xn==null||xn(vi),b(nr.Initializing),_({type:De.DragStart,initialCoordinates:Ye,active:qn}),m({type:"onDragStart",event:vi}),X(Lc.current),z(St)})},onMove(Ye){_({type:De.DragMove,coordinates:Ye})},onEnd:us(De.DragEnd),onCancel:us(De.DragCancel)});Lc.current=on;function us(Ye){return async function(){const{active:ln,collisions:xn,over:vi,scrollAdjustedTranslate:xi}=Ze.current;let Xn=null;if(ln&&xi){const{cancelDrop:bi}=M.current;Xn={activatorEvent:St,active:ln,collisions:xn,delta:xi,over:vi},Ye===De.DragEnd&&typeof bi=="function"&&await Promise.resolve(bi(Xn))&&(Ye=De.DragCancel)}q.current=null,Ns.unstable_batchedUpdates(()=>{_({type:Ye}),b(nr.Uninitialized),Wt(null),X(null),z(null),Lc.current=null;const bi=Ye===De.DragEnd?"onDragEnd":"onDragCancel";if(Xn){const Oc=M.current[bi];Oc==null||Oc(Xn),m({type:bi,event:Xn})}})}}},[S]),Cb=y.useCallback((et,kt)=>(Ct,Gn)=>{const Lt=Ct.nativeEvent,St=S.get(Gn);if(q.current!==null||!St||Lt.dndKit||Lt.defaultPrevented)return;const on={active:St};et(Ct,kt.options,on)===!0&&(Lt.dndKit={capturedBy:kt.sensor},q.current=Gn,_p(Ct,kt))},[S,_p]),gp=xj(h,Cb);Ij(h),gn(()=>{ee&&x===nr.Initializing&&b(nr.Initialized)},[ee,x]),y.useEffect(()=>{const{onDragMove:et}=M.current,{active:kt,activatorEvent:Ct,collisions:Gn,over:Lt}=Ze.current;if(!kt||!Ct)return;const St={active:kt,activatorEvent:Ct,collisions:Gn,delta:{x:A.x,y:A.y},over:Lt};Ns.unstable_batchedUpdates(()=>{et==null||et(St),m({type:"onDragMove",event:St})})},[A.x,A.y]),y.useEffect(()=>{const{active:et,activatorEvent:kt,collisions:Ct,droppableContainers:Gn,scrollAdjustedTranslate:Lt}=Ze.current;if(!et||q.current==null||!kt||!Lt)return;const{onDragOver:St}=M.current,on=Gn.get(be),us=on&&on.rect.current?{id:on.id,rect:on.rect.current,data:on.data,disabled:on.disabled}:null,Ye={active:et,activatorEvent:kt,collisions:Ct,delta:{x:Lt.x,y:Lt.y},over:us};Ns.unstable_batchedUpdates(()=>{Wt(us),St==null||St(Ye),m({type:"onDragOver",event:Ye})})},[be]),gn(()=>{Ze.current={activatorEvent:K,active:L,activeNode:F,collisionRect:H,collisions:Q,droppableRects:V,draggableNodes:S,draggingNode:Yn,draggingNodeRect:Qn,droppableContainers:E,over:pe,scrollableAncestors:rn,scrollAdjustedTranslate:A},T.current={initial:Qn,translated:H}},[L,F,Q,H,S,Yn,Qn,V,E,pe,rn,A]),_j({...ue,delta:j,draggingRect:H,pointerCoordinates:gi,scrollableAncestors:rn,scrollableAncestorRects:cs});const Sb=y.useMemo(()=>({active:L,activeNode:F,activeNodeRect:ee,activatorEvent:K,collisions:Q,containerNodeRect:vn,dragOverlay:At,draggableNodes:S,droppableContainers:E,droppableRects:V,over:pe,measureDroppableContainers:ie,scrollableAncestors:rn,scrollableAncestorRects:cs,measuringConfiguration:B,measuringScheduled:P,windowRect:_i}),[L,F,ee,K,Q,vn,At,S,E,V,pe,ie,rn,cs,B,P,_i]),Eb=y.useMemo(()=>({activatorEvent:K,activators:gp,active:L,activeNodeRect:ee,ariaDescribedById:{draggable:R},dispatch:_,draggableNodes:S,over:pe,measureDroppableContainers:ie}),[K,gp,L,ee,_,R,S,pe,ie]);return lt.createElement(eb.Provider,{value:g},lt.createElement(Pc.Provider,{value:Eb},lt.createElement(pb.Provider,{value:Sb},lt.createElement(mb.Provider,{value:wt},u)),lt.createElement(Uj,{disabled:(l==null?void 0:l.restoreFocus)===!1})),lt.createElement(BR,{...l,hiddenTextDescribedById:R}));function Nb(){const et=(Z==null?void 0:Z.autoScrollEnabled)===!1,kt=typeof a=="object"?a.enabled===!1:a===!1,Ct=C&&!et&&!kt;return typeof a=="object"?{...a,enabled:Ct}:{enabled:Ct}}}),Wj=y.createContext(null),i0="button",Hj="Draggable";function Vj(t){let{id:e,data:n,disabled:r=!1,attributes:s}=t;const i=el(Hj),{activators:o,activatorEvent:l,active:a,activeNodeRect:u,ariaDescribedById:h,draggableNodes:d,over:f}=y.useContext(Pc),{role:p=i0,roleDescription:v="draggable",tabIndex:w=0}=s??{},k=(a==null?void 0:a.id)===e,_=y.useContext(k?mb:Wj),[m,g]=$a(),[x,b]=$a(),C=Tj(o,e),N=Do(n);gn(()=>(d.set(e,{id:e,key:i,node:m,activatorNode:x,data:N}),()=>{const j=d.get(e);j&&j.key===i&&d.delete(e)}),[d,e]);const S=y.useMemo(()=>({role:p,tabIndex:w,"aria-disabled":r,"aria-pressed":k&&p===i0?!0:void 0,"aria-roledescription":v,"aria-describedby":h.draggable}),[r,p,w,k,v,h.draggable]);return{active:a,activatorEvent:l,activeNodeRect:u,attributes:S,isDragging:k,listeners:r?void 0:C,node:m,over:f,setNodeRef:g,setActivatorNodeRef:b,transform:_}}function Yj(){return y.useContext(pb)}const Qj="Droppable",Gj={timeout:25};function qj(t){let{data:e,disabled:n=!1,id:r,resizeObserverConfig:s}=t;const i=el(Qj),{active:o,dispatch:l,over:a,measureDroppableContainers:u}=y.useContext(Pc),h=y.useRef({disabled:n}),d=y.useRef(!1),f=y.useRef(null),p=y.useRef(null),{disabled:v,updateMeasurementsFor:w,timeout:k}={...Gj,...s},_=Do(w??r),m=y.useCallback(()=>{if(!d.current){d.current=!0;return}p.current!=null&&clearTimeout(p.current),p.current=setTimeout(()=>{u(Array.isArray(_.current)?_.current:[_.current]),p.current=null},k)},[k]),g=jc({callback:m,disabled:v||!o}),x=y.useCallback((S,j)=>{g&&(j&&(g.unobserve(j),d.current=!1),S&&g.observe(S))},[g]),[b,C]=$a(x),N=Do(e);return y.useEffect(()=>{!g||!b.current||(g.disconnect(),d.current=!1,g.observe(b.current))},[b,g]),y.useEffect(()=>(l({type:De.RegisterDroppable,element:{id:r,key:i,disabled:n,node:b,rect:f,data:N}}),()=>l({type:De.UnregisterDroppable,key:i,id:r})),[r]),y.useEffect(()=>{n!==h.current.disabled&&(l({type:De.SetDroppableDisabled,id:r,key:i,disabled:n}),h.current.disabled=n)},[r,i,n,l]),{active:o,rect:f,isOver:(a==null?void 0:a.id)===r,node:b,over:a,setNodeRef:C}}function Ac(t,e,n){const r=t.slice();return r.splice(n<0?r.length+n:n,0,r.splice(e,1)[0]),r}function Xj(t,e){return t.reduce((n,r,s)=>{const i=e.get(r);return i&&(n[s]=i),n},Array(t.length))}function Nl(t){return t!==null&&t>=0}function Kj(t,e){if(t===e)return!0;if(t.length!==e.length)return!1;for(let n=0;n<t.length;n++)if(t[n]!==e[n])return!1;return!0}function Jj(t){return typeof t=="boolean"?{draggable:t,droppable:t}:t}const gb=t=>{let{rects:e,activeIndex:n,overIndex:r,index:s}=t;const i=Ac(e,r,n),o=e[s],l=i[s];return!l||!o?null:{x:l.left-o.left,y:l.top-o.top,scaleX:l.width/o.width,scaleY:l.height/o.height}},Il={scaleX:1,scaleY:1},yb=t=>{var e;let{activeIndex:n,activeNodeRect:r,index:s,rects:i,overIndex:o}=t;const l=(e=i[n])!=null?e:r;if(!l)return null;if(s===n){const u=i[o];return u?{x:0,y:n<o?u.top+u.height-(l.top+l.height):u.top-l.top,...Il}:null}const a=Zj(i,s,n);return s>n&&s<=o?{x:0,y:-l.height-a,...Il}:s<n&&s>=o?{x:0,y:l.height+a,...Il}:{x:0,y:0,...Il}};function Zj(t,e,n){const r=t[e],s=t[e-1],i=t[e+1];return r?n<e?s?r.top-(s.top+s.height):i?i.top-(r.top+r.height):0:i?i.top-(r.top+r.height):s?r.top-(s.top+s.height):0:0}const vb="Sortable",xb=lt.createContext({activeIndex:-1,containerId:vb,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:gb,disabled:{draggable:!1,droppable:!1}});function bb(t){let{children:e,id:n,items:r,strategy:s=gb,disabled:i=!1}=t;const{active:o,dragOverlay:l,droppableRects:a,over:u,measureDroppableContainers:h}=Yj(),d=el(vb,n),f=l.rect!==null,p=y.useMemo(()=>r.map(C=>typeof C=="object"&&"id"in C?C.id:C),[r]),v=o!=null,w=o?p.indexOf(o.id):-1,k=u?p.indexOf(u.id):-1,_=y.useRef(p),m=!Kj(p,_.current),g=k!==-1&&w===-1||m,x=Jj(i);gn(()=>{m&&v&&h(p)},[m,p,v,h]),y.useEffect(()=>{_.current=p},[p]);const b=y.useMemo(()=>({activeIndex:w,containerId:d,disabled:x,disableTransforms:g,items:p,overIndex:k,useDragOverlay:f,sortedRects:Xj(p,a),strategy:s}),[w,d,x.draggable,x.droppable,g,p,k,a,f,s]);return lt.createElement(xb.Provider,{value:b},e)}const eP=t=>{let{id:e,items:n,activeIndex:r,overIndex:s}=t;return Ac(n,r,s).indexOf(e)},tP=t=>{let{containerId:e,isSorting:n,wasDragging:r,index:s,items:i,newIndex:o,previousItems:l,previousContainerId:a,transition:u}=t;return!u||!r||l!==i&&s===o?!1:n?!0:o!==s&&e===a},nP={duration:200,easing:"ease"},wb="transform",rP=ri.Transition.toString({property:wb,duration:0,easing:"linear"}),sP={roleDescription:"sortable"};function iP(t){let{disabled:e,index:n,node:r,rect:s}=t;const[i,o]=y.useState(null),l=y.useRef(n);return gn(()=>{if(!e&&n!==l.current&&r.current){const a=s.current;if(a){const u=mi(r.current,{ignoreTransform:!0}),h={x:a.left-u.left,y:a.top-u.top,scaleX:a.width/u.width,scaleY:a.height/u.height};(h.x||h.y)&&o(h)}}n!==l.current&&(l.current=n)},[e,n,r,s]),y.useEffect(()=>{i&&o(null)},[i]),i}function kb(t){let{animateLayoutChanges:e=tP,attributes:n,disabled:r,data:s,getNewIndex:i=eP,id:o,strategy:l,resizeObserverConfig:a,transition:u=nP}=t;const{items:h,containerId:d,activeIndex:f,disabled:p,disableTransforms:v,sortedRects:w,overIndex:k,useDragOverlay:_,strategy:m}=y.useContext(xb),g=oP(r,p),x=h.indexOf(o),b=y.useMemo(()=>({sortable:{containerId:d,index:x,items:h},...s}),[d,s,x,h]),C=y.useMemo(()=>h.slice(h.indexOf(o)),[h,o]),{rect:N,node:S,isOver:j,setNodeRef:E}=qj({id:o,data:b,disabled:g.droppable,resizeObserverConfig:{updateMeasurementsFor:C,...a}}),{active:I,activatorEvent:T,activeNodeRect:L,attributes:q,setNodeRef:Z,listeners:X,isDragging:K,over:z,setActivatorNodeRef:M,transform:R}=Vj({id:o,data:b,attributes:{...sP,...n},disabled:g.draggable}),U=IR(E,Z),B=!!I,V=B&&!v&&Nl(f)&&Nl(k),ie=!_&&K,P=ie&&V?R:null,J=V?P??(l??m)({rects:w,activeNodeRect:L,activeIndex:f,overIndex:k,index:x}):null,ue=Nl(f)&&Nl(k)?i({id:o,items:h,activeIndex:f,overIndex:k}):x,fe=I==null?void 0:I.id,ee=y.useRef({activeId:fe,items:h,newIndex:ue,containerId:d}),vn=h!==ee.current.items,Ze=e({active:I,containerId:d,isDragging:K,isSorting:B,id:o,index:x,items:h,newIndex:ee.current.newIndex,previousItems:ee.current.items,previousContainerId:ee.current.containerId,transition:u,wasDragging:ee.current.activeId!=null}),Vn=iP({disabled:!Ze,index:x,node:S,rect:N});return y.useEffect(()=>{B&&ee.current.newIndex!==ue&&(ee.current.newIndex=ue),d!==ee.current.containerId&&(ee.current.containerId=d),h!==ee.current.items&&(ee.current.items=h)},[B,ue,d,h]),y.useEffect(()=>{if(fe===ee.current.activeId)return;if(fe!=null&&ee.current.activeId==null){ee.current.activeId=fe;return}const Yn=setTimeout(()=>{ee.current.activeId=fe},50);return()=>clearTimeout(Yn)},[fe]),{active:I,activeIndex:f,attributes:q,data:b,rect:N,index:x,newIndex:ue,items:h,isOver:j,isSorting:B,isDragging:K,listeners:X,node:S,overIndex:k,over:z,setNodeRef:U,setActivatorNodeRef:M,setDroppableNodeRef:E,setDraggableNodeRef:Z,transform:Vn??J,transition:At()};function At(){if(Vn||vn&&ee.current.newIndex===x)return rP;if(!(ie&&!dp(T)||!u)&&(B||Ze))return ri.Transition.toString({...u,property:wb})}}function oP(t,e){var n,r;return typeof t=="boolean"?{draggable:t,droppable:!1}:{draggable:(n=t==null?void 0:t.draggable)!=null?n:e.draggable,droppable:(r=t==null?void 0:t.droppable)!=null?r:e.droppable}}le.Down,le.Right,le.Up,le.Left;const o0={"clipboard-list":Zd,footprints:f4,briefcase:UT,plane:J4,"person-standing":X4,backpack:AT,umbrella:bR,tent:yR,target:_R,"shopping-cart":aR,shirt:oR,dumbbell:a4,mountain:$4,baby:OT,camera:op,heart:x4,music:H4,"book-open":MT,coffee:n4,gift:g4},l0={"📋":"clipboard-list","🚶":"footprints","💼":"briefcase","✈️":"plane","🏃":"person-standing","🎒":"backpack","🏖️":"umbrella","🏕️":"tent","🎯":"target","🛒":"shopping-cart"};function lP(t){return l0[t]?o0[l0[t]]||Zd:o0[t]||Zd}function io({name:t,size:e=20,className:n=""}){const r=lP(t);return c.jsx(r,{size:e,className:n})}function Au({message:t,onConfirm:e,onCancel:n}){return c.jsxs("div",{className:"fixed inset-0 z-50 flex items-end justify-center",onClick:n,children:[c.jsx("div",{className:"absolute inset-0 bg-black bg-opacity-50"}),c.jsx("div",{className:"relative w-full max-w-lg bg-white dark:bg-slate-800 rounded-t-2xl animate-slide-up safe-bottom",onClick:r=>r.stopPropagation(),children:c.jsxs("div",{className:"p-6",children:[c.jsx("p",{className:"text-center text-lg text-slate-800 dark:text-slate-100 mb-6",children:t}),c.jsxs("div",{className:"flex gap-3",children:[c.jsx("button",{onClick:n,className:"flex-1 py-3 text-slate-600 dark:text-slate-300 border border-slate-300 dark:border-slate-600 rounded-xl font-medium active:bg-slate-100 dark:active:bg-slate-700 transition-colors duration-150 min-h-[44px]",children:"取消"}),c.jsx("button",{onClick:e,className:"flex-1 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-xl font-medium active:bg-indigo-700 dark:active:bg-indigo-600 transition-colors duration-150 min-h-[44px]",children:"確定"})]})]})})]})}function aP(){const t=["bg-red-400","bg-yellow-400","bg-green-400","bg-blue-400","bg-purple-400","bg-pink-400","bg-indigo-400","bg-emerald-400","bg-orange-400","bg-cyan-400"];return c.jsxs("div",{className:"fixed inset-0 z-40 pointer-events-none overflow-hidden",children:[Array.from({length:30}).map((e,n)=>c.jsx("div",{className:`absolute w-2.5 h-2.5 rounded-sm animate-confetti ${t[n%t.length]}`,style:{left:`${Math.random()*100}%`,animationDelay:`${Math.random()*.8}s`,animationDuration:`${1.5+Math.random()*1}s`}},n)),c.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:c.jsxs("div",{className:"animate-celebration-text text-center",children:[c.jsx("div",{className:"text-6xl mb-2",children:"🎉"}),c.jsx("div",{className:"text-2xl font-bold text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 bg-opacity-90 dark:bg-opacity-90 px-6 py-3 rounded-2xl shadow-lg",children:"準備完成！"})]})})]})}function cP({item:t}){const{attributes:e,listeners:n,setNodeRef:r,transform:s,transition:i,isDragging:o}=kb({id:t.id}),l={transform:ri.Transform.toString(s),transition:i,zIndex:o?50:void 0,position:"relative"};return c.jsx("div",{ref:r,style:l,children:c.jsxs("div",{className:`flex items-center p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 min-h-[56px]
          ${o?"shadow-lg opacity-90":""}`,children:[c.jsx("div",{...e,...n,className:"w-6 h-6 mr-4 flex items-center justify-center flex-shrink-0 text-slate-400 dark:text-slate-500 touch-none cursor-grab active:cursor-grabbing",children:c.jsx(Qx,{size:20})}),c.jsx("div",{className:"flex-1 min-w-0",children:c.jsx("div",{className:"text-lg text-slate-800 dark:text-slate-100",children:t.name})})]})})}function uP({data:t,user:e,syncStatus:n,onLogin:r,onLogout:s,onNavigate:i,onSaveData:o,shared:l,activeSharedListId:a,categories:u=[]}){var yi,rl,sl;const[h,d]=y.useState([]),[f,p]=y.useState(null),[v,w]=y.useState(null),[k,_]=y.useState([]),[m,g]=y.useState(!1),[x,b]=y.useState("default"),[C,N]=y.useState(!1),[S,j]=y.useState(""),[E,I]=y.useState(u[0]||""),[T,L]=y.useState(null),q=a&&((yi=l==null?void 0:l.sharedWithMe)==null?void 0:yi[a]),Z=a&&((rl=l==null?void 0:l.sharedByMe)==null?void 0:rl[a]),X=q?"shared-with-me":Z?"own-shared":"local",K=q?l.sharedWithMe[a]:Z?l.sharedByMe[a]:null,z=X!=="shared-with-me"||(()=>{if(!(e!=null&&e.email)||!(K!=null&&K.sharedWith))return!1;const A=tr(e.email);return K.sharedWith[A]==="edit"})(),M=(sl=t.lists)==null?void 0:sl.find(A=>A.id===t.activeListId),R=M?{...M,items:Array.isArray(M.items)?M.items:[],checkedItems:Array.isArray(M.checkedItems)?M.checkedItems:[]}:null;let U=[],B=[],V="",ie="",P="";X==="shared-with-me"&&K?(U=(K.items||[]).filter(Boolean),B=K.checkedItems||[],V=K.name||"清單",ie=K.icon||"clipboard-list",P=K.ownerName||K.ownerEmail||""):X==="own-shared"&&R&&K?(U=R.items.map(A=>{var H;return(H=t.itemLibrary)==null?void 0:H.find(Q=>Q.id===A)}).filter(Boolean),B=K.checkedItems||[],V=R.name||"清單",ie=R.icon||"clipboard-list"):(U=R?R.items.map(A=>{var H;return(H=t.itemLibrary)==null?void 0:H.find(Q=>Q.id===A)}).filter(Boolean):[],B=(R==null?void 0:R.checkedItems)||[],V=(R==null?void 0:R.name)||"清單",ie=(R==null?void 0:R.icon)||"clipboard-list");const F=B.length,J=U.length,ue=J>0&&F===J,fe=J>0?F/J*100:0,ee=y.useRef(ue);y.useEffect(()=>{if(ue&&!ee.current){g(!0);const A=setTimeout(()=>g(!1),2500);return()=>clearTimeout(A)}ee.current=ue},[ue]);const vn=(()=>{const A=[],H={};return U.forEach(Q=>{const be=Q.category||"其他";H[be]||(H[be]=[]),H[be].push(Q)}),u.forEach(Q=>{H[Q]&&(A.push({category:Q,items:H[Q]}),delete H[Q])}),Object.keys(H).forEach(Q=>{A.push({category:Q,items:H[Q]})}),A})(),Ze=x==="name"?[...U].sort((A,H)=>A.name.localeCompare(H.name,"zh-Hant")):x==="unchecked"?[...U].sort((A,H)=>{const Q=B.includes(A.id)?1:0,be=B.includes(H.id)?1:0;return Q-be}):U,Vn=()=>{b(A=>A==="default"?"name":A==="name"?"unchecked":A==="unchecked"?X==="shared-with-me"?"default":"manual":"default")},At=x==="name"?"名稱":x==="unchecked"?"未勾選":x==="manual"?"手動":"",Yn=tb(Va(Rc,{activationConstraint:{distance:5}}),Va(mp,{activationConstraint:{delay:150,tolerance:5}})),Qn=A=>{const{active:H,over:Q}=A;if(!Q||H.id===Q.id)return;const be=R.items.indexOf(H.id),pe=R.items.indexOf(Q.id);if(be===-1||pe===-1)return;const Wt=Ac(R.items,be,pe),sn={...t,lists:t.lists.map(wt=>wt.id===t.activeListId?{...wt,items:Wt}:wt)};o(sn)},tl=A=>{if(w(A),X==="shared-with-me"||X==="own-shared")l.toggleSharedCheck(a,A);else{const H={...t,lists:t.lists.map(Q=>{if(Q.id!==t.activeListId)return Q;const be=Array.isArray(Q.checkedItems)?Q.checkedItems:[],pe=be.includes(A);return{...Q,checkedItems:pe?be.filter(Wt=>Wt!==A):[...be,A]}})};o(H)}},nl=()=>{if(X==="shared-with-me"||X==="own-shared")l.resetSharedChecks(a);else{const A={...t,lists:t.lists.map(H=>H.id===t.activeListId?{...H,checkedItems:[]}:H)};o(A)}},_i=()=>{if(X==="shared-with-me"||X==="own-shared"){const A=U.map(H=>H.id);l.checkAllShared(a,A)}else{if(!R)return;const A={...t,lists:t.lists.map(H=>H.id===t.activeListId?{...H,checkedItems:[...R.items]}:H)};o(A)}},rn=A=>{d(H=>H.includes(A)?H.filter(Q=>Q!==A):[...H,A])},cs=A=>{_(H=>H.includes(A)?H.filter(Q=>Q!==A):[...H,A])},Pr=()=>{const A=S.trim();if(A){if(X==="shared-with-me"){const Q={id:"shared_item_"+Date.now(),name:A,category:E};l.addSharedItem(a,Q)}else{if(!R)return;const H="item_"+Date.now(),Q={id:H,name:A,category:E},be={...t,itemLibrary:[...t.itemLibrary||[],Q],lists:t.lists.map(pe=>pe.id!==t.activeListId?pe:{...pe,items:[...Array.isArray(pe.items)?pe.items:[],H]})};o(be)}j(""),N(!1)}},gi=A=>{var sn;const H=B.includes(A.id),Q=(sn=A.note)==null?void 0:sn.trim(),be=Q||A.photoURL,pe=h.includes(A.id),Wt=v===A.id;return c.jsxs("div",{children:[c.jsxs("div",{onClick:()=>tl(A.id),className:`flex items-center p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 active:bg-slate-50 dark:active:bg-slate-700 transition-colors duration-150 cursor-pointer min-h-[56px]
