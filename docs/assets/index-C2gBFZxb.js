 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(U,M){var R=U.length;U.push(M);e:for(;0<R;){var z=R-1>>>1,B=U[z];if(0<s(B,M))U[z]=M,U[R]=B,R=z;else break e}}function n(U){return U.length===0?null:U[0]}function r(U){if(U.length===0)return null;var M=U[0],R=U.pop();if(R!==M){U[0]=R;e:for(var z=0,B=U.length,V=B>>>1;z<V;){var ie=2*(z+1)-1,P=U[ie],F=ie+1,J=U[F];if(0>s(P,R))F<B&&0>s(J,P)?(U[z]=J,U[F]=R,z=F):(U[z]=P,U[ie]=R,z=ie);else if(F<B&&0>s(J,R))U[z]=J,U[F]=R,z=F;else break e}}return M}function s(U,M){var R=U.sortIndex-M.sortIndex;return R!==0?R:U.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;t.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],h=1,d=null,f=3,p=!1,v=!1,w=!1,k=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(U){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=U)r(u),M.sortIndex=M.expirationTime,e(a,M);else break;M=n(u)}}function x(U){if(w=!1,y(U),!v)if(n(a)!==null)v=!0,X(b);else{var M=n(u);M!==null&&K(x,M.startTime-U)}}function b(U,M){v=!1,w&&(w=!1,_(C),C=-1),p=!0;var R=f;try{for(y(M),d=n(a);d!==null&&(!(d.expirationTime>M)||U&&!N());){var z=d.callback;if(typeof z=="function"){d.callback=null,f=d.priorityLevel;var B=z(d.expirationTime<=M);M=t.unstable_now(),typeof B=="function"?d.callback=B:d===n(a)&&r(a),y(M)}else r(a);d=n(a)}if(d!==null)var V=!0;else{var ie=n(u);ie!==null&&K(x,ie.startTime-M),V=!1}return V}finally{d=null,f=R,p=!1}}var S=!1,I=null,C=-1,j=5,E=-1;function N(){return!(t.unstable_now()-E<j)}function T(){if(I!==null){var U=t.unstable_now();E=U;var M=!0;try{M=I(!0,U)}finally{M?L():(S=!1,I=null)}}else S=!1}var L;if(typeof m=="function")L=function(){m(T)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,Z=q.port2;q.port1.onmessage=T,L=function(){Z.postMessage(null)}}else L=function(){k(T,0)};function X(U){I=U,S||(S=!0,L())}function K(U,M){C=k(function(){U(t.unstable_now())},M)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,X(b))},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(U){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var R=f;f=M;try{return U()}finally{f=R}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(U,M){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var R=f;f=U;try{return M()}finally{f=R}},t.unstable_scheduleCallback=function(U,M,R){var z=t.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?z+R:z):R=z,U){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=R+B,U={id:h++,callback:M,priorityLevel:U,startTime:R,expirationTime:B,sortIndex:-1},R>z?(U.sortIndex=R,e(u,U),n(a)===null&&U===n(u)&&(w?(_(C),C=-1):w=!0,K(x,R-z))):(U.sortIndex=B,e(a,U),v||p||(v=!0,X(b))),U},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(U){var M=f;return function(){var R=f;f=M;try{return U.apply(this,arguments)}finally{f=R}}}})(b0);x0.exports=b0;var Xb=x0.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zn=new rf("@firebase/app"),Xk="@firebase/app-compat",Kk="@firebase/analytics-compat",Jk="@firebase/analytics",Zk="@firebase/app-check-compat",e2="@firebase/app-check",t2="@firebase/auth",n2="@firebase/auth-compat",r2="@firebase/database",s2="@firebase/data-connect",i2="@firebase/database-compat",o2="@firebase/functions",l2="@firebase/functions-compat",a2="@firebase/installations",c2="@firebase/installations-compat",u2="@firebase/messaging",d2="@firebase/messaging-compat",h2="@firebase/performance",f2="@firebase/performance-compat",p2="@firebase/remote-config",m2="@firebase/remote-config-compat",_2="@firebase/storage",g2="@firebase/storage-compat",y2="@firebase/firestore",v2="@firebase/vertexai-preview",x2="@firebase/firestore-compat",b2="firebase",w2="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wa=new Map,C2=new Map,Ad=new Map;function Am(t,e){try{t.container.addComponent(e)}catch(n){zn.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Kr(t){const e=t.name;if(Ad.has(e))return zn.debug(`There were multiple attempts to register component ${e}.`),!1;Ad.set(e,t);for(const n of wa.values())Am(n,t);for(const n of C2.values())Am(n,t);return!0}function dc(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function Nn(t){return t.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N2="firebase-heartbeat-database",I2=1,So="firebase-heartbeat-store";let fu=null;function Ly(){return fu||(fu=Vk(N2,I2,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(So)}catch(n){console.warn(n)}}}}).catch(t=>{throw br.create("idb-open",{originalErrorMessage:t.message})})),fu}async function T2(t){try{const n=(await Ly()).transaction(So),r=await n.objectStore(So).get(Oy(t));return await n.done,r}catch(e){if(e instanceof Hn)zn.warn(e.message);else{const n=br.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});zn.warn(n.message)}}}async function Lm(t,e){try{const r=(await Ly()).transaction(So,"readwrite");await r.objectStore(So).put(e,Oy(t)),await r.done}catch(n){if(n instanceof Hn)zn.warn(n.message);else{const r=br.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});zn.warn(r.message)}}}function Oy(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ld(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function z2(){return Mm()==="http:"||Mm()==="https:"}function Mm(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F2(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(z2()||pk()||"connection"in navigator)?navigator.onLine:!0}function B2(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qi(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Q2(t,e=!1){const n=Ue(t),r=await n.getIdToken(e),s=hf(r);G(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:qi(pu(s.auth_time)),issuedAtTime:qi(pu(s.iat)),expirationTime:qi(pu(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function pu(t){return Number(t)*1e3}function hf(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return $l("JWT malformed, contained fewer than 3 sections"),null;try{const s=va(n);return s?JSON.parse(s):($l("Failed to decode base64 JWT payload"),null)}catch(s){return $l("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Um(t){const e=hf(t);return G(e,"internal-error"),G(typeof e.exp<"u","internal-error"),G(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function J2(t,e){const n=await zy(t,{},async()=>{const r=ai({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=t.config,o=Fy(t,s,"/v1/token",`key=${i}`),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",Uy.fetch()(o,{method:"POST",headers:l,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Z2(t,e){return ci(t,"POST","/v2/accounts:revokeToken",df(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zm=new Map;function Rn(t){Fn(t instanceof Function,"Expected a class definition");let e=zm.get(t);return e?(Fn(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,zm.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dv{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:l}=e;if(o){this.reject(o);return}const a={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(a))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return zC;case"linkViaPopup":case"linkViaRedirect":return BC;case"reauthViaPopup":case"reauthViaRedirect":return FC;default:_n(this.auth,"internal-error")}}resolve(e){Fn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Fn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class US{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,n){n==null?delete this.cache_[e]:this.cache_[e]=n}get(e){return yn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pv=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new MS(e)}}catch{}return new US},Br=pv("localStorage"),zS=pv("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xf="5",yv="v",vv="s",xv="r",bv="f",wv=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,kv="ls",Cv="p",Ud="ac",Sv="websocket",Ev="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zd;function DE(t){zd=t}const zv=function(t){return typeof t=="number"?"number:"+gv(t):"string:"+t},Fv=function(t){if(t.isLeafNode()){const e=t.val();D(typeof e=="string"||typeof e=="number"||typeof e=="object"&&yn(e,".sv"),"Priority must be a string or number.")}else D(t===zd||t.isEmpty(),"priority of unexpected type.");D(t===zd||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let __;class ze{constructor(e,n=ze.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,D(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Fv(this.priorityNode_)}static set __childrenNodeConstructor(e){__=e}static get __childrenNodeConstructor(){return __}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new ze(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:ze.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return re(e)?this:te(e)===".priority"?this.priorityNode_:ze.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:ze.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const r=te(e);return r===null?n:n.isEmpty()&&r!==".priority"?this:(D(r!==".priority"||Er(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(r,ze.__childrenNodeConstructor.EMPTY_NODE.updateChild(ge(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+zv(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=gv(this.value_):e+=this.value_,this.lazyHash_=mv(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===ze.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof ze.__childrenNodeConstructor?-1:(D(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,r=typeof this.value_,s=ze.VALUE_TYPE_ORDER.indexOf(n),i=ze.VALUE_TYPE_ORDER.indexOf(r);return D(s>=0,"Unknown leaf type: "+n),D(i>=0,"Unknown leaf type: "+r),s===i?r==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:i-s}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}ze.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bv,$v;function ME(t){Bv=t}function UE(t){$v=t}class zE extends mc{compare(e,n){const r=e.node.getPriority(),s=n.node.getPriority(),i=r.compareTo(s);return i===0?ls(e.name,n.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return ne.MIN}maxPost(){return new ne(Zr,new ze("[PRIORITY-POST]",$v))}makePost(e,n){const r=Bv(e);return new ne(n,new ze("[PRIORITY-POST]",r))}toString(){return".priority"}}const Ie=new zE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ua;function WN(t){D(!Ua,"__referenceConstructor has already been defined"),Ua=t}function HN(){return D(Ua,"Reference.ts has not been loaded"),Ua}let VN=1;class I_{constructor(e){this.listenProvider_=e,this.syncPointTree_=new _e(null),this.pendingWriteTree_=vN(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function rx(t,e,n,r,s){return lN(t.pendingWriteTree_,e,n,r,s),s?di(t,new es(Tf(),e,n)):[]}function YN(t,e,n,r){aN(t.pendingWriteTree_,e,n,r);const s=_e.fromObject(n);return di(t,new Zs(Tf(),e,s))}function dr(t,e,n=!1){const r=cN(t.pendingWriteTree_,e);if(uN(t.pendingWriteTree_,e)){let i=new _e(null);return r.snap!=null?i=i.set(ae(),!0):Je(r.children,o=>{i=i.set(new he(o),!0)}),di(t,new Aa(r.path,i,n))}else return[]}function yc(t,e,n){return di(t,new es(Rf(),e,n))}function QN(t,e,n){const r=_e.fromObject(n);return di(t,new Zs(Rf(),e,r))}function GN(t,e){return di(t,new Po(Rf(),e))}function qN(t,e,n){const r=Uf(t,n);if(r){const s=zf(r),i=s.path,o=s.queryId,l=_t(i,e),a=new Po(jf(o),l);return Ff(t,i,a)}else return[]}function Qd(t,e,n,r,s=!1){const i=e._path,o=t.syncPointTree_.get(i);let l=[];if(o&&(e._queryIdentifier==="default"||nx(o,e))){const a=$N(o,e,n,r);zN(o)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const u=a.removed;if(l=a.events,!s){const h=u.findIndex(f=>f._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(i,(f,p)=>Nr(p));if(h&&!d){const f=t.syncPointTree_.subtree(i);if(!f.isEmpty()){const p=JN(f);for(let v=0;v<p.length;++v){const w=p[v],k=w.query,_=ox(t,w);t.listenProvider_.startListening(eo(k),za(t,k),_.hashFn,_.onComplete)}}}!d&&u.length>0&&!r&&(h?t.listenProvider_.stopListening(eo(e),null):u.forEach(f=>{const p=t.queryToTagMap.get(vc(f));t.listenProvider_.stopListening(eo(f),p)}))}ZN(t,u)}return l}function XN(t,e,n,r){const s=Uf(t,r);if(s!=null){const i=zf(s),o=i.path,l=i.queryId,a=_t(o,e),u=new es(jf(l),a,n);return Ff(t,o,u)}else return[]}function KN(t,e,n,r){const s=Uf(t,r);if(s){const i=zf(s),o=i.path,l=i.queryId,a=_t(o,e),u=_e.fromObject(n),h=new Zs(jf(l),a,u);return Ff(t,o,h)}else return[]}function T_(t,e,n,r=!1){const s=e._path;let i=null,o=!1;t.syncPointTree_.foreachOnPath(s,(f,p)=>{const v=_t(f,s);i=i||Fs(p,v),o=o||Nr(p)});let l=t.syncPointTree_.get(s);l?(o=o||Nr(l),i=i||Fs(l,ae())):(l=new DN,t.syncPointTree_=t.syncPointTree_.set(s,l));let a;i!=null?a=!0:(a=!1,i=Y.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((p,v)=>{const w=Fs(v,ae());w&&(i=i.updateImmediateChild(p,w))}));const u=nx(l,e);if(!u&&!e._queryParams.loadsAllData()){const f=vc(e);D(!t.queryToTagMap.has(f),"View does not exist, but we have a tag");const p=e5();t.queryToTagMap.set(f,p),t.tagToQueryMap.set(p,f)}const h=Pf(t.pendingWriteTree_,s);let d=BN(l,e,n,h,i,a);if(!u&&!o&&!r){const f=tx(l,e);d=d.concat(t5(t,e,f))}return d}function Mf(t,e,n){const s=t.pendingWriteTree_,i=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=_t(o,e),u=Fs(l,a);if(u)return u});return Gv(s,e,i,n,!0)}function di(t,e){return sx(e,t.syncPointTree_,null,Pf(t.pendingWriteTree_,ae()))}function sx(t,e,n,r){if(re(t.path))return ix(t,e,n,r);{const s=e.get(ae());n==null&&s!=null&&(n=Fs(s,ae()));let i=[];const o=te(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,h=qv(r,o);i=i.concat(sx(l,a,u,h))}return s&&(i=i.concat(Df(s,t,r,n))),i}}function ix(t,e,n,r){const s=e.get(ae());n==null&&s!=null&&(n=Fs(s,ae()));let i=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=qv(r,o),h=t.operationForChild(o);h&&(i=i.concat(ix(h,l,a,u)))}),s&&(i=i.concat(Df(s,t,r,n))),i}function ox(t,e){const n=e.query,r=za(t,n);return{hashFn:()=>(PN(e)||Y.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return r?qN(t,n._path,r):GN(t,n._path);{const i=QS(s,n);return Qd(t,n,null,i)}}}}function za(t,e){const n=vc(e);return t.queryToTagMap.get(n)}function vc(t){return t._path.toString()+"$"+t._queryIdentifier}function Uf(t,e){return t.tagToQueryMap.get(e)}function zf(t){const e=t.indexOf("$");return D(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new he(t.substr(0,e))}}function Ff(t,e,n){const r=t.syncPointTree_.get(e);D(r,"Missing sync point for query tag that we're tracking");const s=Pf(t.pendingWriteTree_,e);return Df(r,n,s,null)}function JN(t){return t.fold((e,n,r)=>{if(n&&Nr(n))return[gc(n)];{let s=[];return n&&(s=ex(n)),Je(r,(i,o)=>{s=s.concat(o)}),s}})}function eo(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(HN())(t._repo,t._path):t}function ZN(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const s=vc(r),i=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(i)}}}function e5(){return VN++}function t5(t,e,n){const r=e._path,s=za(t,e),i=ox(t,n),o=t.listenProvider_.startListening(eo(e),s,i.hashFn,i.onComplete),l=t.syncPointTree_.subtree(r);if(s)D(!Nr(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,h,d)=>{if(!re(u)&&h&&Nr(h))return[gc(h).query];{let f=[];return h&&(f=f.concat(ex(h).map(p=>p.query))),Je(d,(p,v)=>{f=f.concat(v)}),f}});for(let u=0;u<a.length;++u){const h=a[u];t.listenProvider_.stopListening(eo(h),za(t,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kf{constructor(e,n,r,s){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=s}get key(){return re(this._path)?null:kf(this._path)}get ref(){return new jr(this._repo,this._path)}get _queryIdentifier(){const e=y_(this._queryParams),n=vf(e);return n==="{}"?"default":n}get _queryObject(){return y_(this._queryParams)}isEqual(e){if(e=Ue(e),!(e instanceof Kf))return!1;const n=this._repo===e._repo,r=Cf(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&r&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+SE(this._path)}}class jr extends Kf{constructor(e,n){super(e,n,new If,!1)}get parent(){const e=Dv(this._path);return e===null?null:new jr(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Fa{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new he(e),r=Ao(this.ref,e);return new Fa(this._node.getChild(n),r,Ie)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,s)=>e(new Fa(s,Ao(this.ref,r),Ie)))}hasChild(e){const n=new he(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function je(t,e){return t=Ue(t),t._checkNotDeleted("ref"),e!==void 0?Ao(t._root,e):t._root}function Ao(t,e){return t=Ue(t),te(t._path)===null?p5("child","path",e):px("child","path",e),new jr(t._repo,Ne(t._path,e))}function M5(t,e){t=Ue(t),mx("push",t._path),fx("push",e,t._path,!0);const n=yx(t._repo),r=A5(n),s=Ao(t,r),i=Ao(t,r);let o;return o=Promise.resolve(i),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Cn(t,e){t=Ue(t),mx("set",t._path),fx("set",e,t._path,!1);const n=new Wo;return k5(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function ps(t,e){f5("update",e,t._path);const n=new Wo;return C5(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}class Jf{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new L5("value",this,new Fa(e.snapshotNode,new jr(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new O5(this,e,n):null}matches(e){return e instanceof Jf?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function U5(t,e,n,r,s){let i;if(typeof r=="object"&&(i=void 0,s=r),typeof r=="function"&&(i=r),s&&s.onlyOnce){const a=n,u=(h,d)=>{A_(t._repo,t,l),a(h,d)};u.userCallback=n.userCallback,u.context=n.context,n=u}const o=new D5(n,i||void 0),l=new Jf(o);return E5(t._repo,t,l),()=>A_(t._repo,t,l)}function Lo(t,e,n,r){return U5(t,"value",e,n,r)}MN(jr);WN(jr);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=It.makeFromUrl(e,n)}catch{return new It(e,"")}if(r.path==="")return r;throw lI(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(x){x.path.charAt(x.path.length-1)==="/"&&(x.path_=x.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),a={bucket:1,path:3};function u(x){x.path_=decodeURIComponent(x.path)}const h="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),f="(/([^?#]*).*)?$",p=new RegExp(`^https?://${d}/${h}/b/${s}/o${f}`,"i"),v={bucket:1,path:3},w=n===kx?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",_=new RegExp(`^https?://${w}/${s}/${k}`,"i"),y=[{regex:l,indices:a,postModify:i},{regex:p,indices:v,postModify:u},{regex:_,indices:{bucket:1,path:2},postModify:u}];for(let x=0;x<y.length;x++){const b=y[x],S=b.regex.exec(e);if(S){const I=S[b.indices.bucket];let C=S[b.indices.path];C||(C=""),r=new It(I,C),b.postModify(r);break}}if(r==null)throw oI(e);return r}}class fI{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ux="storage";function iT(t,e,n){return t=Ue(t),KI(t,e,n)}function oT(t){return t=Ue(t),JI(t)}function lT(t){return t=Ue(t),ZI(t)}function B_(t,e){return t=Ue(t),rT(t,e)}function aT(t=of(),e){t=Ue(t);const r=dc(t,Ux).getImmediate({identifier:e}),s=Sy("storage");return s&&cT(r,...s),r}function cT(t,e,n,r={}){sT(t,e,n,r)}function uT(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new sp(n,r,s,e,os)}function dT(){Kr(new Sr(Ux,uT,"PUBLIC").setMultipleInstances(!0)),pn(z_,F_,""),pn(z_,F_,"esm2017")}dT();const hT={apiKey:"AIzaSyC3tTgAIVm0qz5irkqb7AkjwY7FOMJz4RM",authDomain:"packing-8b3de.firebaseapp.com",databaseURL:"https://packing-8b3de-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"packing-8b3de",storageBucket:"packing-8b3de.firebasestorage.app",messagingSenderId:"109766093944",appId:"1:109766093944:web:35b8d72158750ab522d18d",measurementId:"G-GRY36B729W"},ip=Ay(hT),Su=LS(ip),Pe=Y5(ip),$_=aT(ip),zx=new kn;zx.addScope("email");const Fx="packing-checklist-data",Eu=["必備","電子產品","個人物品","視天氣","旅行","運動"],Bx=["clipboard-list","footprints","briefcase","plane","person-standing","backpack","umbrella","tent","target","shopping-cart","shirt","dumbbell","mountain","baby","camera","heart","music","book-open","coffee","gift"],zi={itemLibrary:[{id:1,name:"錢包",category:"必備",note:"放在玄關抽屜"},{id:2,name:"鑰匙",category:"必備",note:"大門+機車"},{id:3,name:"手機",category:"必備",note:""},{id:4,name:"悠遊卡",category:"必備",note:"記得加值"},{id:5,name:"耳機",category:"電子產品",note:"充電盒在書桌"},{id:6,name:"行動電源",category:"電子產品",note:"出門前確認電量"},{id:7,name:"充電線",category:"電子產品",note:"Type-C"},{id:8,name:"口罩",category:"個人物品",note:"備用放包包內袋"},{id:9,name:"面紙",category:"個人物品",note:""},{id:10,name:"水壺",category:"個人物品",note:"裝滿水"},{id:11,name:"雨傘",category:"視天氣",note:"摺疊傘在門口"},{id:12,name:"護照",category:"旅行",note:"效期到 2027/05"},{id:13,name:"換洗衣物",category:"旅行",note:"依天數準備"}],lists:[{id:1,name:"日常出門",icon:"footprints",items:[1,2,3,4,8,9],checkedItems:[]},{id:2,name:"上班通勤",icon:"briefcase",items:[1,2,3,4,5,6,7,8],checkedItems:[]}],activeListId:1,templates:[]};function tr(t){return t.toLowerCase().replace(/\./g,",")}function Jd(t){return t.replace(/,/g,".")}function fT(t){return t?{...t,items:Array.isArray(t.items)?t.items:[],checkedItems:Array.isArray(t.checkedItems)?t.checkedItems:[],sharedWith:Object.fromEntries(Object.entries(t.sharedWith||{}).map(([e,n])=>[e,n===!0?"view":n]))}:null}function $x(t){return t?{itemLibrary:Array.isArray(t.itemLibrary)?t.itemLibrary:zi.itemLibrary,lists:Array.isArray(t.lists)?t.lists.map(e=>({...e,items:Array.isArray(e.items)?e.items:[],checkedItems:Array.isArray(e.checkedItems)?e.checkedItems:[],...e.sharedListId?{sharedListId:e.sharedListId}:{}})):zi.lists,activeListId:t.activeListId||zi.activeListId,templates:Array.isArray(t.templates)?t.templates:[]}:zi}function pT(){try{const t=localStorage.getItem(Fx);if(t)return $x(JSON.parse(t))}catch(t){console.error("載入本地資料失敗",t)}return zi}function W_(t){try{localStorage.setItem(Fx,JSON.stringify(t))}catch(e){console.error("儲存本地資料失敗",e)}}function mT(t){const[e,n]=g.useState(null),[r,s]=g.useState(t),[i,o]=g.useState("offline"),l=g.useRef(null),a=g.useCallback(p=>{l.current&&l.current();const v=je(Pe,"users/"+p);l.current=Lo(v,w=>{const k=w.val();if(k){const _=$x(k);s(_),W_(_),o("synced")}else u(p,r)},w=>{console.error("Firebase 讀取失敗",w),o("error")})},[]),u=g.useCallback((p,v)=>{o("syncing");const w=je(Pe,"users/"+p);Cn(w,v).then(()=>{o("synced")}).catch(k=>{console.error("Firebase 儲存失敗",k),o("error")})},[]),h=g.useCallback(p=>{s(p),W_(p),e&&u(e.uid,p)},[e,u]),d=g.useCallback(()=>{WC(Su,zx).catch(p=>{console.error("登入失敗",p),alert("登入失敗："+p.message)})},[]),f=g.useCallback(()=>{l.current&&(l.current(),l.current=null),kC(Su).then(()=>{n(null),o("offline")}).catch(p=>{console.error("登出失敗",p)})},[]);return g.useEffect(()=>{const p=wC(Su,v=>{n(v),v?a(v.uid):(o("offline"),l.current&&(l.current(),l.current=null))});return()=>{p(),l.current&&l.current()}},[a]),{user:e,data:r,syncStatus:i,saveData:h,handleLogin:d,handleLogout:f}}function _T(t,e){const[n,r]=g.useState({}),[s,i]=g.useState({}),o=g.useRef({}),l=g.useRef(null),a=g.useCallback(b=>{o.current[b]&&(o.current[b](),delete o.current[b])},[]),u=g.useCallback(()=>{Object.keys(o.current).forEach(a),l.current&&(l.current(),l.current=null),r({}),i({})},[a]),h=g.useCallback((b,S)=>{if(o.current[`${S}_${b}`])return;const I=je(Pe,`sharedLists/${b}`),C=Lo(I,j=>{const E=j.val();if(!E){(S==="withMe"?r:i)(q=>{const Z={...q};return delete Z[b],Z}),a(`${S}_${b}`);return}const N=fT(E);(S==="withMe"?r:i)(L=>({...L,[b]:N}))},j=>{console.error("共享清單讀取失敗",j)});o.current[`${S}_${b}`]=C},[a]);g.useEffect(()=>{if(!(t!=null&&t.email)){u();return}const b=tr(t.email),S=je(Pe,`sharedIndex/${b}`);return l.current=Lo(S,I=>{const C=I.val();if(!C){Object.keys(o.current).forEach(E=>{E.startsWith("withMe_")&&a(E)}),r({});return}const j=new Set(Object.keys(C));Object.keys(o.current).forEach(E=>{if(E.startsWith("withMe_")){const N=E.replace("withMe_","");j.has(N)||(a(E),r(T=>{const L={...T};return delete L[N],L}))}}),j.forEach(E=>{h(E,"withMe")})},I=>{console.error("共享索引讀取失敗",I)}),()=>{u()}},[t==null?void 0:t.email]),g.useEffect(()=>{if(!t||!(e!=null&&e.lists))return;const b=new Set;e.lists.forEach(S=>{S.sharedListId&&b.add(S.sharedListId)}),Object.keys(o.current).forEach(S=>{if(S.startsWith("byMe_")){const I=S.replace("byMe_","");b.has(I)||(a(S),i(C=>{const j={...C};return delete j[I],j}))}}),b.forEach(S=>{h(S,"byMe")})},[t,e==null?void 0:e.lists,h,a]),g.useEffect(()=>{!t||!(e!=null&&e.lists)||!(e!=null&&e.itemLibrary)||e.lists.forEach(b=>{if(!b.sharedListId)return;const S=s[b.sharedListId];if(!S)return;const I=(Array.isArray(b.items)?b.items:[]).map(L=>e.itemLibrary.find(q=>q.id===L)).filter(Boolean).map(({id:L,name:q,category:Z,note:X,photoURL:K})=>({id:L,name:q,category:Z,note:X,...K&&{photoURL:K}})),C=new Set(Array.isArray(b.items)?b.items:[]),j=(S.items||[]).filter(L=>!C.has(L.id)),E=[...I,...j],N=S.items||[];if(JSON.stringify(E)!==JSON.stringify(N)){const L=je(Pe,`sharedLists/${b.sharedListId}`);ps(L,{items:E,name:b.name,icon:b.icon})}})},[t,e==null?void 0:e.lists,e==null?void 0:e.itemLibrary,s]);const d=g.useCallback(async(b,S,I)=>{if(!t)return null;const C=(Array.isArray(b.items)?b.items:[]).map(q=>S.find(Z=>Z.id===q)).filter(Boolean).map(({id:q,name:Z,category:X,note:K,photoURL:U})=>({id:q,name:Z,category:X,note:K,...U&&{photoURL:U}})),j={};I.forEach(q=>{j[tr(q)]="view"});const N=M5(je(Pe,"sharedLists")).key,T={owner:t.uid,ownerEmail:t.email,ownerName:t.displayName||t.email,name:b.name,icon:b.icon,items:C,checkedItems:Array.isArray(b.checkedItems)?b.checkedItems:[],sharedWith:j},L={};return L[`sharedLists/${N}`]=T,I.forEach(q=>{L[`sharedIndex/${tr(q)}/${N}`]=!0}),await ps(je(Pe),L),N},[t]),f=g.useCallback(async(b,S)=>{const I=tr(S),C={};C[`sharedLists/${b}/sharedWith/${I}`]="view",C[`sharedIndex/${I}/${b}`]=!0,await ps(je(Pe),C)},[]),p=g.useCallback(async(b,S)=>{const I=tr(S),C={};C[`sharedLists/${b}/sharedWith/${I}`]=null,C[`sharedIndex/${I}/${b}`]=null,await ps(je(Pe),C)},[]),v=g.useCallback(async b=>{const S=s[b];if(!S)return;const I={};I[`sharedLists/${b}`]=null;const C=S.sharedWith||{};Object.keys(C).forEach(j=>{I[`sharedIndex/${j}/${b}`]=null}),await ps(je(Pe),I)},[s]),w=g.useCallback(async(b,S,I)=>{const C=tr(S);await Cn(je(Pe,`sharedLists/${b}/sharedWith/${C}`),I)},[]),k=g.useCallback(async(b,S)=>{const I=n[b];if(!I)return;const j=[...I.items||[],S];await Cn(je(Pe,`sharedLists/${b}/items`),j)},[n]),_=g.useCallback(async(b,S)=>{const I=n[b]||s[b];if(!I)return;const C=(I.items||[]).filter(N=>N.id!==S),j=(I.checkedItems||[]).filter(N=>N!==S),E={};E[`sharedLists/${b}/items`]=C,E[`sharedLists/${b}/checkedItems`]=j,await ps(je(Pe),E)},[n,s]),m=g.useCallback(async(b,S)=>{const I=n[b]||s[b];if(!I)return;const C=Array.isArray(I.checkedItems)?I.checkedItems:[],E=C.includes(S)?C.filter(T=>T!==S):[...C,S],N=je(Pe,`sharedLists/${b}/checkedItems`);await Cn(N,E)},[n,s]),y=g.useCallback(async b=>{const S=je(Pe,`sharedLists/${b}/checkedItems`);await Cn(S,[])},[]),x=g.useCallback(async(b,S)=>{const I=je(Pe,`sharedLists/${b}/checkedItems`);await Cn(I,S)},[]);return{sharedWithMe:n,sharedByMe:s,shareList:d,addSharedUser:f,removeSharedUser:p,unshareList:v,setUserPermission:w,addSharedItem:k,removeSharedItem:_,toggleSharedCheck:m,resetSharedChecks:y,checkAllShared:x}}function gT(t){const[e,n]=g.useState([]),[r,s]=g.useState(!1),[i,o]=g.useState(!0);g.useEffect(()=>{const u=je(Pe,"adminEmails"),h=Lo(u,d=>{const f=d.val(),p=Array.isArray(f)?f:[];n(p),o(!1)},()=>{n([]),o(!1)});return()=>h()},[]),g.useEffect(()=>{if(!(t!=null&&t.email)){s(!1);return}s(e.some(u=>u.toLowerCase()===t.email.toLowerCase()))},[t==null?void 0:t.email,e]);const l=g.useCallback(async u=>{const h=u.toLowerCase().trim();if(!h)return;const d=[...new Set([...e,h])];await Cn(je(Pe,"adminEmails"),d)},[e]),a=g.useCallback(async u=>{var f;const h=u.toLowerCase().trim();if(((f=t==null?void 0:t.email)==null?void 0:f.toLowerCase())===h)return;const d=e.filter(p=>p!==h);await Cn(je(Pe,"adminEmails"),d)},[e,t==null?void 0:t.email]);return{isAdmin:r,adminEmails:e,loading:i,addAdmin:l,removeAdmin:a}}function yT(){const[t,e]=g.useState(Eu);g.useEffect(()=>{const o=je(Pe,"categories"),l=Lo(o,a=>{const u=a.val();Array.isArray(u)&&u.length>0?e(u):e(Eu)},()=>{e(Eu)});return()=>l()},[]);const n=g.useCallback(async o=>{await Cn(je(Pe,"categories"),o)},[]),r=g.useCallback(async o=>{const l=o.trim();if(!l||t.includes(l))return;const a=[...t,l];await n(a)},[t,n]),s=g.useCallback(async(o,l)=>{const a=l.trim();if(!a||a===o||t.includes(a))return;const u=t.map(h=>h===o?a:h);await n(u)},[t,n]),i=g.useCallback(async o=>{const l=t.filter(a=>a!==o);l.length!==0&&await n(l)},[t,n]);return{categories:t,addCategory:r,updateCategory:s,removeCategory:i}}const vT="modulepreload",xT=function(t){return"/"+t},H_={},bT=function(e,n,r){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(n.map(a=>{if(a=xT(a),a in H_)return;H_[a]=!0;const u=a.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${h}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":vT,u||(d.as="script"),d.crossOrigin="",d.href=a,l&&d.setAttribute("nonce",l),document.head.appendChild(d),u)return new Promise((f,p)=>{d.addEventListener("load",f),d.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${a}`)))})}))}function i(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return s.then(o=>{for(const l of o||[])l.status==="rejected"&&i(l.reason);return e().catch(i)})},wT=60*60*1e3;function kT(){const[t,e]=g.useState(!1),[n,r]=g.useState(null),[s,i]=g.useState(null),[o,l]=g.useState(!1);return g.useEffect(()=>{bT(async()=>{const{registerSW:d}=await import("./virtual_pwa-register-BKyEWWUV.js");return{registerSW:d}},[]).then(({registerSW:d})=>{const f=d({onRegisteredSW(p,v){v&&(i(v),setInterval(()=>{v.update()},wT),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&v.update()}))},onNeedRefresh(){e(!0)},onOfflineReady(){console.log("PWA: 離線模式已就緒")}});r(()=>f)}).catch(()=>{})},[]),{needRefresh:t,refresh:()=>{n&&n(!0)},dismiss:()=>{e(!1)},checkForUpdate:async()=>{if(s){l(!0);try{await s.update()}catch{}setTimeout(()=>l(!1),1500)}},checking:o}}const V_="packing-checklist-theme";function CT(){return window.matchMedia("(prefers-color-scheme: dark)").matches}function Nu(t){const e=t==="dark"||t==="system"&&CT();document.documentElement.classList.toggle("dark",e);const n=document.querySelector('meta[name="theme-color"]');n&&n.setAttribute("content",e?"#0f172a":"#4F46E5")}function ST(){const[t,e]=g.useState(()=>{try{return localStorage.getItem(V_)||"system"}catch{return"system"}}),n=g.useCallback(r=>{e(r);try{localStorage.setItem(V_,r)}catch{}Nu(r)},[]);return g.useEffect(()=>{Nu(t)},[t]),g.useEffect(()=>{if(t!=="system")return;const r=window.matchMedia("(prefers-color-scheme: dark)"),s=()=>Nu("system");return r.addEventListener("change",s),()=>r.removeEventListener("change",s)},[t]),{preference:t,changeTheme:n}}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const RT=g.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:s="",children:i,iconNode:o,...l},a)=>g.createElement("svg",{ref:a,...IT,width:e,height:e,stroke:t,strokeWidth:r?Number(n)*24/Number(e):n,className:Wx("lucide",s),...!i&&!TT(l)&&{"aria-hidden":"true"},...l},[...o.map(([u,h])=>g.createElement(u,h)),...Array.isArray(i)?i:[i]]));/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W=(t,e)=>{const n=g.forwardRef(({className:r,...s},i)=>g.createElement(RT,{ref:i,iconNode:e,className:Wx(`lucide-${ET(Y_(t))}`,`lucide-${t}`,r),...s}));return n.displayName=Y_(t),n};/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h4=[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]],Yx=W("file-text",h4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v4=[["circle",{cx:"9",cy:"12",r:"1",key:"1vctgf"}],["circle",{cx:"9",cy:"5",r:"1",key:"hp0tcf"}],["circle",{cx:"9",cy:"19",r:"1",key:"fkjjf6"}],["circle",{cx:"15",cy:"12",r:"1",key:"1tmaij"}],["circle",{cx:"15",cy:"5",r:"1",key:"19l28e"}],["circle",{cx:"15",cy:"19",r:"1",key:"f4zoj3"}]],Qx=W("grip-vertical",v4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C4=[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]],Gx=W("layout-dashboard",C4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N4=[["path",{d:"M13 5h8",key:"a7qcls"}],["path",{d:"M13 12h8",key:"h98zly"}],["path",{d:"M13 19h8",key:"c3s6r1"}],["path",{d:"m3 17 2 2 4-4",key:"1jhpwq"}],["path",{d:"m3 7 2 2 4-4",key:"1obspn"}]],I4=W("list-checks",N4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T4=[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]],qx=W("loader-circle",T4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U4=[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]],z4=W("monitor",U4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y4=[["path",{d:"M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z",key:"1a0edw"}],["path",{d:"M12 22V12",key:"d0xqtd"}],["polyline",{points:"3.29 7 12 12 20.71 7",key:"ousv84"}],["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}]],Oo=W("package",Y4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q4=[["path",{d:"M13 21h8",key:"1jsn5i"}],["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}]],Ba=W("pen-line",Q4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const G4=[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}],["path",{d:"m15 5 4 4",key:"1mk7zo"}]],q4=W("pencil",G4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const X4=[["circle",{cx:"12",cy:"5",r:"1",key:"gxeob9"}],["path",{d:"m9 20 3-6 3 6",key:"se2kox"}],["path",{d:"m6 8 6 2 6-2",key:"4o3us4"}],["path",{d:"M12 10v4",key:"1kjpxc"}]],K4=W("person-standing",X4);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eR=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],$n=W("plus",eR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tR=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]],nR=W("refresh-cw",tR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rR=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],sR=W("rotate-ccw",rR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const iR=[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]],Nc=W("search",iR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oR=[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]],Ic=W("share-2",oR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lR=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}]],eh=W("shield",lR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const hR=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],fR=W("sparkles",hR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pR=[["path",{d:"M21 9a2.4 2.4 0 0 0-.706-1.706l-3.588-3.588A2.4 2.4 0 0 0 15 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z",key:"1dfntj"}],["path",{d:"M15 3v5a1 1 0 0 0 1 1h5",key:"6s6qgf"}]],lp=W("sticky-note",pR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mR=[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]],_R=W("sun",mR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gR=[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]],Xx=W("tag",gR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yR=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"6",key:"1vlfrh"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]],vR=W("target",yR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xR=[["path",{d:"M3.5 21 14 3",key:"1szst5"}],["path",{d:"M20.5 21 10 3",key:"1310c3"}],["path",{d:"M15.5 21 12 15l-3.5 6",key:"1ddtfw"}],["path",{d:"M2 21h20",key:"1nyx9w"}]],bR=W("tent",xR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wR=[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]],Ln=W("trash-2",wR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kR=[["path",{d:"M12 13v7a2 2 0 0 0 4 0",key:"rpgb42"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M20.992 13a1 1 0 0 0 .97-1.274 10.284 10.284 0 0 0-19.923 0A1 1 0 0 0 3 13z",key:"124nyo"}]],CR=W("umbrella",kR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const SR=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],ER=W("upload",SR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const NR=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],IR=W("user",NR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TR=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744",key:"16gr8j"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],Kx=W("users",TR);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const RR=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],ut=W("x",RR);function jR(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return g.useMemo(()=>r=>{e.forEach(s=>s(r))},e)}const Tc=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function fi(t){const e=Object.prototype.toString.call(t);return e==="[object Window]"||e==="[object global]"}function ap(t){return"nodeType"in t}function bt(t){var e,n;return t?fi(t)?t:ap(t)&&(e=(n=t.ownerDocument)==null?void 0:n.defaultView)!=null?e:window:window}function cp(t){const{Document:e}=bt(t);return t instanceof e}function Jo(t){return fi(t)?!1:t instanceof bt(t).HTMLElement}function Jx(t){return t instanceof bt(t).SVGElement}function pi(t){return t?fi(t)?t.document:ap(t)?cp(t)?t:Jo(t)||Jx(t)?t.ownerDocument:document:document:document}const gn=Tc?g.useLayoutEffect:g.useEffect;function up(t){const e=g.useRef(t);return gn(()=>{e.current=t}),g.useCallback(function(){for(var n=arguments.length,r=new Array(n),s=0;s<n;s++)r[s]=arguments[s];return e.current==null?void 0:e.current(...r)},[])}function PR(){const t=g.useRef(null),e=g.useCallback((r,s)=>{t.current=setInterval(r,s)},[]),n=g.useCallback(()=>{t.current!==null&&(clearInterval(t.current),t.current=null)},[]);return[e,n]}function Do(t,e){e===void 0&&(e=[t]);const n=g.useRef(t);return gn(()=>{n.current!==t&&(n.current=t)},e),n}function Zo(t,e){const n=g.useRef();return g.useMemo(()=>{const r=t(n.current);return n.current=r,r},[...e])}function $a(t){const e=up(t),n=g.useRef(null),r=g.useCallback(s=>{s!==n.current&&(e==null||e(s,n.current)),n.current=s},[]);return[n,r]}function th(t){const e=g.useRef();return g.useEffect(()=>{e.current=t},[t]),e.current}let Tu={};function el(t,e){return g.useMemo(()=>{if(e)return e;const n=Tu[t]==null?0:Tu[t]+1;return Tu[t]=n,t+"-"+n},[t,e])}function Zx(t){return function(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),s=1;s<n;s++)r[s-1]=arguments[s];return r.reduce((i,o)=>{const l=Object.entries(o);for(const[a,u]of l){const h=i[a];h!=null&&(i[a]=h+t*u)}return i},{...e})}}const Bs=Zx(1),Wa=Zx(-1);function AR(t){return"clientX"in t&&"clientY"in t}function dp(t){if(!t)return!1;const{KeyboardEvent:e}=bt(t.target);return e&&t instanceof e}function LR(t){if(!t)return!1;const{TouchEvent:e}=bt(t.target);return e&&t instanceof e}function nh(t){if(LR(t)){if(t.touches&&t.touches.length){const{clientX:e,clientY:n}=t.touches[0];return{x:e,y:n}}else if(t.changedTouches&&t.changedTouches.length){const{clientX:e,clientY:n}=t.changedTouches[0];return{x:e,y:n}}}return AR(t)?{x:t.clientX,y:t.clientY}:null}const ri=Object.freeze({Translate:{toString(t){if(!t)return;const{x:e,y:n}=t;return"translate3d("+(e?Math.round(e):0)+"px, "+(n?Math.round(n):0)+"px, 0)"}},Scale:{toString(t){if(!t)return;const{scaleX:e,scaleY:n}=t;return"scaleX("+e+") scaleY("+n+")"}},Transform:{toString(t){if(t)return[ri.Translate.toString(t),ri.Scale.toString(t)].join(" ")}},Transition:{toString(t){let{property:e,duration:n,easing:r}=t;return e+" "+n+"ms "+r}}}),G_="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function OR(t){return t.matches(G_)?t:t.querySelector(G_)}const DR={display:"none"};function MR(t){let{id:e,value:n}=t;return lt.createElement("div",{id:e,style:DR},n)}function UR(t){let{id:e,announcement:n,ariaLiveType:r="assertive"}=t;const s={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return lt.createElement("div",{id:e,style:s,role:"status","aria-live":r,"aria-atomic":!0},n)}function zR(){const[t,e]=g.useState("");return{announce:g.useCallback(r=>{r!=null&&e(r)},[]),announcement:t}}const eb=g.createContext(null);function FR(t){const e=g.useContext(eb);g.useEffect(()=>{if(!e)throw new Error("useDndMonitor must be used within a children of <DndContext>");return e(t)},[t,e])}function BR(){const[t]=g.useState(()=>new Set),e=g.useCallback(r=>(t.add(r),()=>t.delete(r)),[t]);return[g.useCallback(r=>{let{type:s,event:i}=r;t.forEach(o=>{var l;return(l=o[s])==null?void 0:l.call(o,i)})},[t]),e]}const $R={draggable:`
    To pick up a draggable item, press the space bar.
    While dragging, use the arrow keys to move the item.
    Press space again to drop the item in its new position, or press escape to cancel.
  `},WR={onDragStart(t){let{active:e}=t;return"Picked up draggable item "+e.id+"."},onDragOver(t){let{active:e,over:n}=t;return n?"Draggable item "+e.id+" was moved over droppable area "+n.id+".":"Draggable item "+e.id+" is no longer over a droppable area."},onDragEnd(t){let{active:e,over:n}=t;return n?"Draggable item "+e.id+" was dropped over droppable area "+n.id:"Draggable item "+e.id+" was dropped."},onDragCancel(t){let{active:e}=t;return"Dragging was cancelled. Draggable item "+e.id+" was dropped."}};function HR(t){let{announcements:e=WR,container:n,hiddenTextDescribedById:r,screenReaderInstructions:s=$R}=t;const{announce:i,announcement:o}=zR(),l=el("DndLiveRegion"),[a,u]=g.useState(!1);if(g.useEffect(()=>{u(!0)},[]),FR(g.useMemo(()=>({onDragStart(d){let{active:f}=d;i(e.onDragStart({active:f}))},onDragMove(d){let{active:f,over:p}=d;e.onDragMove&&i(e.onDragMove({active:f,over:p}))},onDragOver(d){let{active:f,over:p}=d;i(e.onDragOver({active:f,over:p}))},onDragEnd(d){let{active:f,over:p}=d;i(e.onDragEnd({active:f,over:p}))},onDragCancel(d){let{active:f,over:p}=d;i(e.onDragCancel({active:f,over:p}))}}),[i,e])),!a)return null;const h=lt.createElement(lt.Fragment,null,lt.createElement(MR,{id:r,value:s.draggable}),lt.createElement(UR,{id:l,announcement:o}));return n?Ns.createPortal(h,n):h}var De;(function(t){t.DragStart="dragStart",t.DragMove="dragMove",t.DragEnd="dragEnd",t.DragCancel="dragCancel",t.DragOver="dragOver",t.RegisterDroppable="registerDroppable",t.SetDroppableDisabled="setDroppableDisabled",t.UnregisterDroppable="unregisterDroppable"})(De||(De={}));function Ha(){}function Va(t,e){return g.useMemo(()=>({sensor:t,options:e??{}}),[t,e])}function tb(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return g.useMemo(()=>[...e].filter(r=>r!=null),[...e])}const nn=Object.freeze({x:0,y:0});function VR(t,e){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function YR(t,e){let{data:{value:n}}=t,{data:{value:r}}=e;return n-r}function QR(t,e){let{data:{value:n}}=t,{data:{value:r}}=e;return r-n}function GR(t,e){if(!t||t.length===0)return null;const[n]=t;return n[e]}function q_(t,e,n){return e===void 0&&(e=t.left),n===void 0&&(n=t.top),{x:e+t.width*.5,y:n+t.height*.5}}const nb=t=>{let{collisionRect:e,droppableRects:n,droppableContainers:r}=t;const s=q_(e,e.left,e.top),i=[];for(const o of r){const{id:l}=o,a=n.get(l);if(a){const u=VR(q_(a),s);i.push({id:l,data:{droppableContainer:o,value:u}})}}return i.sort(YR)};function qR(t,e){const n=Math.max(e.top,t.top),r=Math.max(e.left,t.left),s=Math.min(e.left+e.width,t.left+t.width),i=Math.min(e.top+e.height,t.top+t.height),o=s-r,l=i-n;if(r<s&&n<i){const a=e.width*e.height,u=t.width*t.height,h=o*l,d=h/(a+u-h);return Number(d.toFixed(4))}return 0}const XR=t=>{let{collisionRect:e,droppableRects:n,droppableContainers:r}=t;const s=[];for(const i of r){const{id:o}=i,l=n.get(o);if(l){const a=qR(l,e);a>0&&s.push({id:o,data:{droppableContainer:i,value:a}})}}return s.sort(QR)};function KR(t,e,n){return{...t,scaleX:e&&n?e.width/n.width:1,scaleY:e&&n?e.height/n.height:1}}function rb(t,e){return t&&e?{x:t.left-e.left,y:t.top-e.top}:nn}function JR(t){return function(n){for(var r=arguments.length,s=new Array(r>1?r-1:0),i=1;i<r;i++)s[i-1]=arguments[i];return s.reduce((o,l)=>({...o,top:o.top+t*l.y,bottom:o.bottom+t*l.y,left:o.left+t*l.x,right:o.right+t*l.x}),{...n})}}const ZR=JR(1);function ej(t){if(t.startsWith("matrix3d(")){const e=t.slice(9,-1).split(/, /);return{x:+e[12],y:+e[13],scaleX:+e[0],scaleY:+e[5]}}else if(t.startsWith("matrix(")){const e=t.slice(7,-1).split(/, /);return{x:+e[4],y:+e[5],scaleX:+e[0],scaleY:+e[3]}}return null}function tj(t,e,n){const r=ej(e);if(!r)return t;const{scaleX:s,scaleY:i,x:o,y:l}=r,a=t.left-o-(1-s)*parseFloat(n),u=t.top-l-(1-i)*parseFloat(n.slice(n.indexOf(" ")+1)),h=s?t.width/s:t.width,d=i?t.height/i:t.height;return{width:h,height:d,top:u,right:a+h,bottom:u+d,left:a}}const nj={ignoreTransform:!1};function mi(t,e){e===void 0&&(e=nj);let n=t.getBoundingClientRect();if(e.ignoreTransform){const{transform:u,transformOrigin:h}=bt(t).getComputedStyle(t);u&&(n=tj(n,u,h))}const{top:r,left:s,width:i,height:o,bottom:l,right:a}=n;return{top:r,left:s,width:i,height:o,bottom:l,right:a}}function X_(t){return mi(t,{ignoreTransform:!0})}function rj(t){const e=t.innerWidth,n=t.innerHeight;return{top:0,left:0,right:e,bottom:n,width:e,height:n}}function sj(t,e){return e===void 0&&(e=bt(t).getComputedStyle(t)),e.position==="fixed"}function ij(t,e){e===void 0&&(e=bt(t).getComputedStyle(t));const n=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(s=>{const i=e[s];return typeof i=="string"?n.test(i):!1})}function hp(t,e){const n=[];function r(s){if(e!=null&&n.length>=e||!s)return n;if(cp(s)&&s.scrollingElement!=null&&!n.includes(s.scrollingElement))return n.push(s.scrollingElement),n;if(!Jo(s)||Jx(s)||n.includes(s))return n;const i=bt(t).getComputedStyle(s);return s!==t&&ij(s,i)&&n.push(s),sj(s,i)?n:r(s.parentNode)}return t?r(t):n}function sb(t){const[e]=hp(t,1);return e??null}function Ru(t){return!Tc||!t?null:fi(t)?t:ap(t)?cp(t)||t===pi(t).scrollingElement?window:Jo(t)?t:null:null}function ib(t){return fi(t)?t.scrollX:t.scrollLeft}function ob(t){return fi(t)?t.scrollY:t.scrollTop}function rh(t){return{x:ib(t),y:ob(t)}}var $e;(function(t){t[t.Forward=1]="Forward",t[t.Backward=-1]="Backward"})($e||($e={}));function lb(t){return!Tc||!t?!1:t===document.scrollingElement}function ab(t){const e={x:0,y:0},n=lb(t)?{height:window.innerHeight,width:window.innerWidth}:{height:t.clientHeight,width:t.clientWidth},r={x:t.scrollWidth-n.width,y:t.scrollHeight-n.height},s=t.scrollTop<=e.y,i=t.scrollLeft<=e.x,o=t.scrollTop>=r.y,l=t.scrollLeft>=r.x;return{isTop:s,isLeft:i,isBottom:o,isRight:l,maxScroll:r,minScroll:e}}const oj={x:.2,y:.2};function lj(t,e,n,r,s){let{top:i,left:o,right:l,bottom:a}=n;r===void 0&&(r=10),s===void 0&&(s=oj);const{isTop:u,isBottom:h,isLeft:d,isRight:f}=ab(t),p={x:0,y:0},v={x:0,y:0},w={height:e.height*s.y,width:e.width*s.x};return!u&&i<=e.top+w.height?(p.y=$e.Backward,v.y=r*Math.abs((e.top+w.height-i)/w.height)):!h&&a>=e.bottom-w.height&&(p.y=$e.Forward,v.y=r*Math.abs((e.bottom-w.height-a)/w.height)),!f&&l>=e.right-w.width?(p.x=$e.Forward,v.x=r*Math.abs((e.right-w.width-l)/w.width)):!d&&o<=e.left+w.width&&(p.x=$e.Backward,v.x=r*Math.abs((e.left+w.width-o)/w.width)),{direction:p,speed:v}}function aj(t){if(t===document.scrollingElement){const{innerWidth:i,innerHeight:o}=window;return{top:0,left:0,right:i,bottom:o,width:i,height:o}}const{top:e,left:n,right:r,bottom:s}=t.getBoundingClientRect();return{top:e,left:n,right:r,bottom:s,width:t.clientWidth,height:t.clientHeight}}function cb(t){return t.reduce((e,n)=>Bs(e,rh(n)),nn)}function cj(t){return t.reduce((e,n)=>e+ib(n),0)}function uj(t){return t.reduce((e,n)=>e+ob(n),0)}function dj(t,e){if(e===void 0&&(e=mi),!t)return;const{top:n,left:r,bottom:s,right:i}=e(t);sb(t)&&(s<=0||i<=0||n>=window.innerHeight||r>=window.innerWidth)&&t.scrollIntoView({block:"center",inline:"center"})}const hj=[["x",["left","right"],cj],["y",["top","bottom"],uj]];class fp{constructor(e,n){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const r=hp(n),s=cb(r);this.rect={...e},this.width=e.width,this.height=e.height;for(const[i,o,l]of hj)for(const a of o)Object.defineProperty(this,a,{get:()=>{const u=l(r),h=s[i]-u;return this.rect[a]+h},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class no{constructor(e){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(n=>{var r;return(r=this.target)==null?void 0:r.removeEventListener(...n)})},this.target=e}add(e,n,r){var s;(s=this.target)==null||s.addEventListener(e,n,r),this.listeners.push([e,n,r])}}function fj(t){const{EventTarget:e}=bt(t);return t instanceof e?t:pi(t)}function ju(t,e){const n=Math.abs(t.x),r=Math.abs(t.y);return typeof e=="number"?Math.sqrt(n**2+r**2)>e:"x"in e&&"y"in e?n>e.x&&r>e.y:"x"in e?n>e.x:"y"in e?r>e.y:!1}var Ot;(function(t){t.Click="click",t.DragStart="dragstart",t.Keydown="keydown",t.ContextMenu="contextmenu",t.Resize="resize",t.SelectionChange="selectionchange",t.VisibilityChange="visibilitychange"})(Ot||(Ot={}));function K_(t){t.preventDefault()}function pj(t){t.stopPropagation()}var le;(function(t){t.Space="Space",t.Down="ArrowDown",t.Right="ArrowRight",t.Left="ArrowLeft",t.Up="ArrowUp",t.Esc="Escape",t.Enter="Enter",t.Tab="Tab"})(le||(le={}));const ub={start:[le.Space,le.Enter],cancel:[le.Esc],end:[le.Space,le.Enter,le.Tab]},mj=(t,e)=>{let{currentCoordinates:n}=e;switch(t.code){case le.Right:return{...n,x:n.x+25};case le.Left:return{...n,x:n.x-25};case le.Down:return{...n,y:n.y+25};case le.Up:return{...n,y:n.y-25}}};class db{constructor(e){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=e;const{event:{target:n}}=e;this.props=e,this.listeners=new no(pi(n)),this.windowListeners=new no(bt(n)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(Ot.Resize,this.handleCancel),this.windowListeners.add(Ot.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(Ot.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:e,onStart:n}=this.props,r=e.node.current;r&&dj(r),n(nn)}handleKeyDown(e){if(dp(e)){const{active:n,context:r,options:s}=this.props,{keyboardCodes:i=ub,coordinateGetter:o=mj,scrollBehavior:l="smooth"}=s,{code:a}=e;if(i.end.includes(a)){this.handleEnd(e);return}if(i.cancel.includes(a)){this.handleCancel(e);return}const{collisionRect:u}=r.current,h=u?{x:u.left,y:u.top}:nn;this.referenceCoordinates||(this.referenceCoordinates=h);const d=o(e,{active:n,context:r.current,currentCoordinates:h});if(d){const f=Wa(d,h),p={x:0,y:0},{scrollableAncestors:v}=r.current;for(const w of v){const k=e.code,{isTop:_,isRight:m,isLeft:y,isBottom:x,maxScroll:b,minScroll:S}=ab(w),I=aj(w),C={x:Math.min(k===le.Right?I.right-I.width/2:I.right,Math.max(k===le.Right?I.left:I.left+I.width/2,d.x)),y:Math.min(k===le.Down?I.bottom-I.height/2:I.bottom,Math.max(k===le.Down?I.top:I.top+I.height/2,d.y))},j=k===le.Right&&!m||k===le.Left&&!y,E=k===le.Down&&!x||k===le.Up&&!_;if(j&&C.x!==d.x){const N=w.scrollLeft+f.x,T=k===le.Right&&N<=b.x||k===le.Left&&N>=S.x;if(T&&!f.y){w.scrollTo({left:N,behavior:l});return}T?p.x=w.scrollLeft-N:p.x=k===le.Right?w.scrollLeft-b.x:w.scrollLeft-S.x,p.x&&w.scrollBy({left:-p.x,behavior:l});break}else if(E&&C.y!==d.y){const N=w.scrollTop+f.y,T=k===le.Down&&N<=b.y||k===le.Up&&N>=S.y;if(T&&!f.x){w.scrollTo({top:N,behavior:l});return}T?p.y=w.scrollTop-N:p.y=k===le.Down?w.scrollTop-b.y:w.scrollTop-S.y,p.y&&w.scrollBy({top:-p.y,behavior:l});break}}this.handleMove(e,Bs(Wa(d,this.referenceCoordinates),p))}}}handleMove(e,n){const{onMove:r}=this.props;e.preventDefault(),r(n)}handleEnd(e){const{onEnd:n}=this.props;e.preventDefault(),this.detach(),n()}handleCancel(e){const{onCancel:n}=this.props;e.preventDefault(),this.detach(),n()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}db.activators=[{eventName:"onKeyDown",handler:(t,e,n)=>{let{keyboardCodes:r=ub,onActivation:s}=e,{active:i}=n;const{code:o}=t.nativeEvent;if(r.start.includes(o)){const l=i.activatorNode.current;return l&&t.target!==l?!1:(t.preventDefault(),s==null||s({event:t.nativeEvent}),!0)}return!1}}];function J_(t){return!!(t&&"distance"in t)}function Z_(t){return!!(t&&"delay"in t)}class pp{constructor(e,n,r){var s;r===void 0&&(r=fj(e.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=e,this.events=n;const{event:i}=e,{target:o}=i;this.props=e,this.events=n,this.document=pi(o),this.documentListeners=new no(this.document),this.listeners=new no(r),this.windowListeners=new no(bt(o)),this.initialCoordinates=(s=nh(i))!=null?s:nn,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:e,props:{options:{activationConstraint:n,bypassActivationConstraint:r}}}=this;if(this.listeners.add(e.move.name,this.handleMove,{passive:!1}),this.listeners.add(e.end.name,this.handleEnd),e.cancel&&this.listeners.add(e.cancel.name,this.handleCancel),this.windowListeners.add(Ot.Resize,this.handleCancel),this.windowListeners.add(Ot.DragStart,K_),this.windowListeners.add(Ot.VisibilityChange,this.handleCancel),this.windowListeners.add(Ot.ContextMenu,K_),this.documentListeners.add(Ot.Keydown,this.handleKeydown),n){if(r!=null&&r({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(Z_(n)){this.timeoutId=setTimeout(this.handleStart,n.delay),this.handlePending(n);return}if(J_(n)){this.handlePending(n);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(e,n){const{active:r,onPending:s}=this.props;s(r,e,this.initialCoordinates,n)}handleStart(){const{initialCoordinates:e}=this,{onStart:n}=this.props;e&&(this.activated=!0,this.documentListeners.add(Ot.Click,pj,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(Ot.SelectionChange,this.removeTextSelection),n(e))}handleMove(e){var n;const{activated:r,initialCoordinates:s,props:i}=this,{onMove:o,options:{activationConstraint:l}}=i;if(!s)return;const a=(n=nh(e))!=null?n:nn,u=Wa(s,a);if(!r&&l){if(J_(l)){if(l.tolerance!=null&&ju(u,l.tolerance))return this.handleCancel();if(ju(u,l.distance))return this.handleStart()}if(Z_(l)&&ju(u,l.tolerance))return this.handleCancel();this.handlePending(l,u);return}e.cancelable&&e.preventDefault(),o(a)}handleEnd(){const{onAbort:e,onEnd:n}=this.props;this.detach(),this.activated||e(this.props.active),n()}handleCancel(){const{onAbort:e,onCancel:n}=this.props;this.detach(),this.activated||e(this.props.active),n()}handleKeydown(e){e.code===le.Esc&&this.handleCancel()}removeTextSelection(){var e;(e=this.document.getSelection())==null||e.removeAllRanges()}}const _j={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class Rc extends pp{constructor(e){const{event:n}=e,r=pi(n.target);super(e,_j,r)}}Rc.activators=[{eventName:"onPointerDown",handler:(t,e)=>{let{nativeEvent:n}=t,{onActivation:r}=e;return!n.isPrimary||n.button!==0?!1:(r==null||r({event:n}),!0)}}];const gj={move:{name:"mousemove"},end:{name:"mouseup"}};var sh;(function(t){t[t.RightClick=2]="RightClick"})(sh||(sh={}));class yj extends pp{constructor(e){super(e,gj,pi(e.event.target))}}yj.activators=[{eventName:"onMouseDown",handler:(t,e)=>{let{nativeEvent:n}=t,{onActivation:r}=e;return n.button===sh.RightClick?!1:(r==null||r({event:n}),!0)}}];const Pu={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class mp extends pp{constructor(e){super(e,Pu)}static setup(){return window.addEventListener(Pu.move.name,e,{capture:!1,passive:!1}),function(){window.removeEventListener(Pu.move.name,e)};function e(){}}}mp.activators=[{eventName:"onTouchStart",handler:(t,e)=>{let{nativeEvent:n}=t,{onActivation:r}=e;const{touches:s}=n;return s.length>1?!1:(r==null||r({event:n}),!0)}}];var ro;(function(t){t[t.Pointer=0]="Pointer",t[t.DraggableRect=1]="DraggableRect"})(ro||(ro={}));var Ya;(function(t){t[t.TreeOrder=0]="TreeOrder",t[t.ReversedTreeOrder=1]="ReversedTreeOrder"})(Ya||(Ya={}));function vj(t){let{acceleration:e,activator:n=ro.Pointer,canScroll:r,draggingRect:s,enabled:i,interval:o=5,order:l=Ya.TreeOrder,pointerCoordinates:a,scrollableAncestors:u,scrollableAncestorRects:h,delta:d,threshold:f}=t;const p=bj({delta:d,disabled:!i}),[v,w]=PR(),k=g.useRef({x:0,y:0}),_=g.useRef({x:0,y:0}),m=g.useMemo(()=>{switch(n){case ro.Pointer:return a?{top:a.y,bottom:a.y,left:a.x,right:a.x}:null;case ro.DraggableRect:return s}},[n,s,a]),y=g.useRef(null),x=g.useCallback(()=>{const S=y.current;if(!S)return;const I=k.current.x*_.current.x,C=k.current.y*_.current.y;S.scrollBy(I,C)},[]),b=g.useMemo(()=>l===Ya.TreeOrder?[...u].reverse():u,[l,u]);g.useEffect(()=>{if(!i||!u.length||!m){w();return}for(const S of b){if((r==null?void 0:r(S))===!1)continue;const I=u.indexOf(S),C=h[I];if(!C)continue;const{direction:j,speed:E}=lj(S,C,m,e,f);for(const N of["x","y"])p[N][j[N]]||(E[N]=0,j[N]=0);if(E.x>0||E.y>0){w(),y.current=S,v(x,o),k.current=E,_.current=j;return}}k.current={x:0,y:0},_.current={x:0,y:0},w()},[e,x,r,w,i,o,JSON.stringify(m),JSON.stringify(p),v,u,b,h,JSON.stringify(f)])}const xj={x:{[$e.Backward]:!1,[$e.Forward]:!1},y:{[$e.Backward]:!1,[$e.Forward]:!1}};function bj(t){let{delta:e,disabled:n}=t;const r=th(e);return Zo(s=>{if(n||!r||!s)return xj;const i={x:Math.sign(e.x-r.x),y:Math.sign(e.y-r.y)};return{x:{[$e.Backward]:s.x[$e.Backward]||i.x===-1,[$e.Forward]:s.x[$e.Forward]||i.x===1},y:{[$e.Backward]:s.y[$e.Backward]||i.y===-1,[$e.Forward]:s.y[$e.Forward]||i.y===1}}},[n,e,r])}function wj(t,e){const n=e!=null?t.get(e):void 0,r=n?n.node.current:null;return Zo(s=>{var i;return e==null?null:(i=r??s)!=null?i:null},[r,e])}function kj(t,e){return g.useMemo(()=>t.reduce((n,r)=>{const{sensor:s}=r,i=s.activators.map(o=>({eventName:o.eventName,handler:e(o.handler,r)}));return[...n,...i]},[]),[t,e])}var Mo;(function(t){t[t.Always=0]="Always",t[t.BeforeDragging=1]="BeforeDragging",t[t.WhileDragging=2]="WhileDragging"})(Mo||(Mo={}));var ih;(function(t){t.Optimized="optimized"})(ih||(ih={}));const e0=new Map;function Cj(t,e){let{dragging:n,dependencies:r,config:s}=e;const[i,o]=g.useState(null),{frequency:l,measure:a,strategy:u}=s,h=g.useRef(t),d=k(),f=Do(d),p=g.useCallback(function(_){_===void 0&&(_=[]),!f.current&&o(m=>m===null?_:m.concat(_.filter(y=>!m.includes(y))))},[f]),v=g.useRef(null),w=Zo(_=>{if(d&&!n)return e0;if(!_||_===e0||h.current!==t||i!=null){const m=new Map;for(let y of t){if(!y)continue;if(i&&i.length>0&&!i.includes(y.id)&&y.rect.current){m.set(y.id,y.rect.current);continue}const x=y.node.current,b=x?new fp(a(x),x):null;y.rect.current=b,b&&m.set(y.id,b)}return m}return _},[t,i,n,d,a]);return g.useEffect(()=>{h.current=t},[t]),g.useEffect(()=>{d||p()},[n,d]),g.useEffect(()=>{i&&i.length>0&&o(null)},[JSON.stringify(i)]),g.useEffect(()=>{d||typeof l!="number"||v.current!==null||(v.current=setTimeout(()=>{p(),v.current=null},l))},[l,d,p,...r]),{droppableRects:w,measureDroppableContainers:p,measuringScheduled:i!=null};function k(){switch(u){case Mo.Always:return!1;case Mo.BeforeDragging:return n;default:return!n}}}function hb(t,e){return Zo(n=>t?n||(typeof e=="function"?e(t):t):null,[e,t])}function Sj(t,e){return hb(t,e)}function Ej(t){let{callback:e,disabled:n}=t;const r=up(e),s=g.useMemo(()=>{if(n||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:i}=window;return new i(r)},[r,n]);return g.useEffect(()=>()=>s==null?void 0:s.disconnect(),[s]),s}function jc(t){let{callback:e,disabled:n}=t;const r=up(e),s=g.useMemo(()=>{if(n||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:i}=window;return new i(r)},[n]);return g.useEffect(()=>()=>s==null?void 0:s.disconnect(),[s]),s}function Nj(t){return new fp(mi(t),t)}function t0(t,e,n){e===void 0&&(e=Nj);const[r,s]=g.useState(null);function i(){s(a=>{if(!t)return null;if(t.isConnected===!1){var u;return(u=a??n)!=null?u:null}const h=e(t);return JSON.stringify(a)===JSON.stringify(h)?a:h})}const o=Ej({callback(a){if(t)for(const u of a){const{type:h,target:d}=u;if(h==="childList"&&d instanceof HTMLElement&&d.contains(t)){i();break}}}}),l=jc({callback:i});return gn(()=>{i(),t?(l==null||l.observe(t),o==null||o.observe(document.body,{childList:!0,subtree:!0})):(l==null||l.disconnect(),o==null||o.disconnect())},[t]),r}function Ij(t){const e=hb(t);return rb(t,e)}const n0=[];function Tj(t){const e=g.useRef(t),n=Zo(r=>t?r&&r!==n0&&t&&e.current&&t.parentNode===e.current.parentNode?r:hp(t):n0,[t]);return g.useEffect(()=>{e.current=t},[t]),n}function Rj(t){const[e,n]=g.useState(null),r=g.useRef(t),s=g.useCallback(i=>{const o=Ru(i.target);o&&n(l=>l?(l.set(o,rh(o)),new Map(l)):null)},[]);return g.useEffect(()=>{const i=r.current;if(t!==i){o(i);const l=t.map(a=>{const u=Ru(a);return u?(u.addEventListener("scroll",s,{passive:!0}),[u,rh(u)]):null}).filter(a=>a!=null);n(l.length?new Map(l):null),r.current=t}return()=>{o(t),o(i)};function o(l){l.forEach(a=>{const u=Ru(a);u==null||u.removeEventListener("scroll",s)})}},[s,t]),g.useMemo(()=>t.length?e?Array.from(e.values()).reduce((i,o)=>Bs(i,o),nn):cb(t):nn,[t,e])}function r0(t,e){e===void 0&&(e=[]);const n=g.useRef(null);return g.useEffect(()=>{n.current=null},e),g.useEffect(()=>{const r=t!==nn;r&&!n.current&&(n.current=t),!r&&n.current&&(n.current=null)},[t]),n.current?Wa(t,n.current):nn}function jj(t){g.useEffect(()=>{if(!Tc)return;const e=t.map(n=>{let{sensor:r}=n;return r.setup==null?void 0:r.setup()});return()=>{for(const n of e)n==null||n()}},t.map(e=>{let{sensor:n}=e;return n}))}function Pj(t,e){return g.useMemo(()=>t.reduce((n,r)=>{let{eventName:s,handler:i}=r;return n[s]=o=>{i(o,e)},n},{}),[t,e])}function fb(t){return g.useMemo(()=>t?rj(t):null,[t])}const s0=[];function Aj(t,e){e===void 0&&(e=mi);const[n]=t,r=fb(n?bt(n):null),[s,i]=g.useState(s0);function o(){i(()=>t.length?t.map(a=>lb(a)?r:new fp(e(a),a)):s0)}const l=jc({callback:o});return gn(()=>{l==null||l.disconnect(),o(),t.forEach(a=>l==null?void 0:l.observe(a))},[t]),s}function Lj(t){if(!t)return null;if(t.children.length>1)return t;const e=t.children[0];return Jo(e)?e:t}function Oj(t){let{measure:e}=t;const[n,r]=g.useState(null),s=g.useCallback(u=>{for(const{target:h}of u)if(Jo(h)){r(d=>{const f=e(h);return d?{...d,width:f.width,height:f.height}:f});break}},[e]),i=jc({callback:s}),o=g.useCallback(u=>{const h=Lj(u);i==null||i.disconnect(),h&&(i==null||i.observe(h)),r(h?e(h):null)},[e,i]),[l,a]=$a(o);return g.useMemo(()=>({nodeRef:l,rect:n,setRef:a}),[n,l,a])}const Dj=[{sensor:Rc,options:{}},{sensor:db,options:{}}],Mj={current:{}},Ql={draggable:{measure:X_},droppable:{measure:X_,strategy:Mo.WhileDragging,frequency:ih.Optimized},dragOverlay:{measure:mi}};class so extends Map{get(e){var n;return e!=null&&(n=super.get(e))!=null?n:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(e=>{let{disabled:n}=e;return!n})}getNodeFor(e){var n,r;return(n=(r=this.get(e))==null?void 0:r.node.current)!=null?n:void 0}}const Uj={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new so,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:Ha},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:Ql,measureDroppableContainers:Ha,windowRect:null,measuringScheduled:!1},zj={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:Ha,draggableNodes:new Map,over:null,measureDroppableContainers:Ha},Pc=g.createContext(zj),pb=g.createContext(Uj);function Fj(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new so}}}function Bj(t,e){switch(e.type){case De.DragStart:return{...t,draggable:{...t.draggable,initialCoordinates:e.initialCoordinates,active:e.active}};case De.DragMove:return t.draggable.active==null?t:{...t,draggable:{...t.draggable,translate:{x:e.coordinates.x-t.draggable.initialCoordinates.x,y:e.coordinates.y-t.draggable.initialCoordinates.y}}};case De.DragEnd:case De.DragCancel:return{...t,draggable:{...t.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case De.RegisterDroppable:{const{element:n}=e,{id:r}=n,s=new so(t.droppable.containers);return s.set(r,n),{...t,droppable:{...t.droppable,containers:s}}}case De.SetDroppableDisabled:{const{id:n,key:r,disabled:s}=e,i=t.droppable.containers.get(n);if(!i||r!==i.key)return t;const o=new so(t.droppable.containers);return o.set(n,{...i,disabled:s}),{...t,droppable:{...t.droppable,containers:o}}}case De.UnregisterDroppable:{const{id:n,key:r}=e,s=t.droppable.containers.get(n);if(!s||r!==s.key)return t;const i=new so(t.droppable.containers);return i.delete(n),{...t,droppable:{...t.droppable,containers:i}}}default:return t}}function $j(t){let{disabled:e}=t;const{active:n,activatorEvent:r,draggableNodes:s}=g.useContext(Pc),i=th(r),o=th(n==null?void 0:n.id);return g.useEffect(()=>{if(!e&&!r&&i&&o!=null){if(!dp(i)||document.activeElement===i.target)return;const l=s.get(o);if(!l)return;const{activatorNode:a,node:u}=l;if(!a.current&&!u.current)return;requestAnimationFrame(()=>{for(const h of[a.current,u.current]){if(!h)continue;const d=OR(h);if(d){d.focus();break}}})}},[r,e,s,o,i]),null}function Wj(t,e){let{transform:n,...r}=e;return t!=null&&t.length?t.reduce((s,i)=>i({transform:s,...r}),n):n}function Hj(t){return g.useMemo(()=>({draggable:{...Ql.draggable,...t==null?void 0:t.draggable},droppable:{...Ql.droppable,...t==null?void 0:t.droppable},dragOverlay:{...Ql.dragOverlay,...t==null?void 0:t.dragOverlay}}),[t==null?void 0:t.draggable,t==null?void 0:t.droppable,t==null?void 0:t.dragOverlay])}function Vj(t){let{activeNode:e,measure:n,initialRect:r,config:s=!0}=t;const i=g.useRef(!1),{x:o,y:l}=typeof s=="boolean"?{x:s,y:s}:s;gn(()=>{if(!o&&!l||!e){i.current=!1;return}if(i.current||!r)return;const u=e==null?void 0:e.node.current;if(!u||u.isConnected===!1)return;const h=n(u),d=rb(h,r);if(o||(d.x=0),l||(d.y=0),i.current=!0,Math.abs(d.x)>0||Math.abs(d.y)>0){const f=sb(u);f&&f.scrollBy({top:d.y,left:d.x})}},[e,o,l,r,n])}const mb=g.createContext({...nn,scaleX:1,scaleY:1});var nr;(function(t){t[t.Uninitialized=0]="Uninitialized",t[t.Initializing=1]="Initializing",t[t.Initialized=2]="Initialized"})(nr||(nr={}));const _b=g.memo(function(e){var n,r,s,i;let{id:o,accessibility:l,autoScroll:a=!0,children:u,sensors:h=Dj,collisionDetection:d=XR,measuring:f,modifiers:p,...v}=e;const w=g.useReducer(Bj,void 0,Fj),[k,_]=w,[m,y]=BR(),[x,b]=g.useState(nr.Uninitialized),S=x===nr.Initialized,{draggable:{active:I,nodes:C,translate:j},droppable:{containers:E}}=k,N=I!=null?C.get(I):null,T=g.useRef({initial:null,translated:null}),L=g.useMemo(()=>{var et;return I!=null?{id:I,data:(et=N==null?void 0:N.data)!=null?et:Mj,rect:T}:null},[I,N]),q=g.useRef(null),[Z,X]=g.useState(null),[K,U]=g.useState(null),M=Do(v,Object.values(v)),R=el("DndDescribedBy",o),z=g.useMemo(()=>E.getEnabled(),[E]),B=Hj(f),{droppableRects:V,measureDroppableContainers:ie,measuringScheduled:P}=Cj(z,{dragging:S,dependencies:[j.x,j.y],config:B.droppable}),F=wj(C,I),J=g.useMemo(()=>K?nh(K):null,[K]),ue=Nb(),fe=Sj(F,B.draggable.measure);Vj({activeNode:I!=null?C.get(I):null,config:ue.layoutShiftCompensation,initialRect:fe,measure:B.draggable.measure});const ee=t0(F,B.draggable.measure,fe),vn=t0(F?F.parentElement:null),Ze=g.useRef({activatorEvent:null,active:null,activeNode:F,collisionRect:null,collisions:null,droppableRects:V,draggableNodes:C,draggingNode:null,draggingNodeRect:null,droppableContainers:E,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),Vn=E.getNodeFor((n=Ze.current.over)==null?void 0:n.id),At=Oj({measure:B.dragOverlay.measure}),Yn=(r=At.nodeRef.current)!=null?r:F,Qn=S?(s=At.rect)!=null?s:ee:null,tl=!!(At.nodeRef.current&&At.rect),nl=Ij(tl?null:ee),_i=fb(Yn?bt(Yn):null),rn=Tj(S?Vn??F:null),cs=Aj(rn),Pr=Wj(p,{transform:{x:j.x-nl.x,y:j.y-nl.y,scaleX:1,scaleY:1},activatorEvent:K,active:L,activeNodeRect:ee,containerNodeRect:vn,draggingNodeRect:Qn,over:Ze.current.over,overlayNodeRect:At.rect,scrollableAncestors:rn,scrollableAncestorRects:cs,windowRect:_i}),gi=J?Bs(J,j):null,yi=Rj(rn),rl=r0(yi),sl=r0(yi,[ee]),A=Bs(Pr,rl),H=Qn?ZR(Qn,Pr):null,Q=L&&H?d({active:L,collisionRect:H,droppableRects:V,droppableContainers:z,pointerCoordinates:gi}):null,be=GR(Q,"id"),[pe,Wt]=g.useState(null),sn=tl?Pr:Bs(Pr,sl),wt=KR(sn,(i=pe==null?void 0:pe.rect)!=null?i:null,ee),Lc=g.useRef(null),_p=g.useCallback((et,kt)=>{let{sensor:Ct,options:Gn}=kt;if(q.current==null)return;const Lt=C.get(q.current);if(!Lt)return;const St=et.nativeEvent,on=new Ct({active:q.current,activeNode:Lt,event:St,options:Gn,context:Ze,onAbort(Ye){if(!C.get(Ye))return;const{onDragAbort:ln}=M.current,xn={id:Ye};ln==null||ln(xn),m({type:"onDragAbort",event:xn})},onPending(Ye,qn,ln,xn){if(!C.get(Ye))return;const{onDragPending:xi}=M.current,Xn={id:Ye,constraint:qn,initialCoordinates:ln,offset:xn};xi==null||xi(Xn),m({type:"onDragPending",event:Xn})},onStart(Ye){const qn=q.current;if(qn==null)return;const ln=C.get(qn);if(!ln)return;const{onDragStart:xn}=M.current,vi={activatorEvent:St,active:{id:qn,data:ln.data,rect:T}};Ns.unstable_batchedUpdates(()=>{xn==null||xn(vi),b(nr.Initializing),_({type:De.DragStart,initialCoordinates:Ye,active:qn}),m({type:"onDragStart",event:vi}),X(Lc.current),U(St)})},onMove(Ye){_({type:De.DragMove,coordinates:Ye})},onEnd:us(De.DragEnd),onCancel:us(De.DragCancel)});Lc.current=on;function us(Ye){return async function(){const{active:ln,collisions:xn,over:vi,scrollAdjustedTranslate:xi}=Ze.current;let Xn=null;if(ln&&xi){const{cancelDrop:bi}=M.current;Xn={activatorEvent:St,active:ln,collisions:xn,delta:xi,over:vi},Ye===De.DragEnd&&typeof bi=="function"&&await Promise.resolve(bi(Xn))&&(Ye=De.DragCancel)}q.current=null,Ns.unstable_batchedUpdates(()=>{_({type:Ye}),b(nr.Uninitialized),Wt(null),X(null),U(null),Lc.current=null;const bi=Ye===De.DragEnd?"onDragEnd":"onDragCancel";if(Xn){const Oc=M.current[bi];Oc==null||Oc(Xn),m({type:bi,event:Xn})}})}}},[C]),Cb=g.useCallback((et,kt)=>(Ct,Gn)=>{const Lt=Ct.nativeEvent,St=C.get(Gn);if(q.current!==null||!St||Lt.dndKit||Lt.defaultPrevented)return;const on={active:St};et(Ct,kt.options,on)===!0&&(Lt.dndKit={capturedBy:kt.sensor},q.current=Gn,_p(Ct,kt))},[C,_p]),gp=kj(h,Cb);jj(h),gn(()=>{ee&&x===nr.Initializing&&b(nr.Initialized)},[ee,x]),g.useEffect(()=>{const{onDragMove:et}=M.current,{active:kt,activatorEvent:Ct,collisions:Gn,over:Lt}=Ze.current;if(!kt||!Ct)return;const St={active:kt,activatorEvent:Ct,collisions:Gn,delta:{x:A.x,y:A.y},over:Lt};Ns.unstable_batchedUpdates(()=>{et==null||et(St),m({type:"onDragMove",event:St})})},[A.x,A.y]),g.useEffect(()=>{const{active:et,activatorEvent:kt,collisions:Ct,droppableContainers:Gn,scrollAdjustedTranslate:Lt}=Ze.current;if(!et||q.current==null||!kt||!Lt)return;const{onDragOver:St}=M.current,on=Gn.get(be),us=on&&on.rect.current?{id:on.id,rect:on.rect.current,data:on.data,disabled:on.disabled}:null,Ye={active:et,activatorEvent:kt,collisions:Ct,delta:{x:Lt.x,y:Lt.y},over:us};Ns.unstable_batchedUpdates(()=>{Wt(us),St==null||St(Ye),m({type:"onDragOver",event:Ye})})},[be]),gn(()=>{Ze.current={activatorEvent:K,active:L,activeNode:F,collisionRect:H,collisions:Q,droppableRects:V,draggableNodes:C,draggingNode:Yn,draggingNodeRect:Qn,droppableContainers:E,over:pe,scrollableAncestors:rn,scrollAdjustedTranslate:A},T.current={initial:Qn,translated:H}},[L,F,Q,H,C,Yn,Qn,V,E,pe,rn,A]),vj({...ue,delta:j,draggingRect:H,pointerCoordinates:gi,scrollableAncestors:rn,scrollableAncestorRects:cs});const Sb=g.useMemo(()=>({active:L,activeNode:F,activeNodeRect:ee,activatorEvent:K,collisions:Q,containerNodeRect:vn,dragOverlay:At,draggableNodes:C,droppableContainers:E,droppableRects:V,over:pe,measureDroppableContainers:ie,scrollableAncestors:rn,scrollableAncestorRects:cs,measuringConfiguration:B,measuringScheduled:P,windowRect:_i}),[L,F,ee,K,Q,vn,At,C,E,V,pe,ie,rn,cs,B,P,_i]),Eb=g.useMemo(()=>({activatorEvent:K,activators:gp,active:L,activeNodeRect:ee,ariaDescribedById:{draggable:R},dispatch:_,draggableNodes:C,over:pe,measureDroppableContainers:ie}),[K,gp,L,ee,_,R,C,pe,ie]);return lt.createElement(eb.Provider,{value:y},lt.createElement(Pc.Provider,{value:Eb},lt.createElement(pb.Provider,{value:Sb},lt.createElement(mb.Provider,{value:wt},u)),lt.createElement($j,{disabled:(l==null?void 0:l.restoreFocus)===!1})),lt.createElement(HR,{...l,hiddenTextDescribedById:R}));function Nb(){const et=(Z==null?void 0:Z.autoScrollEnabled)===!1,kt=typeof a=="object"?a.enabled===!1:a===!1,Ct=S&&!et&&!kt;return typeof a=="object"?{...a,enabled:Ct}:{enabled:Ct}}}),Yj=g.createContext(null),i0="button",Qj="Draggable";function Gj(t){let{id:e,data:n,disabled:r=!1,attributes:s}=t;const i=el(Qj),{activators:o,activatorEvent:l,active:a,activeNodeRect:u,ariaDescribedById:h,draggableNodes:d,over:f}=g.useContext(Pc),{role:p=i0,roleDescription:v="draggable",tabIndex:w=0}=s??{},k=(a==null?void 0:a.id)===e,_=g.useContext(k?mb:Yj),[m,y]=$a(),[x,b]=$a(),S=Pj(o,e),I=Do(n);gn(()=>(d.set(e,{id:e,key:i,node:m,activatorNode:x,data:I}),()=>{const j=d.get(e);j&&j.key===i&&d.delete(e)}),[d,e]);const C=g.useMemo(()=>({role:p,tabIndex:w,"aria-disabled":r,"aria-pressed":k&&p===i0?!0:void 0,"aria-roledescription":v,"aria-describedby":h.draggable}),[r,p,w,k,v,h.draggable]);return{active:a,activatorEvent:l,activeNodeRect:u,attributes:C,isDragging:k,listeners:r?void 0:S,node:m,over:f,setNodeRef:y,setActivatorNodeRef:b,transform:_}}function qj(){return g.useContext(pb)}const Xj="Droppable",Kj={timeout:25};function Jj(t){let{data:e,disabled:n=!1,id:r,resizeObserverConfig:s}=t;const i=el(Xj),{active:o,dispatch:l,over:a,measureDroppableContainers:u}=g.useContext(Pc),h=g.useRef({disabled:n}),d=g.useRef(!1),f=g.useRef(null),p=g.useRef(null),{disabled:v,updateMeasurementsFor:w,timeout:k}={...Kj,...s},_=Do(w??r),m=g.useCallback(()=>{if(!d.current){d.current=!0;return}p.current!=null&&clearTimeout(p.current),p.current=setTimeout(()=>{u(Array.isArray(_.current)?_.current:[_.current]),p.current=null},k)},[k]),y=jc({callback:m,disabled:v||!o}),x=g.useCallback((C,j)=>{y&&(j&&(y.unobserve(j),d.current=!1),C&&y.observe(C))},[y]),[b,S]=$a(x),I=Do(e);return g.useEffect(()=>{!y||!b.current||(y.disconnect(),d.current=!1,y.observe(b.current))},[b,y]),g.useEffect(()=>(l({type:De.RegisterDroppable,element:{id:r,key:i,disabled:n,node:b,rect:f,data:I}}),()=>l({type:De.UnregisterDroppable,key:i,id:r})),[r]),g.useEffect(()=>{n!==h.current.disabled&&(l({type:De.SetDroppableDisabled,id:r,key:i,disabled:n}),h.current.disabled=n)},[r,i,n,l]),{active:o,rect:f,isOver:(a==null?void 0:a.id)===r,node:b,over:a,setNodeRef:S}}function Ac(t,e,n){const r=t.slice();return r.splice(n<0?r.length+n:n,0,r.splice(e,1)[0]),r}function Zj(t,e){return t.reduce((n,r,s)=>{const i=e.get(r);return i&&(n[s]=i),n},Array(t.length))}function Nl(t){return t!==null&&t>=0}function eP(t,e){if(t===e)return!0;if(t.length!==e.length)return!1;for(let n=0;n<t.length;n++)if(t[n]!==e[n])return!1;return!0}function tP(t){return typeof t=="boolean"?{draggable:t,droppable:t}:t}const gb=t=>{let{rects:e,activeIndex:n,overIndex:r,index:s}=t;const i=Ac(e,r,n),o=e[s],l=i[s];return!l||!o?null:{x:l.left-o.left,y:l.top-o.top,scaleX:l.width/o.width,scaleY:l.height/o.height}},Il={scaleX:1,scaleY:1},yb=t=>{var e;let{activeIndex:n,activeNodeRect:r,index:s,rects:i,overIndex:o}=t;const l=(e=i[n])!=null?e:r;if(!l)return null;if(s===n){const u=i[o];return u?{x:0,y:n<o?u.top+u.height-(l.top+l.height):u.top-l.top,...Il}:null}const a=nP(i,s,n);return s>n&&s<=o?{x:0,y:-l.height-a,...Il}:s<n&&s>=o?{x:0,y:l.height+a,...Il}:{x:0,y:0,...Il}};function nP(t,e,n){const r=t[e],s=t[e-1],i=t[e+1];return r?n<e?s?r.top-(s.top+s.height):i?i.top-(r.top+r.height):0:i?i.top-(r.top+r.height):s?r.top-(s.top+s.height):0:0}const vb="Sortable",xb=lt.createContext({activeIndex:-1,containerId:vb,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:gb,disabled:{draggable:!1,droppable:!1}});function bb(t){let{children:e,id:n,items:r,strategy:s=gb,disabled:i=!1}=t;const{active:o,dragOverlay:l,droppableRects:a,over:u,measureDroppableContainers:h}=qj(),d=el(vb,n),f=l.rect!==null,p=g.useMemo(()=>r.map(S=>typeof S=="object"&&"id"in S?S.id:S),[r]),v=o!=null,w=o?p.indexOf(o.id):-1,k=u?p.indexOf(u.id):-1,_=g.useRef(p),m=!eP(p,_.current),y=k!==-1&&w===-1||m,x=tP(i);gn(()=>{m&&v&&h(p)},[m,p,v,h]),g.useEffect(()=>{_.current=p},[p]);const b=g.useMemo(()=>({activeIndex:w,containerId:d,disabled:x,disableTransforms:y,items:p,overIndex:k,useDragOverlay:f,sortedRects:Zj(p,a),strategy:s}),[w,d,x.draggable,x.droppable,y,p,k,a,f,s]);return lt.createElement(xb.Provider,{value:b},e)}const rP=t=>{let{id:e,items:n,activeIndex:r,overIndex:s}=t;return Ac(n,r,s).indexOf(e)},sP=t=>{let{containerId:e,isSorting:n,wasDragging:r,index:s,items:i,newIndex:o,previousItems:l,previousContainerId:a,transition:u}=t;return!u||!r||l!==i&&s===o?!1:n?!0:o!==s&&e===a},iP={duration:200,easing:"ease"},wb="transform",oP=ri.Transition.toString({property:wb,duration:0,easing:"linear"}),lP={roleDescription:"sortable"};function aP(t){let{disabled:e,index:n,node:r,rect:s}=t;const[i,o]=g.useState(null),l=g.useRef(n);return gn(()=>{if(!e&&n!==l.current&&r.current){const a=s.current;if(a){const u=mi(r.current,{ignoreTransform:!0}),h={x:a.left-u.left,y:a.top-u.top,scaleX:a.width/u.width,scaleY:a.height/u.height};(h.x||h.y)&&o(h)}}n!==l.current&&(l.current=n)},[e,n,r,s]),g.useEffect(()=>{i&&o(null)},[i]),i}function kb(t){let{animateLayoutChanges:e=sP,attributes:n,disabled:r,data:s,getNewIndex:i=rP,id:o,strategy:l,resizeObserverConfig:a,transition:u=iP}=t;const{items:h,containerId:d,activeIndex:f,disabled:p,disableTransforms:v,sortedRects:w,overIndex:k,useDragOverlay:_,strategy:m}=g.useContext(xb),y=cP(r,p),x=h.indexOf(o),b=g.useMemo(()=>({sortable:{containerId:d,index:x,items:h},...s}),[d,s,x,h]),S=g.useMemo(()=>h.slice(h.indexOf(o)),[h,o]),{rect:I,node:C,isOver:j,setNodeRef:E}=Jj({id:o,data:b,disabled:y.droppable,resizeObserverConfig:{updateMeasurementsFor:S,...a}}),{active:N,activatorEvent:T,activeNodeRect:L,attributes:q,setNodeRef:Z,listeners:X,isDragging:K,over:U,setActivatorNodeRef:M,transform:R}=Gj({id:o,data:b,attributes:{...lP,...n},disabled:y.draggable}),z=jR(E,Z),B=!!N,V=B&&!v&&Nl(f)&&Nl(k),ie=!_&&K,P=ie&&V?R:null,J=V?P??(l??m)({rects:w,activeNodeRect:L,activeIndex:f,overIndex:k,index:x}):null,ue=Nl(f)&&Nl(k)?i({id:o,items:h,activeIndex:f,overIndex:k}):x,fe=N==null?void 0:N.id,ee=g.useRef({activeId:fe,items:h,newIndex:ue,containerId:d}),vn=h!==ee.current.items,Ze=e({active:N,containerId:d,isDragging:K,isSorting:B,id:o,index:x,items:h,newIndex:ee.current.newIndex,previousItems:ee.current.items,previousContainerId:ee.current.containerId,transition:u,wasDragging:ee.current.activeId!=null}),Vn=aP({disabled:!Ze,index:x,node:C,rect:I});return g.useEffect(()=>{B&&ee.current.newIndex!==ue&&(ee.current.newIndex=ue),d!==ee.current.containerId&&(ee.current.containerId=d),h!==ee.current.items&&(ee.current.items=h)},[B,ue,d,h]),g.useEffect(()=>{if(fe===ee.current.activeId)return;if(fe!=null&&ee.current.activeId==null){ee.current.activeId=fe;return}const Yn=setTimeout(()=>{ee.current.activeId=fe},50);return()=>clearTimeout(Yn)},[fe]),{active:N,activeIndex:f,attributes:q,data:b,rect:I,index:x,newIndex:ue,items:h,isOver:j,isSorting:B,isDragging:K,listeners:X,node:C,overIndex:k,over:U,setNodeRef:z,setActivatorNodeRef:M,setDroppableNodeRef:E,setDraggableNodeRef:Z,transform:Vn??J,transition:At()};function At(){if(Vn||vn&&ee.current.newIndex===x)return oP;if(!(ie&&!dp(T)||!u)&&(B||Ze))return ri.Transition.toString({...u,property:wb})}}function cP(t,e){var n,r;return typeof t=="boolean"?{draggable:t,droppable:!1}:{draggable:(n=t==null?void 0:t.draggable)!=null?n:e.draggable,droppable:(r=t==null?void 0:t.droppable)!=null?r:e.droppable}}le.Down,le.Right,le.Up,le.Left;const o0={"clipboard-list":Zd,footprints:p4,briefcase:FT,plane:Z4,"person-standing":K4,backpack:LT,umbrella:CR,tent:bR,target:vR,"shopping-cart":dR,shirt:cR,dumbbell:c4,mountain:W4,baby:DT,camera:op,heart:b4,music:V4,"book-open":UT,coffee:r4,gift:y4},l0={"📋":"clipboard-list","🚶":"footprints","💼":"briefcase","✈️":"plane","🏃":"person-standing","🎒":"backpack","🏖️":"umbrella","🏕️":"tent","🎯":"target","🛒":"shopping-cart"};function uP(t){return l0[t]?o0[l0[t]]||Zd:o0[t]||Zd}function io({name:t,size:e=20,className:n=""}){const r=uP(t);return c.jsx(r,{size:e,className:n})}function Au({message:t,onConfirm:e,onCancel:n}){return c.jsxs("div",{className:"fixed inset-0 z-50 flex items-end justify-center",onClick:n,children:[c.jsx("div",{className:"absolute inset-0 bg-black bg-opacity-50"}),c.jsx("div",{className:"relative w-full max-w-lg bg-white dark:bg-slate-800 rounded-t-2xl animate-slide-up safe-bottom",onClick:r=>r.stopPropagation(),children:c.jsxs("div",{className:"p-6",children:[c.jsx("p",{className:"text-center text-lg text-slate-800 dark:text-slate-100 mb-6",children:t}),c.jsxs("div",{className:"flex gap-3",children:[c.jsx("button",{onClick:n,className:"flex-1 py-3 text-slate-600 dark:text-slate-300 border border-slate-300 dark:border-slate-600 rounded-xl font-medium active:bg-slate-100 dark:active:bg-slate-700 transition-colors duration-150 min-h-[44px]",children:"取消"}),c.jsx("button",{onClick:e,className:"flex-1 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-xl font-medium active:bg-indigo-700 dark:active:bg-indigo-600 transition-colors duration-150 min-h-[44px]",children:"確定"})]})]})})]})}function dP(){const t=["bg-red-400","bg-yellow-400","bg-green-400","bg-blue-400","bg-purple-400","bg-pink-400","bg-indigo-400","bg-emerald-400","bg-orange-400","bg-cyan-400"];return c.jsxs("div",{className:"fixed inset-0 z-40 pointer-events-none overflow-hidden",children:[Array.from({length:30}).map((e,n)=>c.jsx("div",{className:`absolute w-2.5 h-2.5 rounded-sm animate-confetti ${t[n%t.length]}`,style:{left:`${Math.random()*100}%`,animationDelay:`${Math.random()*.8}s`,animationDuration:`${1.5+Math.random()*1}s`}},n)),c.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:c.jsxs("div",{className:"animate-celebration-text text-center",children:[c.jsx("div",{className:"text-6xl mb-2",children:"🎉"}),c.jsx("div",{className:"text-2xl font-bold text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 bg-opacity-90 dark:bg-opacity-90 px-6 py-3 rounded-2xl shadow-lg",children:"準備完成！"})]})})]})}function hP({item:t}){const{attributes:e,listeners:n,setNodeRef:r,transform:s,transition:i,isDragging:o}=kb({id:t.id}),l={transform:ri.Transform.toString(s),transition:i,zIndex:o?50:void 0,position:"relative"};return c.jsx("div",{ref:r,style:l,children:c.jsxs("div",{className:`flex items-center p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 min-h-[56px]
          ${o?"shadow-lg opacity-90":""}`,children:[c.jsx("div",{...e,...n,className:"w-6 h-6 mr-4 flex items-center justify-center flex-shrink-0 text-slate-400 dark:text-slate-500 touch-none cursor-grab active:cursor-grabbing",children:c.jsx(Qx,{size:20})}),c.jsx("div",{className:"flex-1 min-w-0",children:c.jsx("div",{className:"text-lg text-slate-800 dark:text-slate-100",children:t.name})})]})})}function fP({data:t,user:e,syncStatus:n,onLogin:r,onLogout:s,onNavigate:i,onSaveData:o,shared:l,activeSharedListId:a,categories:u=[]}){var yi,rl,sl;const[h,d]=g.useState([]),[f,p]=g.useState(null),[v,w]=g.useState(null),[k,_]=g.useState([]),[m,y]=g.useState(!1),[x,b]=g.useState("default"),[S,I]=g.useState(!1),[C,j]=g.useState(""),[E,N]=g.useState(u[0]||""),[T,L]=g.useState(null),q=a&&((yi=l==null?void 0:l.sharedWithMe)==null?void 0:yi[a]),Z=a&&((rl=l==null?void 0:l.sharedByMe)==null?void 0:rl[a]),X=q?"shared-with-me":Z?"own-shared":"local",K=q?l.sharedWithMe[a]:Z?l.sharedByMe[a]:null,U=X!=="shared-with-me"||(()=>{if(!(e!=null&&e.email)||!(K!=null&&K.sharedWith))return!1;const A=tr(e.email);return K.sharedWith[A]==="edit"})(),M=(sl=t.lists)==null?void 0:sl.find(A=>A.id===t.activeListId),R=M?{...M,items:Array.isArray(M.items)?M.items:[],checkedItems:Array.isArray(M.checkedItems)?M.checkedItems:[]}:null;let z=[],B=[],V="",ie="",P="";X==="shared-with-me"&&K?(z=(K.items||[]).filter(Boolean),B=K.checkedItems||[],V=K.name||"清單",ie=K.icon||"clipboard-list",P=K.ownerName||K.ownerEmail||""):X==="own-shared"&&R&&K?(z=R.items.map(A=>{var H;return(H=t.itemLibrary)==null?void 0:H.find(Q=>Q.id===A)}).filter(Boolean),B=K.checkedItems||[],V=R.name||"清單",ie=R.icon||"clipboard-list"):(z=R?R.items.map(A=>{var H;return(H=t.itemLibrary)==null?void 0:H.find(Q=>Q.id===A)}).filter(Boolean):[],B=(R==null?void 0:R.checkedItems)||[],V=(R==null?void 0:R.name)||"清單",ie=(R==null?void 0:R.icon)||"clipboard-list");const F=B.length,J=z.length,ue=J>0&&F===J,fe=J>0?F/J*100:0,ee=g.useRef(ue);g.useEffect(()=>{if(ue&&!ee.current){y(!0);const A=setTimeout(()=>y(!1),2500);return()=>clearTimeout(A)}ee.current=ue},[ue]);const vn=(()=>{const A=[],H={};return z.forEach(Q=>{const be=Q.category||"其他";H[be]||(H[be]=[]),H[be].push(Q)}),u.forEach(Q=>{H[Q]&&(A.push({category:Q,items:H[Q]}),delete H[Q])}),Object.keys(H).forEach(Q=>{A.push({category:Q,items:H[Q]})}),A})(),Ze=x==="name"?[...z].sort((A,H)=>A.name.localeCompare(H.name,"zh-Hant")):x==="unchecked"?[...z].sort((A,H)=>{const Q=B.includes(A.id)?1:0,be=B.includes(H.id)?1:0;return Q-be}):z,Vn=()=>{b(A=>A==="default"?"name":A==="name"?"unchecked":A==="unchecked"?X==="shared-with-me"?"default":"manual":"default")},At=x==="name"?"名稱":x==="unchecked"?"未勾選":x==="manual"?"手動":"",Yn=tb(Va(Rc,{activationConstraint:{distance:5}}),Va(mp,{activationConstraint:{delay:150,tolerance:5}})),Qn=A=>{const{active:H,over:Q}=A;if(!Q||H.id===Q.id)return;const be=R.items.indexOf(H.id),pe=R.items.indexOf(Q.id);if(be===-1||pe===-1)return;const Wt=Ac(R.items,be,pe),sn={...t,lists:t.lists.map(wt=>wt.id===t.activeListId?{...wt,items:Wt}:wt)};o(sn)},tl=A=>{if(w(A),X==="shared-with-me"||X==="own-shared")l.toggleSharedCheck(a,A);else{const H={...t,lists:t.lists.map(Q=>{if(Q.id!==t.activeListId)return Q;const be=Array.isArray(Q.checkedItems)?Q.checkedItems:[],pe=be.includes(A);return{...Q,checkedItems:pe?be.filter(Wt=>Wt!==A):[...be,A]}})};o(H)}},nl=()=>{if(X==="shared-with-me"||X==="own-shared")l.resetSharedChecks(a);else{const A={...t,lists:t.lists.map(H=>H.id===t.activeListId?{...H,checkedItems:[]}:H)};o(A)}},_i=()=>{if(X==="shared-with-me"||X==="own-shared"){const A=z.map(H=>H.id);l.checkAllShared(a,A)}else{if(!R)return;const A={...t,lists:t.lists.map(H=>H.id===t.activeListId?{...H,checkedItems:[...R.items]}:H)};o(A)}},rn=A=>{d(H=>H.includes(A)?H.filter(Q=>Q!==A):[...H,A])},cs=A=>{_(H=>H.includes(A)?H.filter(Q=>Q!==A):[...H,A])},Pr=()=>{const A=C.trim();if(A){if(X==="shared-with-me"){const Q={id:"shared_item_"+Date.now(),name:A,category:E};l.addSharedItem(a,Q)}else{if(!R)return;const H="item_"+Date.now(),Q={id:H,name:A,category:E},be={...t,itemLibrary:[...t.itemLibrary||[],Q],lists:t.lists.map(pe=>pe.id!==t.activeListId?pe:{...pe,items:[...Array.isArray(pe.items)?pe.items:[],H]})};o(be)}j(""),I(!1)}},gi=A=>{var sn;const H=B.includes(A.id),Q=(sn=A.note)==null?void 0:sn.trim(),be=Q||A.photoURL,pe=h.includes(A.id),Wt=v===A.id;return c.jsxs("div",{children:[c.jsxs("div",{onClick:()=>tl(A.id),className:`flex items-center p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 active:bg-slate-50 dark:active:bg-slate-700 transition-colors duration-150 cursor-pointer min-h-[56px]
