 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,z){var M=D.length;D.push(z);e:for(;0<M;){var H=M-1>>>1,V=D[H];if(0<s(V,z))D[H]=z,D[M]=V,M=H;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var z=D[0],M=D.pop();if(M!==z){D[0]=M;e:for(var H=0,V=D.length,q=V>>>1;H<q;){var ce=2*(H+1)-1,L=D[ce],U=ce+1,K=D[U];if(0>s(L,M))U<V&&0>s(K,L)?(D[H]=K,D[U]=M,H=U):(D[H]=L,D[ce]=M,H=ce);else if(U<V&&0>s(K,M))D[H]=K,D[U]=M,H=U;else break e}}return z}function s(D,z){var M=D.sortIndex-z.sortIndex;return M!==0?M:D.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;t.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],h=1,d=null,f=3,p=!1,v=!1,w=!1,k=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(D){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=D)r(u),z.sortIndex=z.expirationTime,e(a,z);else break;z=n(u)}}function x(D){if(w=!1,g(D),!v)if(n(a)!==null)v=!0,Z(b);else{var z=n(u);z!==null&&Q(x,z.startTime-D)}}function b(D,z){v=!1,w&&(w=!1,_(S),S=-1),p=!0;var M=f;try{for(g(z),d=n(a);d!==null&&(!(d.expirationTime>z)||D&&!I());){var H=d.callback;if(typeof H=="function"){d.callback=null,f=d.priorityLevel;var V=H(d.expirationTime<=z);z=t.unstable_now(),typeof V=="function"?d.callback=V:d===n(a)&&r(a),g(z)}else r(a);d=n(a)}if(d!==null)var q=!0;else{var ce=n(u);ce!==null&&Q(x,ce.startTime-z),q=!1}return q}finally{d=null,f=M,p=!1}}var C=!1,E=null,S=-1,R=5,N=-1;function I(){return!(t.unstable_now()-N<R)}function T(){if(E!==null){var D=t.unstable_now();N=D;var z=!0;try{z=E(!0,D)}finally{z?A():(C=!1,E=null)}}else C=!1}var A;if(typeof m=="function")A=function(){m(T)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,te=Y.port2;Y.port1.onmessage=T,A=function(){te.postMessage(null)}}else A=function(){k(T,0)};function Z(D){E=D,C||(C=!0,A())}function Q(D,z){S=k(function(){D(t.unstable_now())},z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,Z(b))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(D){switch(f){case 1:case 2:case 3:var z=3;break;default:z=f}var M=f;f=z;try{return D()}finally{f=M}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,z){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var M=f;f=D;try{return z()}finally{f=M}},t.unstable_scheduleCallback=function(D,z,M){var H=t.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?H+M:H):M=H,D){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=M+V,D={id:h++,callback:z,priorityLevel:D,startTime:M,expirationTime:V,sortIndex:-1},M>H?(D.sortIndex=M,e(u,D),n(a)===null&&D===n(u)&&(w?(_(S),S=-1):w=!0,Q(x,M-H))):(D.sortIndex=V,e(a,D),v||p||(v=!0,Z(b))),D},t.unstable_shouldYield=I,t.unstable_wrapCallback=function(D){var z=f;return function(){var M=f;f=z;try{return D.apply(this,arguments)}finally{f=M}}}})(b0);x0.exports=b0;var Xb=x0.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O=function(t,e){if(!t)throw ai(e)},ai=function(t){return new Error("Firebase Database ("+xy.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uC(t,e){const n=dc(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(wa(i,e??{}))return s;bn(s,"already-initialized")}return n.initialize({options:e})}function dC(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Ln);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function hC(t,e,n){const r=hc(t);J(r._canInitEmulator,r,"emulator-config-failed"),J(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Zy(e),{host:o,port:l}=fC(e),a=l===null?"":`:${l}`;r.config.emulator={url:`${i}//${o}${a}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),pC()}function Zy(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function fC(t){const e=Zy(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Hm(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:Hm(o)}}}function Hm(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function pC(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gC(t,e,n=!1){const{auth:r}=t;if(jn(r.app))return Promise.reject(Vr(r));const s="reauthenticate";try{const i=await Eo(t,tv(r,s,e,t),n);J(i.idToken,r,"internal-error");const o=hf(i.idToken);J(o,r,"internal-error");const{sub:l}=o;return J(t.uid===l,r,"user-mismatch"),Js._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&bn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uv(t,e){return e?Ln(e):(J(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mu="webStorageSupport";class SS{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=iv,this._completeRedirectFn=XC,this._overrideRedirectResult=YC}async _openPopup(e,n,r,s){var i;Wn((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await Km(e,n,r,Ld(),s);return vS(e,o,_f())}async _openRedirect(e,n,r,s){await this._originValidation(e);const i=await Km(e,n,r,Ld(),s);return IC(i),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:s,promise:i}=this.eventManagers[n];return s?Promise.resolve(s):(Wn(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await fS(e),r=new KC(e);return n.register("authEvent",s=>(J(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(mu,{type:mu},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[mu];o!==void 0&&n(!!o),bn(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=nS(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Ky()||Vy()||ff()}}const NS=SS;var Jm="@firebase/auth",Zm="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ov{constructor(e){this.allowedEvents_=e,this.listeners_={},O(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const r=[...this.listeners_[e]];for(let s=0;s<r.length;s++)r[s].callback.apply(r[s].context,n)}}on(e,n,r){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:r});const s=this.getInitialEvent(e);s&&n.apply(r,s)}off(e,n,r){this.validateEventType_(e);const s=this.listeners_[e]||[];for(let i=0;i<s.length;i++)if(s[i].callback===n&&(!r||r===s[i].context)){s.splice(i,1);return}}validateEventType_(e){O(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ra extends Ov{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!nf()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ra}getInitialEvent(e){return O(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ud;function ON(t){Ud=t}const Uv=function(t){return typeof t=="number"?"number:"+gv(t):"string:"+t},Fv=function(t){if(t.isLeafNode()){const e=t.val();O(typeof e=="string"||typeof e=="number"||typeof e=="object"&&kn(e,".sv"),"Priority must be a string or number.")}else O(t===Ud||t.isEmpty(),"priority of unexpected type.");O(t===Ud||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xE{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,r=e.childName;O(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),O(r!==".priority","Only non-priority child changes can be tracked.");const s=this.changeMap.get(r);if(s){const i=s.type;if(n==="child_added"&&i==="child_removed")this.changeMap.set(r,jo(r,e.snapshotNode,s.snapshotNode));else if(n==="child_removed"&&i==="child_added")this.changeMap.delete(r);else if(n==="child_removed"&&i==="child_changed")this.changeMap.set(r,Ro(r,s.oldSnap));else if(n==="child_changed"&&i==="child_added")this.changeMap.set(r,ei(r,e.snapshotNode));else if(n==="child_changed"&&i==="child_changed")this.changeMap.set(r,jo(r,e.snapshotNode,s.oldSnap));else throw ai("Illegal combination of changes: "+e+" occurred after "+s)}else this.changeMap.set(r,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=At.makeFromUrl(e,n)}catch{return new At(e,"")}if(r.path==="")return r;throw o5(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(x){x.path.charAt(x.path.length-1)==="/"&&(x.path_=x.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),a={bucket:1,path:3};function u(x){x.path_=decodeURIComponent(x.path)}const h="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),f="(/([^?#]*).*)?$",p=new RegExp(`^https?://${d}/${h}/b/${s}/o${f}`,"i"),v={bucket:1,path:3},w=n===kx?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",_=new RegExp(`^https?://${w}/${s}/${k}`,"i"),g=[{regex:l,indices:a,postModify:i},{regex:p,indices:v,postModify:u},{regex:_,indices:{bucket:1,path:2},postModify:u}];for(let x=0;x<g.length;x++){const b=g[x],C=b.regex.exec(e);if(C){const E=C[b.indices.bucket];let S=C[b.indices.path];S||(S=""),r=new At(E,S),b.postModify(r);break}}if(r==null)throw i5(e);return r}}class h5{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
          ...
          ${o?"shadow-lg opacity-90":""}`,children:[c.jsx("div",{...e,...n,className:"w-6 h-6 mr-4 flex items-center justify-center flex-shrink-0 text-slate-400 dark:text-slate-500 touch-none cursor-grab active:cursor-grabbing",children:c.jsx(Qx,{size:20})}),c.jsx("div",{className:"flex-1 min-w-0",children:c.jsx("div",{className:"text-lg text-slate-800 dark:text-slate-100",children:t.name})})]})})}function rP({data:t,user:e,syncStatus:n,onLogin:r,onLogout:s,onNavigate:i,onSaveData:o,shared:l,activeSharedListId:a,categories:u=[]}){var vi,sl,il;const[h,d]=y.useState([]),[f,p]=y.useState(null),[v,w]=y.useState(null),[k,_]=y.useState([]),[m,g]=y.useState(!1),[x,b]=y.useState("default"),[C,E]=y.useState(!1),[S,R]=y.useState(""),[N,I]=y.useState(u[0]||""),[T,A]=y.useState(null),Y=a&&((vi=l==null?void 0:l.sharedWithMe)==null?void 0:vi[a]),te=a&&((sl=l==null?void 0:l.sharedByMe)==null?void 0:sl[a]),Z=Y?"shared-with-me":te?"own-shared":"local",Q=Y?l.sharedWithMe[a]:te?l.sharedByMe[a]:null,D=Z!=="shared-with-me"||(()=>{if(!(e!=null&&e.email)||!(Q!=null&&Q.sharedWith))return!1;const j=nr(e.email);return Q.sharedWith[j]==="edit"})(),z=(il=t.lists)==null?void 0:il.find(j=>j.id===t.activeListId),M=z?{...z,items:Array.isArray(z.items)?z.items:[],checkedItems:Array.isArray(z.checkedItems)?z.checkedItems:[]}:null;let H=[],V=[],q="",ce="",L="";Z==="shared-with-me"&&Q?(H=(Q.items||[]).filter(Boolean),V=Q.checkedItems||[],q=Q.name||"清單",ce=Q.icon||"clipboard-list",L=Q.ownerName||Q.ownerEmail||""):Z==="own-shared"&&M&&Q?(H=M.items.map(j=>{var $;return($=t.itemLibrary)==null?void 0:$.find(X=>X.id===j)}).filter(Boolean),V=Q.checkedItems||[],q=M.name||"清單",ce=M.icon||"clipboard-list"):(H=M?M.items.map(j=>{var $;return($=t.itemLibrary)==null?void 0:$.find(X=>X.id===j)}).filter(Boolean):[],V=(M==null?void 0:M.checkedItems)||[],q=(M==null?void 0:M.name)||"清單",ce=(M==null?void 0:M.icon)||"clipboard-list");const U=V.length,K=H.length,he=K>0&&U===K,fe=K>0?U/K*100:0,ee=y.useRef(he);y.useEffect(()=>{if(he&&!ee.current){g(!0);const j=setTimeout(()=>g(!1),2500);return()=>clearTimeout(j)}ee.current=he},[he]);const B=(()=>{const j=[],$={};return H.forEach(X=>{const Se=X.category||"其他";$[Se]||($[Se]=[]),$[Se].push(X)}),u.forEach(X=>{$[X]&&(j.push({category:X,items:$[X]}),delete $[X])}),Object.keys($).forEach(X=>{j.push({category:X,items:$[X]})}),j})(),oe=x==="name"?[...H].sort((j,$)=>j.name.localeCompare($.name,"zh-Hant")):x==="unchecked"?[...H].sort((j,$)=>{const X=V.includes(j.id)?1:0,Se=V.includes($.id)?1:0;return X-Se}):H,le=()=>{b(j=>j==="default"?"name":j==="name"?"unchecked":j==="unchecked"?Z==="shared-with-me"?"default":"manual":"default")},pe=x==="name"?"名稱":x==="unchecked"?"未勾選":x==="manual"?"手動":"",We=eb(Va(Rc,{activationConstraint:{distance:5}}),Va(_p,{activationConstraint:{delay:150,tolerance:5}})),Nt=j=>{const{active:$,over:X}=j;if(!X||$.id===X.id)return;const Se=M.items.indexOf($.id),ye=M.items.indexOf(X.id);if(Se===-1||ye===-1)return;const Qt=Ac(M.items,Se,ye),cn={...t,lists:t.lists.map(Et=>Et.id===t.activeListId?{...Et,items:Qt}:Et)};o(cn)},Gn=j=>{if(w(j),Z==="shared-with-me"||Z==="own-shared")l.toggleSharedCheck(a,j);else{const $={...t,lists:t.lists.map(X=>{if(X.id!==t.activeListId)return X;const Se=Array.isArray(X.checkedItems)?X.checkedItems:[],ye=Se.includes(j);return{...X,checkedItems:ye?Se.filter(Qt=>Qt!==j):[...Se,j]}})};o($)}},rl=()=>{if(Z==="shared-with-me"||Z==="own-shared")l.resetSharedChecks(a);else{const j={...t,lists:t.lists.map($=>$.id===t.activeListId?{...$,checkedItems:[]}:$)};o(j)}},gi=()=>{if(Z==="shared-with-me"||Z==="own-shared"){const j=H.map($=>$.id);l.checkAllShared(a,j)}else{if(!M)return;const j={...t,lists:t.lists.map($=>$.id===t.activeListId?{...$,checkedItems:[...M.items]}:$)};o(j)}},an=j=>{d($=>$.includes(j)?$.filter(X=>X!==j):[...$,j])},ds=j=>{_($=>$.includes(j)?$.filter(X=>X!==j):[...$,j])},Ar=()=>{const j=S.trim();if(j){if(Z==="shared-with-me"){const X={id:"shared_item_"+Date.now(),name:j,category:N};l.addSharedItem(a,X)}else{if(!M)return;const $="item_"+Date.now(),X={id:$,name:j,category:N},Se={...t,itemLibrary:[...t.itemLibrary||[],X],lists:t.lists.map(ye=>ye.id!==t.activeListId?ye:{...ye,items:[...Array.isArray(ye.items)?ye.items:[],$]})};o(Se)}R(""),E(!1)}},yi=j=>{var cn;const $=V.includes(j.id),X=(cn=j.note)==null?void 0:cn.trim(),Se=X||j.photoURL,ye=h.includes(j.id),Qt=v===j.id;return c.jsxs("div",{children:[c.jsxs("div",{onClick:()=>Gn(j.id),className:`flex items-center p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 active:bg-slate-50 dark:active:bg-slate-700 transition-colors duration-150 cursor-pointer min-h-[56px]
            ${$?"bg-slate-50 dark:bg-slate-800/50":""} ${Se&&ye?"rounded-b-none border-b-0":""}`,children:[c.jsx("div",{className:`w-6 h-6 border-2 rounded-full mr-4 flex items-center justify-center flex-shrink-0 transition-colors duration-150
              ...
              ${Qt&&$?"animate-check-bounce":""}`,onAnimationEnd:()=>w(null),children:$&&c.jsx(is,{size:14,className:`text-white ${Qt?"animate-check-icon-in":""}`})}),j.photoURL&&c.jsx("img",{src:j.photoURL,alt:"",className:"w-10 h-10 object-cover rounded-lg mr-3 flex-shrink-0",loading:"lazy",onError:Et=>{Et.target.style.display="none"}}),c.jsx("div",{className:"flex-1 min-w-0",children:c.jsx("div",{className:`text-lg transition-all duration-300 ${$?"line-through text-slate-400 dark:text-slate-500 opacity-60":"text-slate-800 dark:text-slate-100"}`,children:j.name})}),Se&&c.jsx("button",{onClick:Et=>{Et.stopPropagation(),an(j.id)},className:`p-2 rounded-lg min-w-[44px] min-h-[44px] flex items-center justify-center transition-colors duration-150
                ${ye?"bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400":"text-slate-400"}`,"aria-label":"展開詳情",children:c.jsx(Q_,{size:18,className:`transition-transform duration-200 ${ye?"rotate-180":""}`})}),Z==="shared-with-me"&&D&&c.jsx("button",{onClick:Et=>{Et.stopPropagation(),A(j.id)},className:"p-2 text-slate-400 active:text-rose-500 rounded-lg min-w-[44px] min-h-[44px] flex items-center justify-center transition-colors duration-150","aria-label":"移除物品",children:c.jsx(xn,{size:16})})]}),Se&&ye&&c.jsxs("div",{className:"px-4 py-3 bg-indigo-50 dark:bg-indigo-900/30 border border-slate-200 dark:border-slate-700 border-t-0 rounded-b-xl",children:[X&&c.jsxs("div",{className:"flex items-start text-sm text-slate-600 dark:text-slate-300 gap-2",children:[c.jsx(lp,{size:14,className:"text-indigo-400 mt-0.5 flex-shrink-0"}),c.jsx("span",{children:j.note})]}),j.photoURL&&c.jsx("div",{className:X?"mt-2":"",children:c.jsx("img",{src:j.photoURL,alt:j.name,className:"max-w-[200px] rounded-lg",loading:"lazy",onError:Et=>{Et.target.style.display="none"}})})]})]},j.id)};return c.jsxs("div",{className:"flex flex-col h-screen pb-16",children:[c.jsxs("div",{className:"bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-50 px-4 py-3 border-b border-slate-200 dark:border-slate-700 safe-top",children:[c.jsxs("div",{className:"flex items-center justify-between",children:[c.jsxs("div",{className:"flex items-center gap-1 min-w-0 flex-1",children:[c.jsx("button",{onClick:()=>i("lists"),className:"p-1 -ml-1 rounded-lg active:bg-slate-100 dark:active:bg-slate-700 transition-colors duration-150 min-w-[36px] min-h-[36px] flex items-center justify-center flex-shrink-0","aria-label":"返回所有清單",children:c.jsx(Vx,{size:22,className:"text-slate-500 dark:text-slate-400"})}),c.jsx(oo,{name:ce,size:22,className:"text-indigo-600 dark:text-indigo-400 flex-shrink-0"}),c.jsx("span",{className:"text-lg font-bold truncate",children:q}),Z==="shared-with-me"&&L&&c.jsxs("span",{className:"text-xs text-indigo-500 dark:text-indigo-400 flex-shrink-0",children:["來自 ",L]}),Z==="own-shared"&&c.jsx("span",{className:"text-xs bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800 flex-shrink-0",children:"已分享"})]}),c.jsxs("div",{className:"flex items-center flex-shrink-0",children:[H.length>0&&c.jsxs("div",{className:"flex flex-col items-center",children:[c.jsx("button",{onClick:le,className:`p-2 rounded-lg active:bg-slate-100 dark:active:bg-slate-700 transition-colors duration-150 min-w-[44px] min-h-[44px] flex items-center justify-center
                    ${x!=="default"?"text-indigo-600 dark:text-indigo-400":"text-slate-400 dark:text-slate-500"}`,"aria-label":"排序方式",children:c.jsx(Hx,{size:20})}),pe&&c.jsx("span",{className:"text-[10px] text-indigo-600 dark:text-indigo-400 -mt-1 font-medium",children:pe})]}),Z!=="shared-with-me"&&c.jsx("button",{onClick:()=>i("addItems"),className:"p-2 -mr-2 rounded-lg active:bg-slate-100 dark:active:bg-slate-700 transition-colors duration-150 min-w-[44px] min-h-[44px] flex items-center justify-center","aria-label":"新增物品",children:c.jsx(Vn,{size:22,className:"text-indigo-600 dark:text-indigo-400"})})]})]}),K>0&&c.jsxs("div",{className:"mt-3",children:[c.jsxs("div",{className:"flex justify-between text-xs text-slate-500 dark:text-slate-400 mb-1",children:[c.jsx("span",{children:"完成進度"}),c.jsxs("span",{children:[U,"/",K]})]}),c.jsx("div",{className:"h-2 bg-indigo-100 dark:bg-indigo-900/50 rounded-full overflow-hidden",children:c.jsx("div",{className:"h-full bg-indigo-600 dark:bg-indigo-500 transition-all duration-300",style:{width:`${fe}%`}})})]})]}),c.jsxs("div",{className:"flex-1 overflow-y-auto px-4 pt-6 pb-4 no-scrollbar",children:[H.length===0?c.jsxs("div",{className:"text-center py-16 text-slate-400",children:[c.jsx(g4,{size:48,className:"mx-auto mb-4 text-slate-300 dark:text-slate-600"}),c.jsx("div",{className:"text-lg mb-2",children:"清單是空的"}),Z!=="shared-with-me"&&c.jsx("button",{onClick:()=>i("addItems"),className:"text-indigo-600 dark:text-indigo-400 font-medium active:text-indigo-700 dark:active:text-indigo-300 transition-colors duration-150",children:"從物品庫加入物品"})]}):c.jsx("div",{className:"space-y-4",children:x==="manual"?c.jsx(mb,{sensors:We,collisionDetection:tb,onDragEnd:Nt,children:c.jsx(xb,{items:H.map(j=>j.id),strategy:gb,children:c.jsx("div",{className:"space-y-2",children:H.map(j=>c.jsx(nP,{item:j},j.id))})})}):x==="default"?B.map(({category:j,items:$})=>{const X=k.includes(j),Se=$.filter(cn=>V.includes(cn.id)).length,ye=$.length,Qt=Se===ye;return c.jsxs("div",{children:[c.jsxs("button",{onClick:()=>ds(j),className:"w-full flex items-center gap-2 py-2 px-1 mb-1",children:[c.jsx(Q_,{size:16,className:`text-slate-400 transition-transform duration-200 ${X?"-rotate-90":""}`}),c.jsx("span",{className:"text-sm font-semibold text-slate-600 dark:text-slate-300",children:j}),c.jsxs("span",{className:`text-xs px-2 py-0.5 rounded-full ${Qt?"bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400":"bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400"}`,children:[Se,"/",ye]})]}),!X&&c.jsx("div",{className:"space-y-2 animate-slide-down",children:$.map(cn=>yi(cn))})]},j)}):c.jsx("div",{className:"space-y-2",children:oe.map(j=>yi(j))})}),H.length>0&&c.jsx("div",{className:"pt-4 pb-16",children:c.jsxs("div",{className:"flex gap-3",children:[c.jsxs("button",{onClick:()=>p("reset"),className:"flex-1 py-3 text-slate-600 dark:text-slate-300 border border-slate-300 dark:border-slate-600 rounded-xl font-medium active:bg-slate-100 dark:active:bg-slate-700 transition-colors duration-150 min-h-[44px]",children:[c.jsx(q4,{size:16,className:"inline mr-1.5 -mt-0.5"}),"重設"]}),c.jsxs("button",{onClick:()=>p("checkAll"),disabled:he,className:`flex-1 py-3 rounded-xl font-medium transition-colors duration-150 min-h-[44px]
                  ${he?"bg-indigo-100 dark:bg-indigo-900/50 text-indigo-400":"bg-indigo-600 dark:bg-indigo-500 text-white active:bg-indigo-700 dark:active:bg-indigo-600"}`,children:[c.jsx(UT,{size:16,className:"inline mr-1.5 -mt-0.5"}),he?"準備完成！":"全部確認"]})]})})]}),f==="reset"&&c.jsx(Au,{message:"確定要重設所有勾選？",onConfirm:()=>{rl(),p(null)},onCancel:()=>p(null)}),f==="checkAll"&&c.jsx(Au,{message:"確定要勾選全部項目？",onConfirm:()=>{gi(),p(null)},onCancel:()=>p(null)}),m&&c.jsx(tP,{}),T!==null&&c.jsx(Au,{message:"確定要移除此物品？",onConfirm:()=>{l.removeSharedItem(a,T),A(null)},onCancel:()=>A(null)}),D&&c.jsxs(c.Fragment,{children:[C&&c.jsx("div",{className:"fixed inset-0 bg-black/30 z-40",onClick:()=>{E(!1),R("")}}),C&&c.jsxs("div",{className:"fixed right-4 bottom-24 z-50 w-72 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 p-4 space-y-3",children:[c.jsx("div",{className:"text-sm font-semibold text-slate-700 dark:text-slate-200",children:"快速新增物品"}),c.jsx("input",{type:"text",placeholder:"物品名稱",value:S,onChange:j=>R(j.target.value),onKeyDown:j=>{j.key==="Enter"&&Ar()},className:"w-full px-3 py-2 border border-slate-200 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"}),c.jsx("select",{value:N,onChange:j=>I(j.target.value),className:"w-full px-3 py-2 border border-slate-200 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500",children:u.map(j=>c.jsx("option",{value:j,children:j},j))}),c.jsx("button",{onClick:Ar,disabled:!S.trim(),className:"w-full py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg text-sm font-medium active:bg-indigo-700 dark:active:bg-indigo-600 disabled:opacity-40 transition-colors duration-150",children:"新增並加入清單"})]}),c.jsx("button",{onClick:()=>{E(j=>!j),C&&R("")},className:"fixed bottom-24 right-4 z-50 w-14 h-14 rounded-full bg-indigo-600 dark:bg-indigo-500 text-white shadow-lg flex items-center justify-center active:bg-indigo-700 dark:active:bg-indigo-600 transition-colors duration-150","aria-label":C?"關閉新增表單":"快速新增物品",children:C?c.jsx(at,{size:24}):c.jsx(Vn,{size:24})})]})]})}function sP({sharedData:t,onAddUser:e,onRemoveUser:n,onSetPermission:r,onUnshare:s,onClose:i}){const[o,l]=y.useState(""),[a,u]=y.useState(""),h=t!=null&&t.sharedWith?Object.keys(t.sharedWith).map(Jd):[],d=v=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v),f=()=>{const v=o.trim().toLowerCase();if(v){if(!d(v)){u("請輸入有效的 Email");return}if(h.includes(v)){u("已經分享給此帳號");return}u(""),e(v),l("")}},p=v=>{v.key==="Enter"&&f()};return c.jsxs("div",{className:"fixed inset-0 z-50 flex items-end justify-center",children:[c.jsx("div",{className:"absolute inset-0 bg-black bg-opacity-50",onClick:i}),c.jsx("div",{className:"relative w-full max-w-lg bg-white dark:bg-slate-800 rounded-t-2xl animate-slide-up safe-bottom",children:c.jsxs("div",{className:"p-4",children:[c.jsx("div",{className:"w-10 h-1 bg-slate-300 dark:bg-slate-600 rounded-full mx-auto mb-4"}),c.jsx("div",{className:"text-lg font-bold text-slate-800 dark:text-slate-100 mb-4",children:"分享清單"}),c.jsxs("div",{className:"flex gap-2 mb-2",children:[c.jsx("input",{type:"email",value:o,onChange:v=>{l(v.target.value),u("")},onKeyDown:p,placeholder:"輸入 Gmail 帳號...",className:"flex-1 px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition-colors duration-150"}),c.jsx("button",{onClick:f,className:"px-5 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-xl font-medium active:bg-indigo-700 dark:active:bg-indigo-600 transition-colors duration-150 min-h-[44px]",children:"新增"})]}),a&&c.jsx("div",{className:"text-sm text-rose-500 mb-3",children:a}),h.length>0&&c.jsxs("div",{className:"mt-4",children:[c.jsx("div",{className:"text-sm text-slate-500 dark:text-slate-400 mb-2",children:"已分享給"}),c.jsx("div",{className:"space-y-2",children:h.map(v=>{var _;const w=nr(v),k=((_=t==null?void 0:t.sharedWith)==null?void 0:_[w])||"view";return c.jsxs("div",{className:"flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700 rounded-xl border border-slate-200 dark:border-slate-600",children:[c.jsx("span",{className:"text-slate-700 dark:text-slate-200 text-sm truncate flex-1",children:v}),c.jsx("button",{onClick:()=>r(v,k==="edit"?"view":"edit"),className:`ml-2 p-2 rounded-lg min-w-[36px] min-h-[36px] flex items-center justify-center transition-colors duration-150
