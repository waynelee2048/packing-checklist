 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,z){var M=D.length;D.push(z);e:for(;0<M;){var H=M-1>>>1,V=D[H];if(0<s(V,z))D[H]=z,D[M]=V,M=H;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var z=D[0],M=D.pop();if(M!==z){D[0]=M;e:for(var H=0,V=D.length,X=V>>>1;H<X;){var ce=2*(H+1)-1,L=D[ce],U=ce+1,K=D[U];if(0>s(L,M))U<V&&0>s(K,L)?(D[H]=K,D[U]=M,H=U):(D[H]=L,D[ce]=M,H=ce);else if(U<V&&0>s(K,M))D[H]=K,D[U]=M,H=U;else break e}}return z}function s(D,z){var M=D.sortIndex-z.sortIndex;return M!==0?M:D.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;t.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],h=1,d=null,f=3,p=!1,v=!1,b=!1,k=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(D){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=D)r(u),z.sortIndex=z.expirationTime,e(a,z);else break;z=n(u)}}function x(D){if(b=!1,y(D),!v)if(n(a)!==null)v=!0,Z(w);else{var z=n(u);z!==null&&Q(x,z.startTime-D)}}function w(D,z){v=!1,b&&(b=!1,_(C),C=-1),p=!0;var M=f;try{for(y(z),d=n(a);d!==null&&(!(d.expirationTime>z)||D&&!E());){var H=d.callback;if(typeof H=="function"){d.callback=null,f=d.priorityLevel;var V=H(d.expirationTime<=z);z=t.unstable_now(),typeof V=="function"?d.callback=V:d===n(a)&&r(a),y(z)}else r(a);d=n(a)}if(d!==null)var X=!0;else{var ce=n(u);ce!==null&&Q(x,ce.startTime-z),X=!1}return X}finally{d=null,f=M,p=!1}}var S=!1,I=null,C=-1,R=5,N=-1;function E(){return!(t.unstable_now()-N<R)}function T(){if(I!==null){var D=t.unstable_now();N=D;var z=!0;try{z=I(!0,D)}finally{z?A():(S=!1,I=null)}}else S=!1}var A;if(typeof m=="function")A=function(){m(T)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,te=Y.port2;Y.port1.onmessage=T,A=function(){te.postMessage(null)}}else A=function(){k(T,0)};function Z(D){I=D,S||(S=!0,A())}function Q(D,z){C=k(function(){D(t.unstable_now())},z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,Z(w))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(D){switch(f){case 1:case 2:case 3:var z=3;break;default:z=f}var M=f;f=z;try{return D()}finally{f=M}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,z){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var M=f;f=D;try{return z()}finally{f=M}},t.unstable_scheduleCallback=function(D,z,M){var H=t.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?H+M:H):M=H,D){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=M+V,D={id:h++,callback:z,priorityLevel:D,startTime:M,expirationTime:V,sortIndex:-1},M>H?(D.sortIndex=M,e(u,D),n(a)===null&&D===n(u)&&(b?(_(C),C=-1):b=!0,Q(x,M-H))):(D.sortIndex=V,e(a,D),v||p||(v=!0,Z(w))),D},t.unstable_shouldYield=E,t.unstable_wrapCallback=function(D){var z=f;return function(){var M=f;f=z;try{return D.apply(this,arguments)}finally{f=M}}}})(w0);b0.exports=w0;var Xb=b0.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FN=Math.log(2);class BN{constructor(e){const n=i=>parseInt(Math.log(i)/FN,10),r=i=>parseInt(Array(i+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const s=r(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const ja=function(t,e,n,r){t.sort(e);const s=function(a,u){const h=u-a;let d,f;if(h===0)return null;if(h===1)return d=t[a],f=n?n(d):d,new Ye(f,d.node,Ye.BLACK,null,null);{const p=parseInt(h/2,10)+a,v=s(a,p),b=s(p+1,u);return d=t[p],f=n?n(d):d,new Ye(f,d.node,Ye.BLACK,v,b)}},i=function(a){let u=null,h=null,d=t.length;const f=function(v,b){const k=d-v,_=d;d-=v;const m=s(k+1,_),y=t[k],x=n?n(y):y;p(new Ye(x,y.node,b,null,m))},p=function(v){u?(u.left=v,u=v):(h=v,u=v)};for(let v=0;v<a.count;++v){const b=a.nextBitIsOne(),k=Math.pow(2,a.count-(v+1));b?f(k,Ye.BLACK):(f(k,Ye.BLACK),f(k,Ye.RED))}return h},o=new BN(t.length),l=i(o);return new bt(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=At.makeFromUrl(e,n)}catch{return new At(e,"")}if(r.path==="")return r;throw lI(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(x){x.path.charAt(x.path.length-1)==="/"&&(x.path_=x.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),a={bucket:1,path:3};function u(x){x.path_=decodeURIComponent(x.path)}const h="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),f="(/([^?#]*).*)?$",p=new RegExp(`^https?://${d}/${h}/b/${s}/o${f}`,"i"),v={bucket:1,path:3},b=n===Cx?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",_=new RegExp(`^https?://${b}/${s}/${k}`,"i"),y=[{regex:l,indices:a,postModify:i},{regex:p,indices:v,postModify:u},{regex:_,indices:{bucket:1,path:2},postModify:u}];for(let x=0;x<y.length;x++){const w=y[x],S=w.regex.exec(e);if(S){const I=S[w.indices.bucket];let C=S[w.indices.path];C||(C=""),r=new At(I,C),w.postModify(r);break}}if(r==null)throw oI(e);return r}}class fI{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
